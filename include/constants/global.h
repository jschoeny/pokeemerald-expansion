...
#define OPTIONS_RANDOMIZER_TYPE_NORMAL 0
#define OPTIONS_RANDOMIZER_TYPE_1_1 1
#define OPTIONS_RANDOMIZER_TYPE_1_2 2
#define OPTIONS_RANDOMIZER_TYPE_RAND 3

#define OPTIONS_RANDOMIZER_ABILITY_NORMAL 0
#define OPTIONS_RANDOMIZER_ABILITY_TYPE 1
#define OPTIONS_RANDOMIZER_ABILITY_SPECIES 2
#define OPTIONS_RANDOMIZER_ABILITY_PERSONALITY 3

#define OPTIONS_RANDOMIZER_MOVES_NORMAL 0
#define OPTIONS_RANDOMIZER_MOVES_TYPE 1
#define OPTIONS_RANDOMIZER_MOVES_SPECIES 2
#define OPTIONS_RANDOMIZER_MOVES_PERSONALITY 3

#define OPTIONS_RANDOMIZER_WILD_NORMAL 0
#define OPTIONS_RANDOMIZER_WILD_SPECIES 1
#define OPTIONS_RANDOMIZER_WILD_MAP 2
#define OPTIONS_RANDOMIZER_WILD_RAND 3

#define OPTIONS_RANDOMIZER_TRAINER_NORMAL 0
#define OPTIONS_RANDOMIZER_TRAINER_SPECIES 1
#define OPTIONS_RANDOMIZER_TRAINER_TRAINER 2
#define OPTIONS_RANDOMIZER_TRAINER_RAND 3

#define OPTIONS_RANDOMIZER_LEVELCAP_OFF 0
#define OPTIONS_RANDOMIZER_LEVELCAP_CANDY 1
#define OPTIONS_RANDOMIZER_LEVELCAP_NORMAL 2
#define OPTIONS_RANDOMIZER_LEVELCAP_HARD 3

#define OPTIONS_RANDOMIZER_FILTER_TYPECOLORS 0xFFFF
#define OPTIONS_RANDOMIZER_FILTER_HOENNDEX 0x7FFF

#define OPTIONS_RANDOMIZER_VERSION 1
