...
#define PARTY_MSG_CHOOSE_FIELD_MOVE         20
...
#define PARTY_MSG_HOW_MANY_ITEM             28
...
#define SELECTWINDOW_FIELDMOVE 4
#define SELECTWINDOW_STATS    5
#define SELECTWINDOW_QUANTITY 6

#define NUM_SHOWN_FIELD_MOVES 2
