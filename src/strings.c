...
const u8 gMenuText_FieldMove[] = _("FIELD MOVES");
...
const u8 gText_Var1IsItThatllBeVar2Slates[] = _("You can have that {STR_VAR_1}\nfor {STR_VAR_2} Mystery Shards. That okay?");
...
const u8 gText_YouDontHaveShards[] = _("You don't have enough\nMystery Shards.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ShardsVar1[] = _("{STR_VAR_1} MS");
...
const u8 gText_PkmnGainedVar2Exp[] = _("{STR_VAR_1} gained\n{STR_VAR_2} EXP. POINTS.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_MightAffectPkmnStats[] = _("It might affect {STR_VAR_1}'s stats.\nUse the {STR_VAR_2}?");
const u8 gText_PkmnStatsMayHaveChanged[] = _("{STR_VAR_1}'s stats may have\nchanged from the {STR_VAR_2}!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_BoostIv[] = _("Boost IV of which stat?");
const u8 gText_UseHowManyItems[] = _("Use how many {STR_VAR_1}(s)?");
...
const u8 gText_ChooseFieldMove[] = _("Choose a move to use.");
...
const u8 gText_EggFromCynthia[] = _("Obtained from the CHAMPION\nof the SINNOH region.");
...
const u8 gText_PCUnavailable[] = _("Please set the clock first.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_NewMove[] = _("a new move");
const u8 gText_MintNatureIndicator[] = _(" {EMOJI_LEAF}");
