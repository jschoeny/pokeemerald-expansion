...
const u8 gText_Var1IsItThatllBeVar2Slates[] = _("{STR_VAR_1}, is it?\nThat'll be {STR_VAR_2} SHARDS. That okay?");
...
const u8 gText_YouDontHaveShards[] = _("You don't have enough shards.{PAUSE_UNTIL_PRESS}");
