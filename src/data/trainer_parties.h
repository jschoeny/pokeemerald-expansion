...
static const struct TrainerMonItemCustomMoves sParty_Challenge_Sidney[] = {
    ...
    .species = SPECIES_MIGHTYENA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROAR, MOVE_DOUBLE_EDGE, MOVE_POISON_FANG, MOVE_CRUNCH}
    },
    {
    .iv = 255,
    .lvl = 48,
...
static const struct TrainerMonItemCustomMoves sParty_Challenge_Phoebe[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_DISCHARGE, MOVE_OVERHEAT, MOVE_VOLT_SWITCH}
    },
    {
    .iv = 255,
    .lvl = 50,
...
static const struct TrainerMonItemCustomMoves sParty_Challenge_Glacia[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ICE_SHARD, MOVE_STONE_EDGE, MOVE_EARTHQUAKE, MOVE_ICICLE_SPEAR}
    },
    {
    .iv = 255,
    .lvl = 52,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DESTINY_BOND, MOVE_SPIKES, MOVE_TAUNT, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 52,
...
static const struct TrainerMonItemCustomMoves sParty_Challenge_Drake[] = {
    ...
    .species = SPECIES_ALTARIA,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_ROOST, MOVE_DRAGON_DANCE, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 55,
