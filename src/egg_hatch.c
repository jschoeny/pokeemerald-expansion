...
static const u16 sEggPalette[]  = INCBIN_U16("Pokemon-Palette-Categorized/graphics/pokemon/egg/normal.gbapal");
static const u8 sEggHatchTiles[] = INCBIN_U8("Pokemon-Palette-Categorized/graphics/pokemon/egg/hatch.4bpp");
static const u8 sEggShardTiles[] = INCBIN_U8("Pokemon-Palette-Categorized/graphics/pokemon/egg/shard.4bpp");
