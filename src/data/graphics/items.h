...
const u32 gItemIcon_GritDust[] = INCBIN_U32("graphics/items/icons/grit_dust.4bpp.lz");
const u32 gItemIconPalette_GritDust[] = INCBIN_U32("graphics/items/icon_palettes/grit_dust.gbapal.lz");
