...
#define MENU_FIELD_MOVES_NOT_HM MENU_FIELD_MOVES + FIELD_MOVE_TELEPORT
...
static const u16 sFieldHMMoves[] =
{
    ITEM_HM01, ITEM_HM02, ITEM_HM03, ITEM_HM04, ITEM_HM05, ITEM_HM06, ITEM_HM07, ITEM_HM08, FIELD_MOVE_TERMINATOR
    // MOVE_CUT, MOVE_FLASH, MOVE_ROCK_SMASH, MOVE_STRENGTH, MOVE_SURF, MOVE_FLY, MOVE_DIVE, MOVE_WATERFALL, FIELD_MOVE_TERMINATOR
};
...
const u16 gExpCandyAmounts[ITEM_EXP_CANDY_XL - ITEM_RARE_CANDY + 1] = {
    [ITEM_RARE_CANDY - ITEM_RARE_CANDY]     = 0,
    [ITEM_EXP_CANDY_XS - ITEM_RARE_CANDY]   = 100,
    [ITEM_EXP_CANDY_S - ITEM_RARE_CANDY]    = 800,
    [ITEM_EXP_CANDY_M - ITEM_RARE_CANDY]    = 3000,
    [ITEM_EXP_CANDY_L - ITEM_RARE_CANDY]    = 10000,
    [ITEM_EXP_CANDY_XL - ITEM_RARE_CANDY]   = 30000
};
