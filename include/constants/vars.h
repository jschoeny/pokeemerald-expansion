...
#define VAR_HEARTSCALES_GIVEN                0x408B
...
#define VAR_FARAWAY_ISLAND_STATE             0x40DB
...
#define VAR_RNDM_SPECIES_LIMIT               0x40FB // Used for enforcing only one usable species
