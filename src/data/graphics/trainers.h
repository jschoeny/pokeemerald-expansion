...
const u32 gTrainerFrontPic_Cynthia[] = INCBIN_U32("graphics/trainers/front_pics/champion_cynthia_front_pic.4bpp.lz");
const u32 gTrainerPalette_Cynthia[] = INCBIN_U32("graphics/trainers/palettes/champion_cynthia.gbapal.lz");
