...
static const u16 gMonTypeColorIndexesPrimary[NUM_SPECIES] =
{
    ...
    [SPECIES_TORCHIC] = (IND_TO_B(5) | IND_TO_B(6) | IND_TO_B(7) | IND_TO_B(8)),
    ...
    [SPECIES_MIGHTYENA] = 0,
    [SPECIES_ZIGZAGOON] = (IND_TO_B(5) | IND_TO_B(6) | IND_TO_B(7) | IND_TO_B(8) | IND_TO_B(10) | IND_TO_B(11) | IND_TO_B(12) | IND_TO_B(13)),
    [SPECIES_LINOONE] = 0,
    ...
    [SPECIES_NINJASK] = 0,
    [SPECIES_SHEDINJA] = 0,
    [SPECIES_TAILLOW] = (IND_TO_B(1) | IND_TO_B(2) | IND_TO_B(5)),
    [SPECIES_SWELLOW] = 0,
    [SPECIES_SHROOMISH] = (IND_TO_B(1) | IND_TO_B(2) | IND_TO_B(3) | IND_TO_B(5) | IND_TO_B(9)),
    [SPECIES_BRELOOM] = 0,
    [SPECIES_SPINDA] = 0,
    [SPECIES_WINGULL] = (IND_TO_B(1) | IND_TO_B(3) | IND_TO_B(4) | IND_TO_B(8) | IND_TO_B(11)),
    [SPECIES_PELIPPER] = 0,
    [SPECIES_SURSKIT] = 0,
...
static const u16 gMonTypeColorIndexesSecondary[NUM_SPECIES] =
{
    ...
    [SPECIES_TORCHIC] = (IND_TO_B(1) | IND_TO_B(2) | IND_TO_B(3)),
    ...
    [SPECIES_POOCHYENA] = (IND_TO_B(14) | IND_TO_B(15)),
    [SPECIES_MIGHTYENA] = 0,
