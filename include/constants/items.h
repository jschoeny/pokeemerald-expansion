...
#define ITEM_GRIT_DUST 777
#define ITEM_GRIT_PEBBLE 778
...
#define MAX_PBAG_ITEM_CAPACITY 99
#define MAX_PC_ITEM_CAPACITY   999
#define MAX_BERRY_CAPACITY     999

#define BAG_ITEM_CAPACITY_DIGITS 3
#define PBAG_ITEM_CAPACITY_DIGITS 2
...
#define ITEM_HAS_EFFECT(item) (((item) >= ITEM_POTION && (item) <= LAST_BERRY_INDEX) || (item) == ITEM_LINKING_CORD)
