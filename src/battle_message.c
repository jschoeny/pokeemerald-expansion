...
static const u8 sText_TeamGainedEXP[] = _("Your team gained EXP. Points\nthanks to the EXP. Share!\p");
...
static const u8 sText_PkmnStoleItemBag[] = _("{B_ATK_NAME_WITH_PREFIX} stole\n{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ITEM}!\pThe item was placed\nin the BAG.");
...
static const u8 sText_WildPkmnAppearedOutbreak[] = _("Wild {B_OPPONENT_MON1_NAME} appeared\nfrom an Outbreak!\p");
...
void BufferStringBattle(u16 stringID)
{
    ...
    case STRINGID_INTROMSG: // first battle msg
        ...
        else
        {
            ...
            else if (FlagGet(FLAG_OUTBREAK_ENCOUNTER))
                stringPtr = sText_WildPkmnAppearedOutbreak;
            else
