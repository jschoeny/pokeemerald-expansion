...
static const struct TrainerMonItemCustomMoves sParty_Challenge_Roxanne1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TACKLE, MOVE_CHARGE, MOVE_ROCK_THROW, MOVE_SPARK}
    },
    {
    .iv = 200,
    .lvl = 14,
...
static const struct TrainerMonItemCustomMoves sParty_Challenge_Brawly1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PURSUIT, MOVE_LOW_SWEEP, MOVE_MACH_PUNCH, MOVE_BULK_UP}
    },
    {
    .iv = 100,
    .lvl = 15,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FORCE_PALM, MOVE_BULLET_PUNCH, MOVE_DOUBLE_TEAM, MOVE_BULK_UP}
    },
    {
    .iv = 200,
    .lvl = 19,
