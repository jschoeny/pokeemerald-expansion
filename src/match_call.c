    ...
    if (gWildMonHeaders[i].mapGroup != MAP_GROUP(UNDEFINED)) // ??? This check is nonsense.
    {
        ...
        if (gWildMonHeaders[i].mapGroup != MAP_GROUP(UNDEFINED))
        {
            ...
            if (gWildMonHeaders[i].landMonsInfo)
            {
                ...
                species[numSpecies] = GetRandomizedSpeciesWild(gWildMonHeaders[i].landMonsInfo->wildPokemon[timeOfDay][slot].species, i);
                numSpecies++;
            }
            ...
            if (gWildMonHeaders[i].waterMonsInfo)
            {
                ...
                species[numSpecies] = GetRandomizedSpeciesWild(gWildMonHeaders[i].waterMonsInfo->wildPokemon[timeOfDay][slot].species, i);
                numSpecies++;
            }
