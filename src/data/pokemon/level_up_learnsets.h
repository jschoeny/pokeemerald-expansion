...
static const struct LevelUpMove sBulbasaurLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 7, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE( 9, MOVE_VINE_WHIP),
    LEVEL_UP_MOVE(13, MOVE_PH_STATUS4 + MOVES_PH_TYPE2), //MOVE_POISON_POWDER),
    LEVEL_UP_MOVE(13, MOVE_SLEEP_POWDER),
    LEVEL_UP_MOVE(15, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(19, MOVE_PH_SPATK_ADJACENT1), //MOVE_RAZOR_LEAF),
    LEVEL_UP_MOVE(21, MOVE_SWEET_SCENT),
    LEVEL_UP_MOVE(25, MOVE_GROWTH),
    LEVEL_UP_MOVE(27, MOVE_DOUBLE_EDGE),
    LEVEL_UP_MOVE(31, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE(33, MOVE_PH_RECOVER), //MOVE_SYNTHESIS),
...
static const struct LevelUpMove sIvysaurLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE( 3, MOVE_GROWL),
    LEVEL_UP_MOVE( 7, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE( 9, MOVE_VINE_WHIP),
    LEVEL_UP_MOVE(13, MOVE_PH_STATUS4 + MOVES_PH_TYPE2), //MOVE_POISON_POWDER),
    LEVEL_UP_MOVE(13, MOVE_SLEEP_POWDER),
    LEVEL_UP_MOVE(15, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(20, MOVE_PH_SPATK_ADJACENT1), //MOVE_RAZOR_LEAF),
    LEVEL_UP_MOVE(23, MOVE_SWEET_SCENT),
    LEVEL_UP_MOVE(28, MOVE_GROWTH),
    LEVEL_UP_MOVE(31, MOVE_DOUBLE_EDGE),
    LEVEL_UP_MOVE(36, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE(39, MOVE_PH_RECOVER), //MOVE_SYNTHESIS),
    LEVEL_UP_MOVE(44, MOVE_PH_BEAM4),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sVenusaurLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(28, MOVE_GROWTH),
    LEVEL_UP_MOVE(31, MOVE_DOUBLE_EDGE),
    LEVEL_UP_MOVE(39, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE(45, MOVE_PH_RECOVER), //MOVE_SYNTHESIS),
    LEVEL_UP_MOVE(50, MOVE_PETAL_BLIZZARD),
    LEVEL_UP_MOVE(53, MOVE_PH_BEAM4),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sCharmanderLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 7, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE(10, MOVE_SMOKESCREEN),
    LEVEL_UP_MOVE(16, MOVE_DRAGON_RAGE),
    LEVEL_UP_MOVE(19, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(25, MOVE_PH_BITE), //MOVE_FIRE_FANG),
    LEVEL_UP_MOVE(28, MOVE_PH_SPATK_ADJACENT1),
    LEVEL_UP_MOVE(34, MOVE_SLASH),
    LEVEL_UP_MOVE(37, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(43, MOVE_PH_HEAL_SAP),
...
static const struct LevelUpMove sCharmeleonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 7, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE(10, MOVE_SMOKESCREEN),
    LEVEL_UP_MOVE(17, MOVE_DRAGON_RAGE),
    LEVEL_UP_MOVE(21, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(28, MOVE_PH_BITE), //MOVE_FIRE_FANG),
    LEVEL_UP_MOVE(32, MOVE_PH_SPATK_ADJACENT1),
    LEVEL_UP_MOVE(39, MOVE_SLASH),
    LEVEL_UP_MOVE(43, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(50, MOVE_PH_HEAL_SAP),
...
static const struct LevelUpMove sCharizardLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(47, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(56, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(62, MOVE_INFERNO),
    LEVEL_UP_MOVE(71, MOVE_HEAT_WAVE),
    LEVEL_UP_MOVE(77, MOVE_PH_BODY),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSquirtleLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_PH_ELEMENT_WEAK2),
    LEVEL_UP_MOVE(16, MOVE_BITE),
    LEVEL_UP_MOVE(19, MOVE_RAPID_SPIN),
    LEVEL_UP_MOVE(22, MOVE_PROTECT),
    LEVEL_UP_MOVE(25, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(28, MOVE_PH_TAIL), //MOVE_AQUA_TAIL),
    LEVEL_UP_MOVE(31, MOVE_SKULL_BASH),
    LEVEL_UP_MOVE(34, MOVE_IRON_DEFENSE),
    LEVEL_UP_MOVE(37, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
    LEVEL_UP_MOVE(40, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sWartortleLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(29, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(33, MOVE_PH_TAIL), //MOVE_AQUA_TAIL),
    LEVEL_UP_MOVE(37, MOVE_SKULL_BASH),
    LEVEL_UP_MOVE(41, MOVE_IRON_DEFENSE),
    LEVEL_UP_MOVE(45, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
    LEVEL_UP_MOVE(49, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sBlastoiseLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(54, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
    LEVEL_UP_MOVE(60, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sButterfreeLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
...
static const struct LevelUpMove sBeedrillLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(23, MOVE_PH_VARDMG + MOVES_PH_TYPE2), //MOVE_VENOSHOCK),
    LEVEL_UP_MOVE(26, MOVE_ASSURANCE),
    LEVEL_UP_MOVE(29, MOVE_PH_HAZARD + MOVES_PH_TYPE2), //MOVE_TOXIC_SPIKES),
    LEVEL_UP_MOVE(32, MOVE_PIN_MISSILE),
    LEVEL_UP_MOVE(35, MOVE_PH_HORN + MOVES_PH_TYPE2), //MOVE_POISON_JAB),
...
static const struct LevelUpMove sPidgeyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 9, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(13, MOVE_PH_PRIORITY), //MOVE_QUICK_ATTACK),
    ...
    LEVEL_UP_MOVE(37, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(41, MOVE_TAILWIND),
    LEVEL_UP_MOVE(45, MOVE_MIRROR_MOVE),
    LEVEL_UP_MOVE(49, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
    LEVEL_UP_MOVE(53, MOVE_PH_BEAM4 + MOVES_PH_TYPE2), //MOVE_HURRICANE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sPidgeottoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(42, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(47, MOVE_TAILWIND),
    LEVEL_UP_MOVE(52, MOVE_MIRROR_MOVE),
    LEVEL_UP_MOVE(57, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
    LEVEL_UP_MOVE(62, MOVE_PH_BEAM4 + MOVES_PH_TYPE2), //MOVE_HURRICANE),
    LEVEL_UP_END
};

static const struct LevelUpMove sPidgeotLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM4 + MOVES_PH_TYPE2), //MOVE_HURRICANE),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 1, MOVE_PH_PRIORITY), //MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE( 5, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE( 9, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(13, MOVE_PH_PRIORITY), //MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE(17, MOVE_WHIRLWIND),
    ...
    LEVEL_UP_MOVE(44, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(50, MOVE_TAILWIND),
    LEVEL_UP_MOVE(56, MOVE_MIRROR_MOVE),
    LEVEL_UP_MOVE(62, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
    LEVEL_UP_MOVE(68, MOVE_PH_BEAM4 + MOVES_PH_TYPE2), //MOVE_HURRICANE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sRattataLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE( 4, MOVE_PH_PRIORITY), //MOVE_QUICK_ATTACK),
...
static const struct LevelUpMove sSpearowLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(11, MOVE_FURY_ATTACK),
    LEVEL_UP_MOVE(15, MOVE_PH_BLADE + MOVES_PH_TYPE2), //MOVE_AERIAL_ACE),
    ...
    LEVEL_UP_MOVE(32, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
...
static const struct LevelUpMove sFearowLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(36, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
...
static const struct LevelUpMove sEkansLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 4, MOVE_PH_ATK_WEAK), //MOVE_POISON_STING),
    LEVEL_UP_MOVE( 9, MOVE_BITE),
    LEVEL_UP_MOVE(12, MOVE_GLARE),
    LEVEL_UP_MOVE(17, MOVE_SCREECH),
    LEVEL_UP_MOVE(20, MOVE_PH_ELEMENT_WEAK), //MOVE_ACID),
    ...
    LEVEL_UP_MOVE(36, MOVE_PH_TYPE_EFF), //MOVE_GASTRO_ACID),
...
static const struct LevelUpMove sArbokLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_WRAP),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_PH_ATK_WEAK), //MOVE_POISON_STING),
    ...
    LEVEL_UP_MOVE(44, MOVE_PH_TYPE_EFF), //MOVE_GASTRO_ACID),
...
static const struct LevelUpMove sPikachuLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_PH_VARDMG), //MOVE_ELECTRO_BALL),
    LEVEL_UP_MOVE(18, MOVE_PH_STATUS3), //MOVE_THUNDER_WAVE),
    LEVEL_UP_MOVE(21, MOVE_FEINT),
    LEVEL_UP_MOVE(23, MOVE_DOUBLE_TEAM),
    LEVEL_UP_MOVE(26, MOVE_PH_HEAD), //MOVE_SPARK),
    LEVEL_UP_MOVE(29, MOVE_PH_ATK_WEAK), //MOVE_NUZZLE),
    LEVEL_UP_MOVE(34, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISCHARGE),
    LEVEL_UP_MOVE(37, MOVE_SLAM),
    LEVEL_UP_MOVE(42, MOVE_PH_ELEMENT_STRONG), //MOVE_THUNDERBOLT),
    LEVEL_UP_MOVE(45, MOVE_AGILITY),
    LEVEL_UP_MOVE(50, MOVE_WILD_CHARGE),
    LEVEL_UP_MOVE(53, MOVE_LIGHT_SCREEN),
    LEVEL_UP_MOVE(58, MOVE_PH_BEAM4), //MOVE_THUNDER),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sRaichuLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_STRONG), //MOVE_THUNDERBOLT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSandshrewLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(14, MOVE_PH_VARDMG), //MOVE_MAGNITUDE),
    LEVEL_UP_MOVE(17, MOVE_SWIFT),
    LEVEL_UP_MOVE(20, MOVE_FURY_SWIPES),
    LEVEL_UP_MOVE(23, MOVE_PH_ATK_TRAP), //MOVE_SAND_TOMB),
    LEVEL_UP_MOVE(26, MOVE_SLASH),
    LEVEL_UP_MOVE(30, MOVE_PH_BODY_2TURN), //MOVE_DIG),
    LEVEL_UP_MOVE(34, MOVE_GYRO_BALL),
    LEVEL_UP_MOVE(38, MOVE_SWORDS_DANCE),
    LEVEL_UP_MOVE(42, MOVE_PH_WEATHER), //MOVE_SANDSTORM),
    LEVEL_UP_MOVE(46, MOVE_PH_SPATK_ADJACENT2),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSandslashLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(17, MOVE_SWIFT),
    LEVEL_UP_MOVE(20, MOVE_FURY_SWIPES),
    LEVEL_UP_MOVE(24, MOVE_PH_ATK_TRAP), //MOVE_SAND_TOMB),
    LEVEL_UP_MOVE(28, MOVE_SLASH),
    LEVEL_UP_MOVE(33, MOVE_PH_BODY_2TURN), //MOVE_DIG),
    LEVEL_UP_MOVE(38, MOVE_GYRO_BALL),
    LEVEL_UP_MOVE(43, MOVE_SWORDS_DANCE),
    LEVEL_UP_MOVE(48, MOVE_PH_WEATHER), //MOVE_SANDSTORM),
    LEVEL_UP_MOVE(53, MOVE_PH_SPATK_ADJACENT2),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sNidorinaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(35, MOVE_PH_HAZARD), //MOVE_TOXIC_SPIKES),
    LEVEL_UP_MOVE(38, MOVE_FLATTER),
    LEVEL_UP_MOVE(43, MOVE_CRUNCH),
    LEVEL_UP_MOVE(50, MOVE_CAPTIVATE),
    LEVEL_UP_MOVE(58, MOVE_PH_BITE), //MOVE_POISON_FANG),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sNidoqueenLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(43, MOVE_PH_ELEMENT_STRONG + MOVES_PH_TYPE2), //MOVE_EARTH_POWER),
...
static const struct LevelUpMove sNidoranMLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(31, MOVE_PH_HAZARD), //MOVE_TOXIC_SPIKES),
    LEVEL_UP_MOVE(33, MOVE_FLATTER),
    LEVEL_UP_MOVE(37, MOVE_PH_HORN), //MOVE_POISON_JAB),
    LEVEL_UP_MOVE(43, MOVE_CAPTIVATE),
...
static const struct LevelUpMove sNidorinoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(35, MOVE_PH_HAZARD), //MOVE_TOXIC_SPIKES),
    LEVEL_UP_MOVE(38, MOVE_FLATTER),
    LEVEL_UP_MOVE(43, MOVE_PH_HORN), //MOVE_POISON_JAB),
    LEVEL_UP_MOVE(50, MOVE_CAPTIVATE),
...
static const struct LevelUpMove sClefairyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISARMING_VOICE),
...
static const struct LevelUpMove sVulpixLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(15, MOVE_PH_HEAL_SAP),
    ...
    LEVEL_UP_MOVE(36, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(39, MOVE_IMPRISON),
    LEVEL_UP_MOVE(42, MOVE_PH_BEAM4), //MOVE_FIRE_BLAST),
...
static const struct LevelUpMove sJigglypuffLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(11, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2), //MOVE_DISARMING_VOICE),
    ...
    LEVEL_UP_MOVE(32, MOVE_PH_BODY),
    LEVEL_UP_MOVE(35, MOVE_GYRO_BALL),
    LEVEL_UP_MOVE(38, MOVE_MIMIC),
    LEVEL_UP_MOVE(41, MOVE_PH_SPATK_ADJACENT1),
...
static const struct LevelUpMove sWigglytuffLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_BODY + MOVES_PH_TYPE2), //MOVE_PLAY_ROUGH),
    LEVEL_UP_MOVE( 1, MOVE_SING),
    LEVEL_UP_MOVE( 1, MOVE_DEFENSE_CURL),
...
static const struct LevelUpMove sZubatLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(19, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(23, MOVE_SWIFT),
    LEVEL_UP_MOVE(25, MOVE_PH_BITE), //MOVE_POISON_FANG),
    LEVEL_UP_MOVE(29, MOVE_MEAN_LOOK),
    LEVEL_UP_MOVE(31, MOVE_LEECH_LIFE),
    LEVEL_UP_MOVE(35, MOVE_HAZE),
    LEVEL_UP_MOVE(37, MOVE_PH_VARDMG), //MOVE_VENOSHOCK),
    LEVEL_UP_MOVE(41, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
...
static const struct LevelUpMove sGolbatLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(27, MOVE_PH_BITE), //MOVE_POISON_FANG),
    LEVEL_UP_MOVE(32, MOVE_MEAN_LOOK),
    LEVEL_UP_MOVE(35, MOVE_LEECH_LIFE),
    LEVEL_UP_MOVE(40, MOVE_HAZE),
    LEVEL_UP_MOVE(43, MOVE_PH_VARDMG), //MOVE_VENOSHOCK),
    LEVEL_UP_MOVE(48, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
...
static const struct LevelUpMove sOddishLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 9, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2), //MOVE_ACID),
    LEVEL_UP_MOVE(13, MOVE_PH_STATUS4 + MOVES_PH_TYPE2), //MOVE_POISON_POWDER),
    ...
    LEVEL_UP_MOVE(31, MOVE_PH_BEAM2),
    LEVEL_UP_MOVE(35, MOVE_PH_STATUS3 + MOVES_PH_TYPE2), //MOVE_TOXIC),
...
static const struct LevelUpMove sGloomLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2), //MOVE_ACID),
    LEVEL_UP_MOVE( 5, MOVE_SWEET_SCENT),
    LEVEL_UP_MOVE( 9, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2), //MOVE_ACID),
    LEVEL_UP_MOVE(13, MOVE_PH_STATUS4 + MOVES_PH_TYPE2), //MOVE_POISON_POWDER),
    LEVEL_UP_MOVE(14, MOVE_STUN_SPORE),
    ...
    LEVEL_UP_MOVE(34, MOVE_PH_BEAM2),
    LEVEL_UP_MOVE(39, MOVE_PH_STATUS3 + MOVES_PH_TYPE2), //MOVE_TOXIC),
...
static const struct LevelUpMove sVileplumeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_STATUS4 + MOVES_PH_TYPE2), //MOVE_POISON_POWDER),
    LEVEL_UP_MOVE( 1, MOVE_STUN_SPORE),
    LEVEL_UP_MOVE(49, MOVE_PETAL_BLIZZARD),
    LEVEL_UP_MOVE(59, MOVE_PETAL_DANCE),
    LEVEL_UP_MOVE(69, MOVE_PH_BEAM4),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sParasectLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(44, MOVE_PH_BEAM2 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(51, MOVE_AROMATHERAPY),
    LEVEL_UP_MOVE(59, MOVE_RAGE_POWDER),
    LEVEL_UP_MOVE(66, MOVE_PH_BLADE), //MOVE_X_SCISSOR),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sVenonatLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(41, MOVE_PH_BITE + MOVES_PH_TYPE2), //MOVE_POISON_FANG),
...
static const struct LevelUpMove sVenomothLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(47, MOVE_PH_BITE + MOVES_PH_TYPE2), //MOVE_POISON_FANG),
    LEVEL_UP_MOVE(55, MOVE_PSYCHIC),
    LEVEL_UP_MOVE(59, MOVE_PH_BEAM3),
...
static const struct LevelUpMove sDiglettLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 7, MOVE_ASTONISH),
    LEVEL_UP_MOVE(10, MOVE_PH_ELEMENT_WEAK), //MOVE_MUD_SLAP),
    LEVEL_UP_MOVE(14, MOVE_PH_VARDMG), //MOVE_MAGNITUDE),
    LEVEL_UP_MOVE(18, MOVE_PH_PRIORITY), //MOVE_BULLDOZE),
    LEVEL_UP_MOVE(22, MOVE_SUCKER_PUNCH),
    LEVEL_UP_MOVE(25, MOVE_PH_BALL),
    LEVEL_UP_MOVE(28, MOVE_PH_ELEMENT_STRONG), //MOVE_EARTH_POWER),
    LEVEL_UP_MOVE(31, MOVE_PH_BODY_2TURN), //MOVE_DIG),
    LEVEL_UP_MOVE(35, MOVE_SLASH),
    LEVEL_UP_MOVE(39, MOVE_PH_SPATK_ADJACENT2),
    LEVEL_UP_MOVE(43, MOVE_FISSURE),
    LEVEL_UP_END
};

static const struct LevelUpMove sDugtrioLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_ATK_TRAP), //MOVE_SAND_TOMB),
    LEVEL_UP_MOVE( 1, MOVE_PH_ATK_TRAP), //MOVE_SAND_TOMB),
    ...
    LEVEL_UP_MOVE(22, MOVE_SUCKER_PUNCH),
    LEVEL_UP_MOVE(25, MOVE_PH_BALL),
    LEVEL_UP_MOVE(30, MOVE_PH_ELEMENT_STRONG), //MOVE_EARTH_POWER),
    LEVEL_UP_MOVE(35, MOVE_PH_BODY_2TURN), //MOVE_DIG),
    LEVEL_UP_MOVE(41, MOVE_SLASH),
    LEVEL_UP_MOVE(47, MOVE_PH_SPATK_ADJACENT2),
...
static const struct LevelUpMove sMeowthLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(14, MOVE_PH_ATK_WEAK), //MOVE_FURY_SWIPES),
    LEVEL_UP_MOVE(17, MOVE_SCREECH),
    ...
    LEVEL_UP_MOVE(49, ORIGINAL_TYPE_MOVE(MOVE_PH_BLADE2, TYPE_DARK)), //MOVE_NIGHT_SLASH),
    LEVEL_UP_MOVE(50, MOVE_FEINT),
    LEVEL_UP_END
};

static const struct LevelUpMove sPersianLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_SWIFT), //MOVE_SWIFT),
    LEVEL_UP_MOVE( 1, MOVE_PH_SWIFT), //MOVE_SWIFT),
    ...
    LEVEL_UP_MOVE(22, MOVE_FEINT_ATTACK),
    LEVEL_UP_MOVE(25, MOVE_TAUNT),
    LEVEL_UP_MOVE(32, ORIGINAL_TYPE_MOVE(MOVE_PH_ELEMENT_STRONG, TYPE_ROCK)), //MOVE_POWER_GEM),
...
static const struct LevelUpMove sGolduckLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_BODY_ATK_SPEED), //MOVE_AQUA_JET),
    LEVEL_UP_MOVE( 1, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK),
    ...
    LEVEL_UP_MOVE(46, MOVE_PH_BEAM3),
...
static const struct LevelUpMove sMankeyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 8, MOVE_PH_BLADE2), //MOVE_KARATE_CHOP),
    LEVEL_UP_MOVE(12, MOVE_PURSUIT),
    LEVEL_UP_MOVE(15, MOVE_PH_VARDMG), //MOVE_SEISMIC_TOSS),
    ...
    LEVEL_UP_MOVE(36, MOVE_PH_BODY_RECOIL), //MOVE_CLOSE_COMBAT),
...
static const struct LevelUpMove sPrimeapeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(35, MOVE_THRASH),
    LEVEL_UP_MOVE(39, MOVE_PH_BODY_RECOIL), //MOVE_CLOSE_COMBAT),
...
static const struct LevelUpMove sArcanineLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_BITE), //MOVE_FIRE_FANG),
...
static const struct LevelUpMove sPoliwagLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE( 5, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 8, MOVE_HYPNOSIS),
    LEVEL_UP_MOVE(11, MOVE_PH_ELEMENT_WEAK2),
    LEVEL_UP_MOVE(15, MOVE_DOUBLE_SLAP),
    LEVEL_UP_MOVE(18, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
    LEVEL_UP_MOVE(21, MOVE_BODY_SLAM),
    LEVEL_UP_MOVE(25, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE(28, MOVE_MUD_SHOT),
    LEVEL_UP_MOVE(31, MOVE_BELLY_DRUM),
    LEVEL_UP_MOVE(35, MOVE_WAKE_UP_SLAP),
    LEVEL_UP_MOVE(38, MOVE_PH_BEAM3),
    LEVEL_UP_MOVE(41, MOVE_PH_BALL),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sPoliwhirlLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(18, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
    LEVEL_UP_MOVE(21, MOVE_BODY_SLAM),
    LEVEL_UP_MOVE(27, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE(32, MOVE_MUD_SHOT),
    LEVEL_UP_MOVE(37, MOVE_BELLY_DRUM),
    LEVEL_UP_MOVE(43, MOVE_WAKE_UP_SLAP),
    LEVEL_UP_MOVE(48, MOVE_PH_BEAM3),
    LEVEL_UP_MOVE(53, MOVE_PH_BALL),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sPoliwrathLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE( 1, MOVE_HYPNOSIS),
    LEVEL_UP_MOVE( 1, MOVE_DOUBLE_SLAP),
...
static const struct LevelUpMove sKadabraLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_TELEPORT),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE(16, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE(18, MOVE_DISABLE),
    LEVEL_UP_MOVE(21, MOVE_PH_BEAM1), //MOVE_PSYBEAM),
    LEVEL_UP_MOVE(23, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE(26, MOVE_REFLECT),
    LEVEL_UP_MOVE(28, MOVE_PH_BLADE2), //MOVE_PSYCHO_CUT),
    LEVEL_UP_MOVE(31, MOVE_RECOVER),
    LEVEL_UP_MOVE(33, MOVE_TELEKINESIS),
    LEVEL_UP_MOVE(36, MOVE_ALLY_SWITCH),
    LEVEL_UP_MOVE(38, MOVE_PH_BEAM2), //MOVE_PSYCHIC),
    LEVEL_UP_MOVE(41, MOVE_ROLE_PLAY),
    LEVEL_UP_MOVE(43, MOVE_PH_BEAM3), //MOVE_FUTURE_SIGHT),
...
static const struct LevelUpMove sMachopLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 7, MOVE_PH_BLADE2), //MOVE_KARATE_CHOP),
    ...
    LEVEL_UP_MOVE(25, MOVE_PH_ATK_THROW), //MOVE_VITAL_THROW),
    LEVEL_UP_MOVE(27, MOVE_WAKE_UP_SLAP),
...
static const struct LevelUpMove sMachokeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE( 1, MOVE_PH_BLADE2), //MOVE_KARATE_CHOP),
    LEVEL_UP_MOVE( 3, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE( 7, MOVE_PH_BLADE2), //MOVE_KARATE_CHOP),
    LEVEL_UP_MOVE( 9, MOVE_FORESIGHT),
    LEVEL_UP_MOVE(13, MOVE_LOW_SWEEP),
...
static const struct LevelUpMove sBellsproutLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_SLEEP_POWDER),
    LEVEL_UP_MOVE(15, MOVE_PH_STATUS4 + MOVES_PH_TYPE2), //MOVE_POISON_POWDER),
    LEVEL_UP_MOVE(17, MOVE_STUN_SPORE),
    LEVEL_UP_MOVE(23, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2), //MOVE_ACID),
    LEVEL_UP_MOVE(27, MOVE_KNOCK_OFF),
    LEVEL_UP_MOVE(29, MOVE_SWEET_SCENT),
    LEVEL_UP_MOVE(35, MOVE_PH_TYPE_EFF + MOVES_PH_TYPE2), //MOVE_GASTRO_ACID),
    LEVEL_UP_MOVE(39, MOVE_PH_SPATK_ADJACENT1), //MOVE_RAZOR_LEAF),
    LEVEL_UP_MOVE(41, MOVE_PH_PRIORITY + MOVES_PH_TYPE2), //MOVE_POISON_JAB),
...
static const struct LevelUpMove sWeepinbellLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(15, MOVE_PH_STATUS4 + MOVES_PH_TYPE2), //MOVE_POISON_POWDER),
    LEVEL_UP_MOVE(17, MOVE_STUN_SPORE),
    LEVEL_UP_MOVE(24, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2), //MOVE_ACID),
    LEVEL_UP_MOVE(29, MOVE_KNOCK_OFF),
    LEVEL_UP_MOVE(32, MOVE_SWEET_SCENT),
    LEVEL_UP_MOVE(39, MOVE_PH_TYPE_EFF + MOVES_PH_TYPE2), //MOVE_GASTRO_ACID),
    LEVEL_UP_MOVE(44, MOVE_PH_SPATK_ADJACENT1), //MOVE_RAZOR_LEAF),
    LEVEL_UP_MOVE(47, MOVE_PH_PRIORITY + MOVES_PH_TYPE2), //MOVE_POISON_JAB),
...
static const struct LevelUpMove sVictreebelLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_STRONGWIND), //MOVE_LEAF_TORNADO),
    LEVEL_UP_MOVE( 1, MOVE_PH_STRONGWIND), //MOVE_LEAF_TORNADO),
    ...
    LEVEL_UP_MOVE( 1, MOVE_SWEET_SCENT),
    LEVEL_UP_MOVE( 1, MOVE_PH_SPATK_ADJACENT1), //MOVE_RAZOR_LEAF),
    LEVEL_UP_MOVE(32, MOVE_PH_BEAM3),
    LEVEL_UP_MOVE(44, MOVE_PH_BLADE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sTentacoolLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(10, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2), //MOVE_ACID),
    LEVEL_UP_MOVE(13, MOVE_PH_HAZARD + MOVES_PH_TYPE2), //MOVE_TOXIC_SPIKES),
    LEVEL_UP_MOVE(16, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(19, MOVE_WRAP),
    LEVEL_UP_MOVE(22, MOVE_ACID_SPRAY),
    LEVEL_UP_MOVE(25, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE(28, MOVE_BARRIER),
    LEVEL_UP_MOVE(31, MOVE_PH_PRIORITY + MOVES_PH_TYPE2), //MOVE_POISON_JAB),
    LEVEL_UP_MOVE(34, MOVE_PH_VARDMG), //MOVE_BRINE),
    LEVEL_UP_MOVE(37, MOVE_SCREECH),
    LEVEL_UP_MOVE(40, MOVE_HEX),
    LEVEL_UP_MOVE(43, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2), //MOVE_SLUDGE_WAVE),
    LEVEL_UP_MOVE(46, MOVE_PH_BEAM3),
...
static const struct LevelUpMove sTentacruelLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(25, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE(28, MOVE_BARRIER),
    LEVEL_UP_MOVE(32, MOVE_PH_PRIORITY + MOVES_PH_TYPE2), //MOVE_POISON_JAB),
    LEVEL_UP_MOVE(36, MOVE_PH_VARDMG), //MOVE_BRINE),
    LEVEL_UP_MOVE(40, MOVE_SCREECH),
    LEVEL_UP_MOVE(44, MOVE_HEX),
    LEVEL_UP_MOVE(48, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2), //MOVE_SLUDGE_WAVE),
    LEVEL_UP_MOVE(52, MOVE_PH_BEAM3),
...
static const struct LevelUpMove sGeodudeLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_DEFENSE_CURL),
    LEVEL_UP_MOVE( 4, MOVE_PH_TYPE_EFF + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 6, MOVE_ROCK_POLISH),
    LEVEL_UP_MOVE(10, MOVE_PH_ELEMENT_WEAK), //MOVE_ROLLOUT),
    LEVEL_UP_MOVE(12, MOVE_PH_VARDMG + MOVES_PH_TYPE2), //MOVE_MAGNITUDE),
    LEVEL_UP_MOVE(16, MOVE_PH_ATK_THROW), //MOVE_ROCK_THROW),
    LEVEL_UP_MOVE(18, MOVE_SMACK_DOWN),
    LEVEL_UP_MOVE(22, MOVE_PH_PRIORITY + MOVES_PH_TYPE2), //MOVE_BULLDOZE),
    LEVEL_UP_MOVE(24, MOVE_SELF_DESTRUCT),
    LEVEL_UP_MOVE(28, MOVE_PH_HAZARD), //MOVE_STEALTH_ROCK),
    LEVEL_UP_MOVE(30, MOVE_PH_ATK_WEAK), //MOVE_ROCK_BLAST),
    LEVEL_UP_MOVE(34, MOVE_PH_SPATK_ADJACENT2 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(36, MOVE_EXPLOSION),
    LEVEL_UP_MOVE(40, MOVE_DOUBLE_EDGE),
    LEVEL_UP_MOVE(42, MOVE_PH_HORN), //MOVE_STONE_EDGE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sGravelerLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_DEFENSE_CURL),
    LEVEL_UP_MOVE( 1, MOVE_PH_TYPE_EFF + MOVES_PH_TYPE2),
    ...
    LEVEL_UP_MOVE(22, MOVE_PH_PRIORITY + MOVES_PH_TYPE2), //MOVE_BULLDOZE),
    LEVEL_UP_MOVE(24, MOVE_SELF_DESTRUCT),
    LEVEL_UP_MOVE(30, MOVE_PH_HAZARD), //MOVE_STEALTH_ROCK),
    LEVEL_UP_MOVE(34, MOVE_PH_ATK_WEAK), //MOVE_ROCK_BLAST),
    LEVEL_UP_MOVE(40, MOVE_PH_SPATK_ADJACENT2 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(44, MOVE_EXPLOSION),
    LEVEL_UP_MOVE(50, MOVE_DOUBLE_EDGE),
    LEVEL_UP_MOVE(54, MOVE_PH_HORN), //MOVE_STONE_EDGE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sPonytaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 4, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE( 9, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE(13, MOVE_PH_HEAD), //MOVE_FLAME_WHEEL),
    LEVEL_UP_MOVE(17, MOVE_STOMP),
    LEVEL_UP_MOVE(21, MOVE_PH_PRIORITY),
    LEVEL_UP_MOVE(25, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(29, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(33, MOVE_INFERNO),
    LEVEL_UP_MOVE(37, MOVE_AGILITY),
    LEVEL_UP_MOVE(41, MOVE_PH_BEAM4), //MOVE_FIRE_BLAST),
    LEVEL_UP_MOVE(45, MOVE_BOUNCE),
    LEVEL_UP_MOVE(49, MOVE_PH_BODY),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSlowpokeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, ORIGINAL_TYPE_MOVE(MOVE_PH_STATUS2, TYPE_NORMAL)), //MOVE_YAWN),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 5, MOVE_GROWL),
    LEVEL_UP_MOVE( 9, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE(14, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(19, MOVE_DISABLE),
    LEVEL_UP_MOVE(23, MOVE_HEADBUTT),
    LEVEL_UP_MOVE(28, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(32, MOVE_ZEN_HEADBUTT),
    LEVEL_UP_MOVE(36, MOVE_SLACK_OFF),
    LEVEL_UP_MOVE(41, MOVE_AMNESIA),
    LEVEL_UP_MOVE(45, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_PSYCHIC),
    LEVEL_UP_MOVE(49, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
...
static const struct LevelUpMove sSlowbroLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(49, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_PSYCHIC),
    LEVEL_UP_MOVE(55, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
...
static const struct LevelUpMove sMagnemiteLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_SUPERSONIC),
    LEVEL_UP_MOVE( 5, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 7, MOVE_PH_STATUS3), //MOVE_THUNDER_WAVE),
    LEVEL_UP_MOVE(11, MOVE_MAGNET_BOMB),
    LEVEL_UP_MOVE(13, MOVE_LIGHT_SCREEN),
    LEVEL_UP_MOVE(17, MOVE_SONIC_BOOM),
    LEVEL_UP_MOVE(19, MOVE_PH_HEAD), //MOVE_SPARK),
    LEVEL_UP_MOVE(23, MOVE_MIRROR_SHOT),
    LEVEL_UP_MOVE(25, MOVE_METAL_SOUND),
    LEVEL_UP_MOVE(29, MOVE_PH_VARDMG), //MOVE_ELECTRO_BALL),
    LEVEL_UP_MOVE(31, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_FLASH_CANNON),
    LEVEL_UP_MOVE(35, MOVE_SCREECH),
    LEVEL_UP_MOVE(37, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISCHARGE),
...
static const struct LevelUpMove sMagnetonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_SUPERSONIC),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 1, MOVE_PH_STATUS3), //MOVE_THUNDER_WAVE),
    LEVEL_UP_MOVE( 5, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 7, MOVE_PH_STATUS3), //MOVE_THUNDER_WAVE),
    LEVEL_UP_MOVE(11, MOVE_MAGNET_BOMB),
    LEVEL_UP_MOVE(13, MOVE_LIGHT_SCREEN),
    ...
    LEVEL_UP_MOVE(25, MOVE_METAL_SOUND),
    LEVEL_UP_MOVE(29, MOVE_PH_VARDMG), //MOVE_ELECTRO_BALL),
    LEVEL_UP_MOVE(33, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_FLASH_CANNON),
    LEVEL_UP_MOVE(39, MOVE_SCREECH),
    LEVEL_UP_MOVE(43, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISCHARGE),
...
static const struct LevelUpMove sFarfetchdLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_PH_BODY_RECOIL + MOVES_PH_TYPE2), //MOVE_BRAVE_BIRD),
    LEVEL_UP_MOVE( 1, MOVE_POISON_JAB),
    LEVEL_UP_MOVE( 1, MOVE_PECK),
    LEVEL_UP_MOVE( 1, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    ...
    LEVEL_UP_MOVE( 9, MOVE_PH_BLADE + MOVES_PH_TYPE2), //MOVE_AERIAL_ACE),
    LEVEL_UP_MOVE(13, MOVE_KNOCK_OFF),
    LEVEL_UP_MOVE(19, MOVE_SLASH),
    LEVEL_UP_MOVE(21, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(25, MOVE_SWORDS_DANCE),
    LEVEL_UP_MOVE(31, MOVE_AGILITY),
    LEVEL_UP_MOVE(33, ORIGINAL_TYPE_MOVE(MOVE_PH_BLADE2, TYPE_DARK)), //MOVE_NIGHT_SLASH),
    LEVEL_UP_MOVE(37, MOVE_ACROBATICS),
    LEVEL_UP_MOVE(43, MOVE_FEINT),
    LEVEL_UP_MOVE(45, MOVE_FALSE_SWIPE),
    LEVEL_UP_MOVE(49, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
    LEVEL_UP_MOVE(55, MOVE_PH_BODY_RECOIL + MOVES_PH_TYPE2), //MOVE_BRAVE_BIRD),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSeelLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 3, MOVE_GROWL),
    LEVEL_UP_MOVE( 7, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE(11, MOVE_ICY_WIND),
    LEVEL_UP_MOVE(13, MOVE_ENCORE),
    LEVEL_UP_MOVE(17, MOVE_ICE_SHARD),
    LEVEL_UP_MOVE(21, MOVE_REST),
    LEVEL_UP_MOVE(23, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(27, ORIGINAL_TYPE_MOVE(MOVE_PH_BEAM1 + MOVES_PH_TYPE2, TYPE_ICE)), //MOVE_AURORA_BEAM),
    LEVEL_UP_MOVE(31, MOVE_PH_PRIORITY), //MOVE_AQUA_JET),
    LEVEL_UP_MOVE(33, MOVE_PH_VARDMG), //MOVE_BRINE),
    LEVEL_UP_MOVE(37, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(41, MOVE_PH_BODY_2TURN), //MOVE_DIVE),
    LEVEL_UP_MOVE(43, MOVE_PH_TAIL), //MOVE_AQUA_TAIL),
    LEVEL_UP_MOVE(47, ORIGINAL_TYPE_MOVE(MOVE_PH_BEAM2 + MOVES_PH_TYPE2, TYPE_ICE)), //MOVE_ICE_BEAM),
...
static const struct LevelUpMove sDewgongLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(21, MOVE_REST),
    LEVEL_UP_MOVE(23, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(27, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AURORA_BEAM),
    LEVEL_UP_MOVE(31, MOVE_PH_PRIORITY), //MOVE_AQUA_JET),
    LEVEL_UP_MOVE(33, MOVE_PH_VARDMG), //MOVE_BRINE),
    LEVEL_UP_MOVE(39, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(45, MOVE_PH_BODY_2TURN), //MOVE_DIVE),
    LEVEL_UP_MOVE(49, MOVE_PH_TAIL), //MOVE_AQUA_TAIL),
    LEVEL_UP_MOVE(55, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_ICE_BEAM),
...
static const struct LevelUpMove sGrimerLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_POUND),
    LEVEL_UP_MOVE( 1, MOVE_PH_STATUS), //MOVE_POISON_GAS),
    ...
    LEVEL_UP_MOVE(29, MOVE_PH_BEAM2), //MOVE_SLUDGE_BOMB),
    LEVEL_UP_MOVE(32, MOVE_PH_SPATK_ADJACENT1), //MOVE_SLUDGE_WAVE),
    LEVEL_UP_MOVE(37, MOVE_SCREECH),
...
static const struct LevelUpMove sShellderLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(32, MOVE_PH_HORN), //MOVE_RAZOR_SHELL),
    LEVEL_UP_MOVE(37, ORIGINAL_TYPE_MOVE(MOVE_PH_BEAM1 + MOVES_PH_TYPE2, TYPE_ICE)), //MOVE_AURORA_BEAM),
    LEVEL_UP_MOVE(40, MOVE_PH_HAZARD),
    LEVEL_UP_MOVE(44, MOVE_PH_VARDMG), //MOVE_BRINE),
    LEVEL_UP_MOVE(49, MOVE_IRON_DEFENSE),
    LEVEL_UP_MOVE(52, ORIGINAL_TYPE_MOVE(MOVE_PH_BEAM2 + MOVES_PH_TYPE2, TYPE_ICE)), //MOVE_ICE_BEAM),
    LEVEL_UP_MOVE(56, MOVE_SHELL_SMASH),
    LEVEL_UP_MOVE(61, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sCloysterLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AURORA_BEAM),
...
static const struct LevelUpMove sHaunterLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(33, MOVE_PH_BEAM2), //MOVE_SHADOW_BALL),
...
static const struct LevelUpMove sOnixLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 7, MOVE_PH_ATK_THROW), //MOVE_ROCK_THROW),
    LEVEL_UP_MOVE(10, MOVE_ROCK_TOMB),
    LEVEL_UP_MOVE(13, MOVE_RAGE),
    LEVEL_UP_MOVE(16, MOVE_PH_HAZARD), //MOVE_STEALTH_ROCK),
    ...
    LEVEL_UP_MOVE(34, MOVE_PH_SPATK_ADJACENT1), //MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE(37, MOVE_PH_ATK_TRAP + MOVES_PH_TYPE2), //MOVE_SAND_TOMB),
    LEVEL_UP_MOVE(40, MOVE_IRON_TAIL),
    LEVEL_UP_MOVE(43, MOVE_PH_BODY_2TURN + MOVES_PH_TYPE2), //MOVE_DIG),
    LEVEL_UP_MOVE(46, MOVE_PH_HORN), //MOVE_STONE_EDGE),
    LEVEL_UP_MOVE(49, MOVE_DOUBLE_EDGE),
    LEVEL_UP_MOVE(52, MOVE_PH_WEATHER + MOVES_PH_TYPE2), //MOVE_SANDSTORM),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sDrowzeeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(25, MOVE_PH_BEAM1), //MOVE_PSYBEAM),
    ...
    LEVEL_UP_MOVE(49, MOVE_PH_BEAM2), //MOVE_PSYCHIC),
    LEVEL_UP_MOVE(53, MOVE_NASTY_PLOT),
    LEVEL_UP_MOVE(57, MOVE_PSYSHOCK),
    LEVEL_UP_MOVE(61, MOVE_PH_BEAM3), //MOVE_FUTURE_SIGHT),
    LEVEL_UP_END
};

static const struct LevelUpMove sHypnoLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM3), //MOVE_FUTURE_SIGHT),
    LEVEL_UP_MOVE( 1, MOVE_NASTY_PLOT),
...
static const struct LevelUpMove sKrabbyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK2),
    LEVEL_UP_MOVE( 5, MOVE_VISE_GRIP),
    LEVEL_UP_MOVE( 9, MOVE_LEER),
    LEVEL_UP_MOVE(11, MOVE_HARDEN),
    LEVEL_UP_MOVE(15, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    ...
    LEVEL_UP_MOVE(39, MOVE_PH_VARDMG), //MOVE_BRINE),
...
static const struct LevelUpMove sKinglerLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(51, MOVE_PH_VARDMG), //MOVE_BRINE),
...
static const struct LevelUpMove sElectrodeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(41, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISCHARGE),
...
static const struct LevelUpMove sExeggcuteLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(11, MOVE_PH_HEAL_SAP),
    ...
    LEVEL_UP_MOVE(27, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(33, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE(37, MOVE_NATURAL_GIFT),
    LEVEL_UP_MOVE(43, MOVE_PH_BEAM4),
    LEVEL_UP_MOVE(47, MOVE_PH_BALL + MOVES_PH_TYPE2), //MOVE_EXTRASENSORY),
...
static const struct LevelUpMove sExeggutorLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(47, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sHitmonleeLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_FEET_MULTIHIT_FIXED),
    LEVEL_UP_MOVE( 1, MOVE_PH_FEET_MULTIHIT_FIXED),
    LEVEL_UP_MOVE( 1, MOVE_REVERSAL),
    LEVEL_UP_MOVE( 1, MOVE_PH_BODY_RECOIL), //MOVE_CLOSE_COMBAT),
    ...
    LEVEL_UP_MOVE(57, MOVE_PH_BODY_RECOIL), //MOVE_CLOSE_COMBAT),
...
static const struct LevelUpMove sHitmonchanLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PURSUIT),
    LEVEL_UP_MOVE( 1, MOVE_PH_PRIORITY), //MOVE_MACH_PUNCH),
    LEVEL_UP_MOVE( 6, MOVE_AGILITY),
    LEVEL_UP_MOVE(11, MOVE_PURSUIT),
    LEVEL_UP_MOVE(16, MOVE_PH_PRIORITY), //MOVE_MACH_PUNCH),
    ...
    LEVEL_UP_MOVE(66, MOVE_PH_BODY_RECOIL), //MOVE_CLOSE_COMBAT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sLickitungLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, ORIGINAL_TYPE_MOVE(MOVE_PH_HORN, TYPE_DARK)), //MOVE_KNOCK_OFF),
    LEVEL_UP_MOVE(17, MOVE_WRAP),
    LEVEL_UP_MOVE(21, MOVE_STOMP),
    LEVEL_UP_MOVE(25, MOVE_DISABLE),
    LEVEL_UP_MOVE(29, MOVE_SLAM),
    LEVEL_UP_MOVE(33, ORIGINAL_TYPE_MOVE(MOVE_PH_ELEMENT_WEAK, TYPE_ROCK)), //MOVE_ROLLOUT),
    LEVEL_UP_MOVE(37, MOVE_PH_BLADE2), //MOVE_CHIP_AWAY),
...
static const struct LevelUpMove sKoffingLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(34, MOVE_PH_BEAM2), //MOVE_SLUDGE_BOMB),
...
static const struct LevelUpMove sRhyhornLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(17, MOVE_STOMP),
    LEVEL_UP_MOVE(21, MOVE_PH_PRIORITY), //MOVE_BULLDOZE),
    LEVEL_UP_MOVE(25, MOVE_CHIP_AWAY),
    LEVEL_UP_MOVE(29, MOVE_PH_ATK_WEAK + MOVES_PH_TYPE2), //MOVE_ROCK_BLAST),
    LEVEL_UP_MOVE(33, MOVE_DRILL_RUN),
    LEVEL_UP_MOVE(37, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(41, MOVE_PH_HORN + MOVES_PH_TYPE2), //MOVE_STONE_EDGE),
    LEVEL_UP_MOVE(45, MOVE_PH_SPATK_ADJACENT2),
...
static const struct LevelUpMove sRhydonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(37, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(41, MOVE_PH_HORN + MOVES_PH_TYPE2), //MOVE_STONE_EDGE),
    LEVEL_UP_MOVE(48, MOVE_PH_SPATK_ADJACENT2),
...
static const struct LevelUpMove sChanseyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(27, MOVE_PH_BODY_RECOIL), //MOVE_TAKE_DOWN),
...
static const struct LevelUpMove sKangaskhanLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(19, MOVE_PH_FEET_MULTIHIT_FIXED),
    LEVEL_UP_MOVE(22, MOVE_RAGE),
    LEVEL_UP_MOVE(25, MOVE_MEGA_PUNCH),
    LEVEL_UP_MOVE(31, MOVE_PH_BLADE2), //MOVE_CHIP_AWAY),
...
static const struct LevelUpMove sHorseaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 9, MOVE_LEER),
    LEVEL_UP_MOVE(13, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE(17, ORIGINAL_TYPE_MOVE(MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2, TYPE_DRAGON)), //MOVE_TWISTER),
    LEVEL_UP_MOVE(21, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE(26, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE(31, MOVE_PH_VARDMG), //MOVE_BRINE),
    LEVEL_UP_MOVE(36, MOVE_AGILITY),
    LEVEL_UP_MOVE(41, ORIGINAL_TYPE_MOVE(MOVE_PH_BEAM2 + MOVES_PH_TYPE2, TYPE_DRAGON)), //MOVE_DRAGON_PULSE),
...
static const struct LevelUpMove sSeadraLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(31, MOVE_PH_VARDMG), //MOVE_BRINE),
    LEVEL_UP_MOVE(38, MOVE_AGILITY),
    LEVEL_UP_MOVE(45, ORIGINAL_TYPE_MOVE(MOVE_PH_BEAM2 + MOVES_PH_TYPE2, TYPE_DRAGON)), //MOVE_DRAGON_PULSE),
...
static const struct LevelUpMove sGoldeenLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(16, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(21, MOVE_PH_HEAL_SAP),
...
static const struct LevelUpMove sStaryuLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(42, ORIGINAL_TYPE_MOVE(MOVE_PH_BEAM2 + MOVES_PH_TYPE2, TYPE_PSYCHIC)), //MOVE_PSYCHIC),
    LEVEL_UP_MOVE(46, MOVE_LIGHT_SCREEN),
    LEVEL_UP_MOVE(49, MOVE_COSMIC_POWER),
    LEVEL_UP_MOVE(53, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMrMimeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(39, MOVE_PH_BEAM2), //MOVE_PSYCHIC),
...
static const struct LevelUpMove sScytherLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(41, MOVE_PH_BLADE), //MOVE_X_SCISSOR),
    LEVEL_UP_MOVE(45, MOVE_NIGHT_SLASH),
    LEVEL_UP_MOVE(49, MOVE_DOUBLE_HIT),
    LEVEL_UP_MOVE(50, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
...
static const struct LevelUpMove sJynxLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(60, MOVE_PH_SPATK_ADJACENT2), //MOVE_BLIZZARD),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sElectabuzzLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(19, MOVE_PH_STATUS3), //MOVE_THUNDER_WAVE),
    LEVEL_UP_MOVE(22, MOVE_PH_VARDMG), //MOVE_ELECTRO_BALL),
    LEVEL_UP_MOVE(26, MOVE_LIGHT_SCREEN),
    LEVEL_UP_MOVE(29, MOVE_THUNDER_PUNCH),
    LEVEL_UP_MOVE(36, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISCHARGE),
    LEVEL_UP_MOVE(42, MOVE_SCREECH),
    LEVEL_UP_MOVE(49, MOVE_PH_ELEMENT_STRONG), //MOVE_THUNDERBOLT),
    LEVEL_UP_MOVE(55, MOVE_PH_BEAM4), //MOVE_THUNDER),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMagmarLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(22, MOVE_PH_SPATK_ADJACENT1),
    LEVEL_UP_MOVE(26, MOVE_CONFUSE_RAY),
    LEVEL_UP_MOVE(29, MOVE_PH_FIST),
    LEVEL_UP_MOVE(36, MOVE_PH_ELEMENT_STRONG2), //MOVE_LAVA_PLUME),
    LEVEL_UP_MOVE(42, MOVE_PH_WEATHER), //MOVE_SUNNY_DAY),
    LEVEL_UP_MOVE(49, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(55, MOVE_PH_BEAM4), //MOVE_FIRE_BLAST),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sPinsirLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(29, MOVE_PH_BLADE), //MOVE_X_SCISSOR),
    LEVEL_UP_MOVE(33, MOVE_SUBMISSION),
...
static const struct LevelUpMove sGyaradosLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(30, MOVE_PH_TAIL), //MOVE_AQUA_TAIL),
    LEVEL_UP_MOVE(33, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(36, MOVE_DRAGON_RAGE),
    LEVEL_UP_MOVE(39, MOVE_CRUNCH),
    LEVEL_UP_MOVE(42, MOVE_PH_BEAM3),
    LEVEL_UP_MOVE(45, MOVE_DRAGON_DANCE),
    LEVEL_UP_MOVE(48, MOVE_PH_BEAM4 + MOVES_PH_TYPE2), //MOVE_HURRICANE),
    LEVEL_UP_MOVE(51, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
...
static const struct LevelUpMove sLaprasLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(14, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(18, MOVE_BODY_SLAM),
    LEVEL_UP_MOVE(22, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
    LEVEL_UP_MOVE(27, MOVE_PERISH_SONG),
    LEVEL_UP_MOVE(32, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_ICE_BEAM),
    LEVEL_UP_MOVE(37, MOVE_PH_VARDMG), //MOVE_BRINE),
...
static const struct LevelUpMove sEeveeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_PH_PRIORITY), //MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE(17, MOVE_BITE),
    LEVEL_UP_MOVE(17, MOVE_PH_SWIFT), //MOVE_SWIFT),
    LEVEL_UP_MOVE(20, MOVE_REFRESH),
    LEVEL_UP_MOVE(25, MOVE_PH_BODY_RECOIL), //MOVE_TAKE_DOWN),
...
static const struct LevelUpMove sVaporeonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 5, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE( 9, MOVE_BABY_DOLL_EYES),
    LEVEL_UP_MOVE(13, ORIGINAL_TYPE_MOVE(MOVE_PH_PRIORITY, TYPE_NORMAL)), //MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE(17, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(20, MOVE_AURORA_BEAM),
    LEVEL_UP_MOVE(25, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(29, MOVE_ACID_ARMOR),
    LEVEL_UP_MOVE(33, MOVE_HAZE),
    LEVEL_UP_MOVE(37, MOVE_PH_SPATK_ADJACENT1_MUD),
    LEVEL_UP_MOVE(41, MOVE_LAST_RESORT),
    LEVEL_UP_MOVE(45, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sJolteonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(29, MOVE_AGILITY),
    LEVEL_UP_MOVE(33, MOVE_PH_STATUS3), //MOVE_THUNDER_WAVE),
    LEVEL_UP_MOVE(37, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISCHARGE),
    LEVEL_UP_MOVE(41, MOVE_LAST_RESORT),
    LEVEL_UP_MOVE(45, MOVE_PH_BEAM4), //MOVE_THUNDER),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sFlareonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, ORIGINAL_TYPE_MOVE(MOVE_PH_PRIORITY, TYPE_NORMAL)), //MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE(17, MOVE_BITE),
    LEVEL_UP_MOVE(20, MOVE_PH_BITE), //MOVE_FIRE_FANG),
    LEVEL_UP_MOVE(25, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(29, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(33, MOVE_SMOG),
    LEVEL_UP_MOVE(37, MOVE_PH_ELEMENT_STRONG2), //MOVE_LAVA_PLUME),
    LEVEL_UP_MOVE(41, MOVE_LAST_RESORT),
    LEVEL_UP_MOVE(45, MOVE_PH_BODY),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sPorygonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(40, ORIGINAL_TYPE_MOVE(MOVE_PH_SPATK_ADJACENT1, TYPE_ELECTRIC)), //MOVE_DISCHARGE),
...
static const struct LevelUpMove sOmanyteLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(10, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(16, MOVE_PH_ELEMENT_WEAK), //MOVE_ROLLOUT),
    LEVEL_UP_MOVE(19, MOVE_LEER),
    LEVEL_UP_MOVE(25, MOVE_MUD_SHOT),
    LEVEL_UP_MOVE(28, MOVE_PH_VARDMG + MOVES_PH_TYPE2), //MOVE_BRINE),
    LEVEL_UP_MOVE(34, MOVE_PROTECT),
    LEVEL_UP_MOVE(37, MOVE_ANCIENT_POWER),
    LEVEL_UP_MOVE(43, MOVE_TICKLE),
    LEVEL_UP_MOVE(46, MOVE_PH_ATK_WEAK), //MOVE_ROCK_BLAST),
    LEVEL_UP_MOVE(50, MOVE_SHELL_SMASH),
    LEVEL_UP_MOVE(55, MOVE_PH_BEAM3 + MOVES_PH_TYPE2),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sOmastarLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM3 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 1, MOVE_CONSTRICT),
    LEVEL_UP_MOVE( 1, MOVE_WITHDRAW),
    LEVEL_UP_MOVE( 1, MOVE_BITE),
    LEVEL_UP_MOVE( 7, MOVE_BITE),
    ...
    LEVEL_UP_MOVE(56, MOVE_PH_ATK_WEAK), //MOVE_ROCK_BLAST),
    LEVEL_UP_MOVE(67, MOVE_SHELL_SMASH),
    LEVEL_UP_MOVE(75, MOVE_PH_BEAM3 + MOVES_PH_TYPE2),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sKabutopsLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(21, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE(26, MOVE_ENDURE),
    LEVEL_UP_MOVE(31, MOVE_PH_BODY_ATK_SPEED + MOVES_PH_TYPE2), //MOVE_AQUA_JET),
    LEVEL_UP_MOVE(36, MOVE_MEGA_DRAIN),
...
static const struct LevelUpMove sAerodactylLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(73, MOVE_PH_SPATK_ADJACENT1), //MOVE_ROCK_SLIDE),
...
static const struct LevelUpMove sSnorlaxLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(17, MOVE_PH_BLADE2), //MOVE_CHIP_AWAY),
    LEVEL_UP_MOVE(20, MOVE_PH_STATUS2), //MOVE_YAWN),
    LEVEL_UP_MOVE(25, MOVE_PH_BODY),
...
static const struct LevelUpMove sArticunoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(71, MOVE_PH_BEAM2), //MOVE_ICE_BEAM),
    LEVEL_UP_MOVE(78, MOVE_PH_SPATK_ADJACENT2), //MOVE_BLIZZARD),
    LEVEL_UP_MOVE(85, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(92, MOVE_PH_BEAM4 + MOVES_PH_TYPE2), //MOVE_HURRICANE),
...
static const struct LevelUpMove sZapdosLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_PECK),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 8, MOVE_PH_STATUS3), //MOVE_THUNDER_WAVE),
    LEVEL_UP_MOVE(15, MOVE_DETECT),
    LEVEL_UP_MOVE(22, MOVE_PLUCK),
    LEVEL_UP_MOVE(29, MOVE_ANCIENT_POWER),
    LEVEL_UP_MOVE(36, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(43, MOVE_AGILITY),
    LEVEL_UP_MOVE(50, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISCHARGE),
    LEVEL_UP_MOVE(57, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
    LEVEL_UP_MOVE(64, MOVE_LIGHT_SCREEN),
    LEVEL_UP_MOVE(71, MOVE_DRILL_PECK),
    LEVEL_UP_MOVE(78, MOVE_PH_BEAM4), //MOVE_THUNDER),
    LEVEL_UP_MOVE(85, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
...
static const struct LevelUpMove sMoltresLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_WING_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 8, MOVE_PH_HEAL_SAP),
    ...
    LEVEL_UP_MOVE(43, MOVE_SAFEGUARD),
    LEVEL_UP_MOVE(50, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
    LEVEL_UP_MOVE(57, MOVE_PH_WEATHER), //MOVE_SUNNY_DAY),
...
static const struct LevelUpMove sDratiniLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(11, MOVE_PH_ELEMENT_WEAK), //MOVE_TWISTER),
    LEVEL_UP_MOVE(15, MOVE_DRAGON_RAGE),
    LEVEL_UP_MOVE(21, MOVE_SLAM),
    LEVEL_UP_MOVE(25, MOVE_AGILITY),
    LEVEL_UP_MOVE(31, MOVE_PH_TAIL), //MOVE_DRAGON_TAIL),
    LEVEL_UP_MOVE(35, MOVE_AQUA_TAIL),
    LEVEL_UP_MOVE(41, MOVE_PH_BODY), //MOVE_DRAGON_RUSH),
    LEVEL_UP_MOVE(45, MOVE_SAFEGUARD),
    LEVEL_UP_MOVE(51, MOVE_DRAGON_DANCE),
    LEVEL_UP_MOVE(55, MOVE_PH_THRASH), //MOVE_OUTRAGE),
...
static const struct LevelUpMove sDragonairLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK), //MOVE_TWISTER),
    LEVEL_UP_MOVE( 5, MOVE_THUNDER_WAVE),
    LEVEL_UP_MOVE(11, MOVE_PH_ELEMENT_WEAK), //MOVE_TWISTER),
    LEVEL_UP_MOVE(15, MOVE_DRAGON_RAGE),
    LEVEL_UP_MOVE(21, MOVE_SLAM),
    LEVEL_UP_MOVE(25, MOVE_AGILITY),
    LEVEL_UP_MOVE(33, MOVE_PH_TAIL), //MOVE_DRAGON_TAIL),
    LEVEL_UP_MOVE(39, MOVE_AQUA_TAIL),
    LEVEL_UP_MOVE(47, MOVE_PH_BODY), //MOVE_DRAGON_RUSH),
    LEVEL_UP_MOVE(53, MOVE_SAFEGUARD),
    LEVEL_UP_MOVE(61, MOVE_DRAGON_DANCE),
    LEVEL_UP_MOVE(67, MOVE_PH_THRASH), //MOVE_OUTRAGE),
...
static const struct LevelUpMove sDragoniteLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 1, MOVE_WRAP),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_THUNDER_WAVE),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK), //MOVE_TWISTER),
    ...
    LEVEL_UP_MOVE(67, MOVE_PH_THRASH), //MOVE_OUTRAGE),
    LEVEL_UP_MOVE(75, MOVE_HYPER_BEAM),
    LEVEL_UP_MOVE(81, MOVE_PH_BEAM4 + MOVES_PH_TYPE2), //MOVE_HURRICANE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMewtwoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(15, MOVE_PH_BEAM3), //MOVE_FUTURE_SIGHT),
    LEVEL_UP_MOVE(22, MOVE_PSYCH_UP),
    LEVEL_UP_MOVE(29, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE(36, MOVE_PH_BLADE2), //MOVE_PSYCHO_CUT),
    LEVEL_UP_MOVE(43, MOVE_POWER_SWAP),
    LEVEL_UP_MOVE(43, MOVE_GUARD_SWAP),
    LEVEL_UP_MOVE(50, MOVE_RECOVER),
    LEVEL_UP_MOVE(57, MOVE_PH_BEAM2), //MOVE_PSYCHIC),
...
static const struct LevelUpMove sMewLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(30, MOVE_PH_BEAM2), //MOVE_PSYCHIC),
...
static const struct LevelUpMove sChikoritaLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 6, MOVE_PH_SPATK_ADJACENT1), //MOVE_RAZOR_LEAF),
    LEVEL_UP_MOVE( 9, MOVE_POISON_POWDER),
    LEVEL_UP_MOVE(12, MOVE_PH_RECOVER), //MOVE_SYNTHESIS),
    ...
    LEVEL_UP_MOVE(45, MOVE_PH_BEAM4),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sBayleefLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(54, MOVE_PH_BEAM4),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMeganiumLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(66, MOVE_PH_BEAM4),
...
static const struct LevelUpMove sCyndaquilLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(19, MOVE_PH_HEAD), //MOVE_FLAME_WHEEL),
    LEVEL_UP_MOVE(22, MOVE_DEFENSE_CURL),
    LEVEL_UP_MOVE(28, MOVE_PH_PRIORITY),
    LEVEL_UP_MOVE(31, MOVE_SWIFT),
    LEVEL_UP_MOVE(37, MOVE_PH_ELEMENT_STRONG2), //MOVE_LAVA_PLUME),
    LEVEL_UP_MOVE(40, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(46, MOVE_INFERNO),
...
static const struct LevelUpMove sQuilavaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(10, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE(13, MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE(20, MOVE_PH_HEAD), //MOVE_FLAME_WHEEL),
    LEVEL_UP_MOVE(24, MOVE_DEFENSE_CURL),
    LEVEL_UP_MOVE(31, MOVE_SWIFT),
    LEVEL_UP_MOVE(35, MOVE_PH_PRIORITY),
    LEVEL_UP_MOVE(42, MOVE_PH_ELEMENT_STRONG2), //MOVE_LAVA_PLUME),
    LEVEL_UP_MOVE(46, MOVE_PH_BEAM1),
...
static const struct LevelUpMove sTyphlosionLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(31, MOVE_SWIFT),
    LEVEL_UP_MOVE(35, MOVE_PH_PRIORITY),
    LEVEL_UP_MOVE(43, MOVE_PH_ELEMENT_STRONG2), //MOVE_LAVA_PLUME),
    LEVEL_UP_MOVE(48, MOVE_PH_BEAM1),
...
static const struct LevelUpMove sTotodileLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(50, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sCroconawLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(51, MOVE_PH_TAIL), //MOVE_AQUA_TAIL),
...
static const struct LevelUpMove sFeraligatrLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(63, MOVE_PH_TAIL), //MOVE_AQUA_TAIL),
    LEVEL_UP_MOVE(71, MOVE_SUPERPOWER),
    LEVEL_UP_MOVE(76, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSentretLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_FORESIGHT),
    LEVEL_UP_MOVE( 4, MOVE_DEFENSE_CURL),
    LEVEL_UP_MOVE( 7, MOVE_PH_PRIORITY), //MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE(13, MOVE_PH_ATK_WEAK), //MOVE_FURY_SWIPES),
    ...
    LEVEL_UP_MOVE(47, MOVE_PH_SPATK_ADJACENT1),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sFurretLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(56, MOVE_PH_SPATK_ADJACENT1),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sHoothootLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(10, MOVE_CONFUSION),
    LEVEL_UP_MOVE(13, MOVE_PH_ELEMENT_WEAK2), //MOVE_ECHOED_VOICE),
    LEVEL_UP_MOVE(16, MOVE_ZEN_HEADBUTT),
    LEVEL_UP_MOVE(19, MOVE_PSYCHO_SHIFT),
    LEVEL_UP_MOVE(22, ORIGINAL_TYPE_MOVE(MOVE_PH_BALL, TYPE_PSYCHIC)), //MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE(25, MOVE_PH_BODY_RECOIL), //MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(28, MOVE_REFLECT),
    LEVEL_UP_MOVE(31, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
...
static const struct LevelUpMove sNoctowlLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(16, MOVE_ZEN_HEADBUTT),
    LEVEL_UP_MOVE(19, MOVE_PSYCHO_SHIFT),
    LEVEL_UP_MOVE(23, ORIGINAL_TYPE_MOVE(MOVE_PH_BALL, TYPE_PSYCHIC)), //MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE(27, MOVE_PH_BODY_RECOIL), //MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(31, MOVE_REFLECT),
    LEVEL_UP_MOVE(35, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
    LEVEL_UP_MOVE(39, MOVE_UPROAR),
    LEVEL_UP_MOVE(43, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
...
static const struct LevelUpMove sLedybaLevelUpLearnset[] = {    // BUG, FLYING
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 5, MOVE_SUPERSONIC),
    LEVEL_UP_MOVE( 8, MOVE_SWIFT),
    ...
    LEVEL_UP_MOVE(29, MOVE_AGILITY),
    LEVEL_UP_MOVE(33, MOVE_PH_BEAM3),
    LEVEL_UP_MOVE(36, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
    LEVEL_UP_MOVE(40, MOVE_DOUBLE_EDGE),
    LEVEL_UP_END
};

static const struct LevelUpMove sLedianLevelUpLearnset[] = {    // BUG, FLYING
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_SUPERSONIC),
    LEVEL_UP_MOVE( 1, MOVE_SWIFT),
    LEVEL_UP_MOVE( 5, MOVE_SUPERSONIC),
...
static const struct LevelUpMove sSpinarakLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(43, MOVE_PH_HORN + MOVES_PH_TYPE2), //MOVE_POISON_JAB),
...
static const struct LevelUpMove sAriadosLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(50, MOVE_PH_HORN + MOVES_PH_TYPE2), //MOVE_POISON_JAB),
...
static const struct LevelUpMove sChinchouLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK2),
    LEVEL_UP_MOVE( 1, MOVE_SUPERSONIC),
    LEVEL_UP_MOVE( 6, MOVE_PH_STATUS3 + MOVES_PH_TYPE2), //MOVE_THUNDER_WAVE),
    LEVEL_UP_MOVE( 9, MOVE_PH_VARDMG + MOVES_PH_TYPE2), //MOVE_ELECTRO_BALL),
    LEVEL_UP_MOVE(12, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE(17, MOVE_CONFUSE_RAY),
    LEVEL_UP_MOVE(20, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE(23, MOVE_SPARK),
    LEVEL_UP_MOVE(28, MOVE_SIGNAL_BEAM),
    LEVEL_UP_MOVE(31, MOVE_FLAIL),
    LEVEL_UP_MOVE(34, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2), //MOVE_DISCHARGE),
    LEVEL_UP_MOVE(39, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(42, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(45, MOVE_PH_BEAM3),
    LEVEL_UP_MOVE(47, MOVE_PH_TYPE_EFF + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(50, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sLanturnLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK2),
    LEVEL_UP_MOVE( 1, MOVE_SUPERSONIC),
    LEVEL_UP_MOVE( 1, MOVE_PH_STATUS3 + MOVES_PH_TYPE2), //MOVE_THUNDER_WAVE),
    LEVEL_UP_MOVE( 1, MOVE_PH_VARDMG + MOVES_PH_TYPE2), //MOVE_ELECTRO_BALL),
    LEVEL_UP_MOVE( 6, MOVE_PH_STATUS3 + MOVES_PH_TYPE2), //MOVE_THUNDER_WAVE),
    LEVEL_UP_MOVE( 9, MOVE_PH_VARDMG + MOVES_PH_TYPE2), //MOVE_ELECTRO_BALL),
    LEVEL_UP_MOVE(12, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE(17, MOVE_CONFUSE_RAY),
    LEVEL_UP_MOVE(20, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE(23, MOVE_PH_HEAD + MOVES_PH_TYPE2), //MOVE_SPARK),
    LEVEL_UP_MOVE(29, MOVE_SIGNAL_BEAM),
    LEVEL_UP_MOVE(33, MOVE_FLAIL),
    LEVEL_UP_MOVE(37, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2), //MOVE_DISCHARGE),
    LEVEL_UP_MOVE(43, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(47, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(51, MOVE_PH_BEAM3),
    LEVEL_UP_MOVE(54, MOVE_PH_TYPE_EFF + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(58, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sTogepiLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 9, MOVE_SWEET_KISS),
    LEVEL_UP_MOVE(13, ORIGINAL_TYPE_MOVE(MOVE_PH_STATUS2, TYPE_NORMAL)), //MOVE_YAWN),
...
static const struct LevelUpMove sNatuLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(33, MOVE_PH_BEAM2), //MOVE_PSYCHIC),
    LEVEL_UP_MOVE(36, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE(39, MOVE_PSYCHO_SHIFT),
    LEVEL_UP_MOVE(44, MOVE_PH_BEAM3), //MOVE_FUTURE_SIGHT),
...
static const struct LevelUpMove sXatuLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
    ...
    LEVEL_UP_MOVE(23, MOVE_CONFUSE_RAY),
    LEVEL_UP_MOVE(29, MOVE_WISH),
    LEVEL_UP_MOVE(35, MOVE_PH_BEAM2), //MOVE_PSYCHIC),
    LEVEL_UP_MOVE(39, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE(43, MOVE_PSYCHO_SHIFT),
    LEVEL_UP_MOVE(49, MOVE_PH_BEAM3), //MOVE_FUTURE_SIGHT),
...
static const struct LevelUpMove sMareepLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 4, MOVE_PH_STATUS3), //MOVE_THUNDER_WAVE),
    LEVEL_UP_MOVE( 8, MOVE_PH_ELEMENT_WEAK),
...
static const struct LevelUpMove sBellossomLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_MAGICAL_LEAF),
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM3),
    LEVEL_UP_MOVE( 1, MOVE_PH_BLADE),
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE( 1, MOVE_SWEET_SCENT),
    LEVEL_UP_MOVE( 1, MOVE_STUN_SPORE),
    LEVEL_UP_MOVE( 1, MOVE_PH_WEATHER), //MOVE_SUNNY_DAY),
    LEVEL_UP_MOVE(39, MOVE_QUIVER_DANCE),
    LEVEL_UP_MOVE(49, MOVE_PETAL_BLIZZARD),
    LEVEL_UP_MOVE(59, MOVE_PETAL_DANCE),
    LEVEL_UP_MOVE(69, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMarillLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 5, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE( 7, MOVE_PH_ELEMENT_WEAK2),
    LEVEL_UP_MOVE(10, MOVE_DEFENSE_CURL),
    LEVEL_UP_MOVE(10, MOVE_ROLLOUT),
    LEVEL_UP_MOVE(13, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE(16, MOVE_HELPING_HAND),
    LEVEL_UP_MOVE(20, MOVE_PH_TAIL), //MOVE_AQUA_TAIL),
    LEVEL_UP_MOVE(23, MOVE_PH_BODY + MOVES_PH_TYPE2), //MOVE_PLAY_ROUGH),
    LEVEL_UP_MOVE(28, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(31, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
    LEVEL_UP_MOVE(37, MOVE_DOUBLE_EDGE),
...
static const struct LevelUpMove sAzumarillLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE(16, MOVE_HELPING_HAND),
    LEVEL_UP_MOVE(21, MOVE_PH_TAIL), //MOVE_AQUA_TAIL),
    LEVEL_UP_MOVE(25, MOVE_PH_BODY + MOVES_PH_TYPE2), //MOVE_PLAY_ROUGH),
    LEVEL_UP_MOVE(31, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(35, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
    LEVEL_UP_MOVE(42, MOVE_DOUBLE_EDGE),
    LEVEL_UP_MOVE(46, MOVE_SUPERPOWER),
    LEVEL_UP_MOVE(55, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSudowoodoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_LOW_KICK),
    LEVEL_UP_MOVE( 1, MOVE_PH_ATK_THROW), //MOVE_ROCK_THROW),
    LEVEL_UP_MOVE( 5, MOVE_FLAIL),
    LEVEL_UP_MOVE( 8, MOVE_LOW_KICK),
    LEVEL_UP_MOVE(12, MOVE_PH_ATK_THROW), //MOVE_ROCK_THROW),
    LEVEL_UP_MOVE(15, MOVE_MIMIC),
    ...
    LEVEL_UP_MOVE(33, MOVE_PH_SPATK_ADJACENT1), //MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE(36, MOVE_COUNTER),
    LEVEL_UP_MOVE(40, MOVE_SUCKER_PUNCH),
    LEVEL_UP_MOVE(43, MOVE_DOUBLE_EDGE),
    LEVEL_UP_MOVE(47, MOVE_PH_HORN), //MOVE_STONE_EDGE),
...
static const struct LevelUpMove sHoppipLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SPLASH),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 4, MOVE_PH_RECOVER), //MOVE_SYNTHESIS),
    ...
    LEVEL_UP_MOVE(22, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(25, MOVE_PH_BEAM1),
    ...
    LEVEL_UP_MOVE(40, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE(43, MOVE_PH_BEAM2),
...
static const struct LevelUpMove sSkiploomLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SPLASH),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 1, MOVE_PH_RECOVER), //MOVE_SYNTHESIS),
    LEVEL_UP_MOVE( 1, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE( 4, MOVE_PH_RECOVER), //MOVE_SYNTHESIS),
    LEVEL_UP_MOVE( 6, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE( 8, MOVE_TACKLE),
    ...
    LEVEL_UP_MOVE(24, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(28, MOVE_PH_BEAM1),
    ...
    LEVEL_UP_MOVE(48, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE(52, MOVE_PH_BEAM2),
...
static const struct LevelUpMove sJumpluffLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(54, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE(59, MOVE_PH_BEAM2),
...
static const struct LevelUpMove sAipomLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(18, MOVE_PH_ATK_WEAK), //MOVE_FURY_SWIPES),
    LEVEL_UP_MOVE(22, MOVE_PH_SWIFT), //MOVE_SWIFT),
...
static const struct LevelUpMove sSunkernLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(10, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(13, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(16, MOVE_PH_SPATK_ADJACENT1), //MOVE_RAZOR_LEAF),
    LEVEL_UP_MOVE(19, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE(22, MOVE_PH_BEAM2),
    LEVEL_UP_MOVE(25, MOVE_ENDEAVOR),
    LEVEL_UP_MOVE(28, MOVE_PH_RECOVER), //MOVE_SYNTHESIS),
    LEVEL_UP_MOVE(31, MOVE_NATURAL_GIFT),
    LEVEL_UP_MOVE(34, MOVE_PH_BEAM4),
    LEVEL_UP_MOVE(37, MOVE_DOUBLE_EDGE),
...
static const struct LevelUpMove sSunfloraLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(34, MOVE_PH_BEAM4),
    LEVEL_UP_MOVE(37, MOVE_DOUBLE_EDGE),
    LEVEL_UP_MOVE(40, MOVE_PH_WEATHER), //MOVE_SUNNY_DAY),
    LEVEL_UP_MOVE(43, MOVE_PH_BEAM3),
    LEVEL_UP_MOVE(50, MOVE_PETAL_BLIZZARD),
    LEVEL_UP_END
};

static const struct LevelUpMove sYanmaLevelUpLearnset[] = { // BUG, FLYING
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_FORESIGHT),
    ...
    LEVEL_UP_MOVE(49, MOVE_U_TURN),
    LEVEL_UP_MOVE(54, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
    LEVEL_UP_MOVE(57, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sWooperLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 1, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE( 5, MOVE_PH_TYPE_EFF + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 9, MOVE_PH_BEAM1 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(15, MOVE_SLAM),
    LEVEL_UP_MOVE(19, MOVE_PH_BALL + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(23, MOVE_AMNESIA),
    LEVEL_UP_MOVE(29, ORIGINAL_TYPE_MOVE(MOVE_PH_STATUS2, TYPE_NORMAL)), //MOVE_YAWN),
    LEVEL_UP_MOVE(33, MOVE_PH_SPATK_ADJACENT2 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(37, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
    LEVEL_UP_MOVE(43, MOVE_MIST),
    LEVEL_UP_MOVE(43, MOVE_HAZE),
    LEVEL_UP_MOVE(47, MOVE_PH_SPATK_ADJACENT1_MUD),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sQuagsireLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(31, ORIGINAL_TYPE_MOVE(MOVE_PH_STATUS2, TYPE_NORMAL)), //MOVE_YAWN),
    LEVEL_UP_MOVE(36, MOVE_PH_SPATK_ADJACENT2 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(41, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
    LEVEL_UP_MOVE(48, MOVE_MIST),
    LEVEL_UP_MOVE(48, MOVE_HAZE),
    LEVEL_UP_MOVE(53, MOVE_PH_SPATK_ADJACENT1_MUD),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sEspeonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, ORIGINAL_TYPE_MOVE(MOVE_PH_PRIORITY, TYPE_NORMAL)), //MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE(17, MOVE_PH_SWIFT), //MOVE_SWIFT),
    LEVEL_UP_MOVE(20, MOVE_PH_BEAM1), //MOVE_PSYBEAM),
    LEVEL_UP_MOVE(25, MOVE_PH_BEAM3), //MOVE_FUTURE_SIGHT),
    LEVEL_UP_MOVE(29, MOVE_PSYCH_UP),
    LEVEL_UP_MOVE(33, MOVE_MORNING_SUN),
    LEVEL_UP_MOVE(37, MOVE_PH_BEAM2), //MOVE_PSYCHIC),
    LEVEL_UP_MOVE(41, MOVE_LAST_RESORT),
...
static const struct LevelUpMove sUmbreonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, ORIGINAL_TYPE_MOVE(MOVE_PH_PRIORITY, TYPE_NORMAL)), //MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE(17, MOVE_CONFUSE_RAY),
    LEVEL_UP_MOVE(20, MOVE_PH_SWIFT), //MOVE_FEINT_ATTACK),
...
static const struct LevelUpMove sMurkrowLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(35, MOVE_PH_SWIFT), //MOVE_FEINT_ATTACK),
    LEVEL_UP_MOVE(41, MOVE_MEAN_LOOK),
    LEVEL_UP_MOVE(45, MOVE_FOUL_PLAY),
    LEVEL_UP_MOVE(50, MOVE_TAILWIND),
    LEVEL_UP_MOVE(55, MOVE_PH_PRIORITY), //MOVE_SUCKER_PUNCH),
...
static const struct LevelUpMove sMisdreavusLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(41, MOVE_PH_BEAM2), //MOVE_SHADOW_BALL),
...
static const struct LevelUpMove sGirafarigLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(19, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_PSYBEAM),
    LEVEL_UP_MOVE(23, MOVE_AGILITY),
    LEVEL_UP_MOVE(28, MOVE_PH_FEET_MULTIHIT_FIXED),
    LEVEL_UP_MOVE(32, MOVE_ZEN_HEADBUTT),
    LEVEL_UP_MOVE(37, MOVE_CRUNCH),
    LEVEL_UP_MOVE(41, MOVE_BATON_PASS),
    LEVEL_UP_MOVE(46, MOVE_NASTY_PLOT),
    LEVEL_UP_MOVE(50, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_PSYCHIC),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sDunsparceLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_RAGE),
    LEVEL_UP_MOVE( 1, MOVE_DEFENSE_CURL),
    LEVEL_UP_MOVE( 3, ORIGINAL_TYPE_MOVE(MOVE_PH_ELEMENT_WEAK, TYPE_ROCK)), //MOVE_ROLLOUT),
    LEVEL_UP_MOVE( 6, MOVE_SPITE),
    LEVEL_UP_MOVE( 8, MOVE_PURSUIT),
    LEVEL_UP_MOVE(11, MOVE_SCREECH),
    LEVEL_UP_MOVE(13, MOVE_MUD_SLAP),
    LEVEL_UP_MOVE(16, MOVE_PH_STATUS2), //MOVE_YAWN),
    LEVEL_UP_MOVE(18, MOVE_ANCIENT_POWER),
    LEVEL_UP_MOVE(21, MOVE_PH_BODY),
    LEVEL_UP_MOVE(23, MOVE_DRILL_RUN),
    LEVEL_UP_MOVE(26, MOVE_ROOST),
    LEVEL_UP_MOVE(28, MOVE_PH_BODY_RECOIL), //MOVE_TAKE_DOWN),
...
static const struct LevelUpMove sSteelixLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_BIND),
    LEVEL_UP_MOVE( 4, MOVE_CURSE),
    LEVEL_UP_MOVE( 7, ORIGINAL_TYPE_MOVE(MOVE_PH_ATK_THROW, TYPE_ROCK)), //MOVE_ROCK_THROW),
    LEVEL_UP_MOVE(10, MOVE_ROCK_TOMB),
    LEVEL_UP_MOVE(13, MOVE_RAGE),
    LEVEL_UP_MOVE(16, ORIGINAL_TYPE_MOVE(MOVE_PH_HAZARD, TYPE_ROCK)), //MOVE_STEALTH_ROCK),
    ...
    LEVEL_UP_MOVE(28, MOVE_SLAM),
    LEVEL_UP_MOVE(31, MOVE_SCREECH),
    LEVEL_UP_MOVE(34, ORIGINAL_TYPE_MOVE(MOVE_PH_SPATK_ADJACENT1, TYPE_ROCK)), //MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE(37, MOVE_CRUNCH),
    LEVEL_UP_MOVE(40, MOVE_PH_TAIL), //MOVE_IRON_TAIL),
    LEVEL_UP_MOVE(43, MOVE_PH_BODY_2TURN + MOVES_PH_TYPE2), //MOVE_DIG),
    LEVEL_UP_MOVE(46, ORIGINAL_TYPE_MOVE(MOVE_PH_HORN, TYPE_ROCK)), //MOVE_STONE_EDGE),
    LEVEL_UP_MOVE(49, MOVE_DOUBLE_EDGE),
    LEVEL_UP_MOVE(52, MOVE_PH_WEATHER + MOVES_PH_TYPE2), //MOVE_SANDSTORM),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSnubbullLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(37, MOVE_PH_BODY), //MOVE_PLAY_ROUGH),
...
static const struct LevelUpMove sGranbullLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(43, MOVE_PH_BODY), //MOVE_PLAY_ROUGH),
...
static const struct LevelUpMove sQwilfishLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(21, MOVE_PH_HAZARD + MOVES_PH_TYPE2), //MOVE_TOXIC_SPIKES),
    LEVEL_UP_MOVE(25, MOVE_STOCKPILE),
    LEVEL_UP_MOVE(25, MOVE_SPIT_UP),
    ...
    LEVEL_UP_MOVE(41, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(45, MOVE_PH_TAIL), //MOVE_AQUA_TAIL),
    LEVEL_UP_MOVE(49, MOVE_PH_HORN + MOVES_PH_TYPE2), //MOVE_POISON_JAB),
...
static const struct LevelUpMove sScizorLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(45, MOVE_NIGHT_SLASH),
    LEVEL_UP_MOVE(49, MOVE_DOUBLE_HIT),
    LEVEL_UP_MOVE(50, MOVE_PH_HEAD + MOVES_PH_TYPE2), //MOVE_IRON_HEAD),
    LEVEL_UP_MOVE(57, MOVE_SWORDS_DANCE),
    LEVEL_UP_MOVE(61, MOVE_FEINT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sShuckleLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2), //MOVE_ROLLOUT),
    ...
    LEVEL_UP_MOVE(23, MOVE_PH_ATK_THROW + MOVES_PH_TYPE2), //MOVE_ROCK_THROW),
    LEVEL_UP_MOVE(27, MOVE_GASTRO_ACID),
    LEVEL_UP_MOVE(31, MOVE_POWER_TRICK),
    LEVEL_UP_MOVE(34, MOVE_SHELL_SMASH),
    LEVEL_UP_MOVE(38, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2), //MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE(42, MOVE_PH_BITE),
    LEVEL_UP_MOVE(45, MOVE_POWER_SPLIT),
    LEVEL_UP_MOVE(45, MOVE_GUARD_SPLIT),
    LEVEL_UP_MOVE(49, MOVE_PH_HORN + MOVES_PH_TYPE2), //MOVE_STONE_EDGE),
    LEVEL_UP_MOVE(53, MOVE_STICKY_WEB),
    LEVEL_UP_END
};

static const struct LevelUpMove sHeracrossLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_PH_FIST2 + MOVES_PH_TYPE2), //MOVE_ARM_THRUST),
    ...
    LEVEL_UP_MOVE(37, MOVE_PH_HORN),
    LEVEL_UP_MOVE(43, MOVE_PH_BODY_RECOIL + MOVES_PH_TYPE2), //MOVE_CLOSE_COMBAT),
...
static const struct LevelUpMove sSneaselLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(10, MOVE_PH_SWIFT), //MOVE_FEINT_ATTACK),
...
static const struct LevelUpMove sTeddiursaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 8, MOVE_PH_ATK_WEAK), //MOVE_FURY_SWIPES),
...
static const struct LevelUpMove sSlugmaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_SMOG),
    LEVEL_UP_MOVE( 6, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 8, ORIGINAL_TYPE_MOVE(MOVE_PH_ATK_THROW + MOVES_PH_TYPE2, TYPE_ROCK)), //MOVE_ROCK_THROW),
    ...
    LEVEL_UP_MOVE(27, MOVE_PH_SPATK_ADJACENT1),
    LEVEL_UP_MOVE(29, ORIGINAL_TYPE_MOVE(MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2, TYPE_ROCK)), //MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE(34, MOVE_PH_ELEMENT_STRONG2), //MOVE_LAVA_PLUME),
    LEVEL_UP_MOVE(36, MOVE_AMNESIA),
...
static const struct LevelUpMove sMagcargoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_SMOG),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 1, MOVE_PH_ATK_THROW + MOVES_PH_TYPE2), //MOVE_ROCK_THROW),
    LEVEL_UP_MOVE( 6, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 8, MOVE_PH_ATK_THROW + MOVES_PH_TYPE2), //MOVE_ROCK_THROW),
    LEVEL_UP_MOVE(13, MOVE_HARDEN),
    LEVEL_UP_MOVE(15, MOVE_INCINERATE),
    LEVEL_UP_MOVE(20, MOVE_CLEAR_SMOG),
    LEVEL_UP_MOVE(22, MOVE_ANCIENT_POWER),
    LEVEL_UP_MOVE(27, MOVE_PH_SPATK_ADJACENT1),
    LEVEL_UP_MOVE(29, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2), //MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE(34, MOVE_PH_ELEMENT_STRONG2), //MOVE_LAVA_PLUME),
    LEVEL_UP_MOVE(36, MOVE_AMNESIA),
    LEVEL_UP_MOVE(43, MOVE_BODY_SLAM),
    LEVEL_UP_MOVE(47, MOVE_RECOVER),
    LEVEL_UP_MOVE(54, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(58, MOVE_EARTH_POWER),
    LEVEL_UP_END
};

static const struct LevelUpMove sSwinubLevelUpLearnset[] = {    // ICE, GROUND
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_ODOR_SLEUTH),
    LEVEL_UP_MOVE( 5, MOVE_PH_TYPE_EFF + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 8, MOVE_POWDER_SNOW),
    LEVEL_UP_MOVE(11, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2), //MOVE_MUD_SLAP),
    LEVEL_UP_MOVE(14, MOVE_ENDURE),
    LEVEL_UP_MOVE(18, MOVE_PH_BALL + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(21, MOVE_ICY_WIND),
    LEVEL_UP_MOVE(24, MOVE_ICE_SHARD),
    LEVEL_UP_MOVE(28, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(35, MOVE_MIST),
    LEVEL_UP_MOVE(37, MOVE_PH_SPATK_ADJACENT2 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(40, MOVE_FLAIL),
    LEVEL_UP_MOVE(44, MOVE_PH_SPATK_ADJACENT2), //MOVE_BLIZZARD),
    LEVEL_UP_MOVE(48, MOVE_AMNESIA),
    LEVEL_UP_END
};

static const struct LevelUpMove sPiloswineLevelUpLearnset[] = { // ICE, GROUND
    LEVEL_UP_MOVE( 0, MOVE_FURY_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_FURY_ATTACK),
    ...
    LEVEL_UP_MOVE(41, MOVE_THRASH),
    LEVEL_UP_MOVE(46, MOVE_PH_SPATK_ADJACENT2 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(52, MOVE_PH_SPATK_ADJACENT2), //MOVE_BLIZZARD),
...
static const struct LevelUpMove sCorsolaLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_HARDEN),
    LEVEL_UP_MOVE( 4, MOVE_PH_ELEMENT_WEAK2),
    LEVEL_UP_MOVE( 8, MOVE_RECOVER),
    LEVEL_UP_MOVE(10, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE(13, MOVE_REFRESH),
    LEVEL_UP_MOVE(17, MOVE_ANCIENT_POWER),
    LEVEL_UP_MOVE(20, MOVE_SPIKE_CANNON),
    LEVEL_UP_MOVE(23, MOVE_LUCKY_CHANT),
    LEVEL_UP_MOVE(27, MOVE_PH_VARDMG), //MOVE_BRINE),
    LEVEL_UP_MOVE(29, MOVE_IRON_DEFENSE),
    LEVEL_UP_MOVE(31, MOVE_PH_ATK_WEAK + MOVES_PH_TYPE2), //MOVE_ROCK_BLAST),
    LEVEL_UP_MOVE(35, MOVE_ENDURE),
    LEVEL_UP_MOVE(38, MOVE_CURSE),
    LEVEL_UP_MOVE(41, MOVE_PH_ELEMENT_STRONG + MOVES_PH_TYPE2), //MOVE_POWER_GEM),
...
static const struct LevelUpMove sRemoraidLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(26, MOVE_PH_BEAM1),
...
static const struct LevelUpMove sMantineLevelUpLearnset[] = {   // WATER, FLYING
    LEVEL_UP_MOVE( 1, MOVE_PSYBEAM),
    LEVEL_UP_MOVE( 1, MOVE_BULLET_SEED),
    LEVEL_UP_MOVE( 1, MOVE_SIGNAL_BEAM),
    LEVEL_UP_MOVE( 1, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    ...
    LEVEL_UP_MOVE( 7, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    ...
    LEVEL_UP_MOVE(32, MOVE_AGILITY),
    LEVEL_UP_MOVE(36, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
    LEVEL_UP_MOVE(39, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(46, MOVE_BOUNCE),
    LEVEL_UP_MOVE(49, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSkarmoryLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(12, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2),
    ...
    LEVEL_UP_MOVE(45, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
...
static const struct LevelUpMove sHoundourLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(16, MOVE_PH_BITE),
    LEVEL_UP_MOVE(20, MOVE_ODOR_SLEUTH),
    LEVEL_UP_MOVE(25, MOVE_BEAT_UP),
    LEVEL_UP_MOVE(28, MOVE_PH_BITE + MOVES_PH_TYPE2), //MOVE_FIRE_FANG),
    LEVEL_UP_MOVE(32, MOVE_PH_SWIFT), //MOVE_FEINT_ATTACK),
    LEVEL_UP_MOVE(37, MOVE_EMBARGO),
    LEVEL_UP_MOVE(40, MOVE_FOUL_PLAY),
    LEVEL_UP_MOVE(44, MOVE_PH_BEAM1 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(49, MOVE_PH_BITE2), //MOVE_CRUNCH),
...
static const struct LevelUpMove sHoundoomLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(30, MOVE_PH_BITE + MOVES_PH_TYPE2), //MOVE_FIRE_FANG),
    LEVEL_UP_MOVE(35, MOVE_PH_SWIFT), //MOVE_FEINT_ATTACK),
    LEVEL_UP_MOVE(41, MOVE_EMBARGO),
    LEVEL_UP_MOVE(45, MOVE_FOUL_PLAY),
    LEVEL_UP_MOVE(50, MOVE_PH_BEAM1 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(56, MOVE_PH_BITE2), //MOVE_CRUNCH),
...
static const struct LevelUpMove sKingdraLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 9, MOVE_LEER),
    LEVEL_UP_MOVE(13, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE(17, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2), //MOVE_TWISTER),
    LEVEL_UP_MOVE(21, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE(26, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE(31, MOVE_PH_VARDMG), //MOVE_BRINE),
    LEVEL_UP_MOVE(38, MOVE_AGILITY),
    LEVEL_UP_MOVE(45, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_DRAGON_PULSE),
    LEVEL_UP_MOVE(52, MOVE_DRAGON_DANCE),
    LEVEL_UP_MOVE(60, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sDonphanLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_THUNDER_FANG),
    LEVEL_UP_MOVE( 1, MOVE_HORN_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_PH_PRIORITY), //MOVE_BULLDOZE),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_DEFENSE_CURL),
    ...
    LEVEL_UP_MOVE(24, MOVE_SLAM),
    LEVEL_UP_MOVE(30, MOVE_PH_VARDMG), //MOVE_MAGNITUDE),
    LEVEL_UP_MOVE(37, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(43, MOVE_PH_SPATK_ADJACENT2),
...
static const struct LevelUpMove sStantlerLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(21, MOVE_PH_BODY_RECOIL), //MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(23, MOVE_CONFUSE_RAY),
...
static const struct LevelUpMove sHitmontopLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(50, MOVE_DETECT),
    LEVEL_UP_MOVE(55, MOVE_PH_BODY_RECOIL), //MOVE_CLOSE_COMBAT),
...
static const struct LevelUpMove sSmoochumLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(11, MOVE_POWDER_SNOW),
    LEVEL_UP_MOVE(15, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    ...
    LEVEL_UP_MOVE(38, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_PSYCHIC),
    LEVEL_UP_MOVE(41, MOVE_COPYCAT),
    LEVEL_UP_MOVE(45, MOVE_PERISH_SONG),
    LEVEL_UP_MOVE(48, MOVE_PH_SPATK_ADJACENT2), //MOVE_BLIZZARD),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sElekidLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(26, MOVE_LIGHT_SCREEN),
    LEVEL_UP_MOVE(29, MOVE_THUNDER_PUNCH),
    LEVEL_UP_MOVE(33, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISCHARGE),
    LEVEL_UP_MOVE(36, MOVE_SCREECH),
    LEVEL_UP_MOVE(40, MOVE_PH_ELEMENT_STRONG), //MOVE_THUNDERBOLT),
    LEVEL_UP_MOVE(43, MOVE_PH_BEAM4), //MOVE_THUNDER),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMagbyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(26, MOVE_CONFUSE_RAY),
    LEVEL_UP_MOVE(29, MOVE_PH_FIST),
    LEVEL_UP_MOVE(33, MOVE_PH_ELEMENT_STRONG2), //MOVE_LAVA_PLUME),
    LEVEL_UP_MOVE(36, MOVE_PH_WEATHER), //MOVE_SUNNY_DAY),
    LEVEL_UP_MOVE(40, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(43, MOVE_PH_BEAM4), //MOVE_FIRE_BLAST),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMiltankLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(19, ORIGINAL_TYPE_MOVE(MOVE_PH_ELEMENT_WEAK, TYPE_ROCK)), //MOVE_ROLLOUT),
    LEVEL_UP_MOVE(24, MOVE_PH_BODY),
...
static const struct LevelUpMove sRaikouLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISCHARGE),
    LEVEL_UP_MOVE( 1, MOVE_BITE),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 8, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE(15, MOVE_ROAR),
    LEVEL_UP_MOVE(22, MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE(29, MOVE_PH_HEAD), //MOVE_SPARK),
    LEVEL_UP_MOVE(36, MOVE_REFLECT),
    LEVEL_UP_MOVE(43, MOVE_CRUNCH),
    LEVEL_UP_MOVE(50, MOVE_THUNDER_FANG),
    LEVEL_UP_MOVE(57, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISCHARGE),
    LEVEL_UP_MOVE(64, MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE(71, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
    LEVEL_UP_MOVE(78, MOVE_CALM_MIND),
    LEVEL_UP_MOVE(85, MOVE_PH_BEAM4), //MOVE_THUNDER),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sEnteiLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_ERUPTION),
    LEVEL_UP_MOVE( 1, MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_STRONG2), //MOVE_LAVA_PLUME),
    LEVEL_UP_MOVE( 1, MOVE_BITE),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 8, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE(15, MOVE_ROAR),
    ...
    LEVEL_UP_MOVE(50, MOVE_PH_BITE), //MOVE_FIRE_FANG),
    LEVEL_UP_MOVE(57, MOVE_PH_ELEMENT_STRONG2), //MOVE_LAVA_PLUME),
    LEVEL_UP_MOVE(64, MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE(71, MOVE_PH_BEAM4), //MOVE_FIRE_BLAST),
    LEVEL_UP_MOVE(78, MOVE_CALM_MIND),
...
static const struct LevelUpMove sSuicuneLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE( 1, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
    LEVEL_UP_MOVE( 8, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE(15, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
    ...
    LEVEL_UP_MOVE(64, MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE(71, MOVE_PH_BEAM3),
    LEVEL_UP_MOVE(78, MOVE_CALM_MIND),
    LEVEL_UP_MOVE(85, MOVE_BLIZZARD),
    LEVEL_UP_END
};

static const struct LevelUpMove sLarvitarLevelUpLearnset[] = {  // ROCK, GROUND
    LEVEL_UP_MOVE( 1, MOVE_BITE),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 5, MOVE_PH_WEATHER), //MOVE_SANDSTORM),
    LEVEL_UP_MOVE(10, MOVE_SCREECH),
    LEVEL_UP_MOVE(14, MOVE_CHIP_AWAY),
    LEVEL_UP_MOVE(19, MOVE_PH_SPATK_ADJACENT1), //MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE(23, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(28, MOVE_THRASH),
    LEVEL_UP_MOVE(32, MOVE_DARK_PULSE),
    LEVEL_UP_MOVE(37, MOVE_PAYBACK),
    LEVEL_UP_MOVE(41, ORIGINAL_TYPE_MOVE(MOVE_PH_BITE2 + MOVES_PH_TYPE2, TYPE_DARK)), //MOVE_CRUNCH),
    LEVEL_UP_MOVE(46, MOVE_PH_SPATK_ADJACENT2 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(50, MOVE_PH_HORN), //MOVE_STONE_EDGE),
    LEVEL_UP_MOVE(55, MOVE_HYPER_BEAM),
    LEVEL_UP_END
};

static const struct LevelUpMove sPupitarLevelUpLearnset[] = {   // ROCK, GROUND
    LEVEL_UP_MOVE( 1, MOVE_BITE),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_PH_WEATHER), //MOVE_SANDSTORM),
    LEVEL_UP_MOVE( 1, MOVE_SCREECH),
    LEVEL_UP_MOVE( 5, MOVE_PH_WEATHER), //MOVE_SANDSTORM),
    LEVEL_UP_MOVE(10, MOVE_SCREECH),
    LEVEL_UP_MOVE(14, MOVE_CHIP_AWAY),
    ...
    LEVEL_UP_MOVE(47, ORIGINAL_TYPE_MOVE(MOVE_PH_BITE2 + MOVES_PH_TYPE2, TYPE_DARK)), //MOVE_CRUNCH),
    LEVEL_UP_MOVE(54, MOVE_PH_SPATK_ADJACENT2 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(60, MOVE_PH_HORN), //MOVE_STONE_EDGE),
    LEVEL_UP_MOVE(67, MOVE_HYPER_BEAM),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sTyranitarLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(34, MOVE_DARK_PULSE),
    LEVEL_UP_MOVE(41, MOVE_PAYBACK),
    LEVEL_UP_MOVE(47, MOVE_PH_BITE2 + MOVES_PH_TYPE2), //MOVE_CRUNCH),
    LEVEL_UP_MOVE(54, ORIGINAL_TYPE_MOVE(MOVE_PH_SPATK_ADJACENT2 + MOVES_PH_TYPE2, TYPE_GROUND)),
    LEVEL_UP_MOVE(63, MOVE_PH_HORN), //MOVE_STONE_EDGE),
...
static const struct LevelUpMove sLugiaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(23, MOVE_PH_BALL), //MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE(29, MOVE_RAIN_DANCE),
    LEVEL_UP_MOVE(37, ORIGINAL_TYPE_MOVE(MOVE_PH_BEAM4, TYPE_WATER)), //MOVE_HYDRO_PUMP),
    ...
    LEVEL_UP_MOVE(79, MOVE_PH_BEAM3), //MOVE_FUTURE_SIGHT),
...
static const struct LevelUpMove sHoOhLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_WEATHER_BALL),
    LEVEL_UP_MOVE( 9, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(15, MOVE_PH_BODY_RECOIL + MOVES_PH_TYPE2), //MOVE_BRAVE_BIRD),
    LEVEL_UP_MOVE(23, MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE(29, MOVE_PH_WEATHER), //MOVE_SUNNY_DAY),
    LEVEL_UP_MOVE(37, MOVE_PH_BEAM4), //MOVE_FIRE_BLAST),
...
static const struct LevelUpMove sCelebiLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(64, MOVE_PH_BEAM3), //MOVE_FUTURE_SIGHT),
    LEVEL_UP_MOVE(73, MOVE_HEALING_WISH),
    LEVEL_UP_MOVE(82, MOVE_PH_BEAM3 + MOVES_PH_TYPE2),
...
static const struct LevelUpMove sTreeckoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(17, MOVE_PURSUIT),
    LEVEL_UP_MOVE(21, MOVE_PH_BEAM2),
    LEVEL_UP_MOVE(25, MOVE_AGILITY),
    LEVEL_UP_MOVE(29, MOVE_SLAM),
    LEVEL_UP_MOVE(33, MOVE_DETECT),
    LEVEL_UP_MOVE(37, MOVE_PH_BALL),
...
static const struct LevelUpMove sGrovyleLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(23, MOVE_PH_BLADE),
    ...
    LEVEL_UP_MOVE(58, MOVE_PH_BEAM3),
...
static const struct LevelUpMove sSceptileLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(63, MOVE_PH_BEAM3),
...
static const struct LevelUpMove sTorchicLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(19, MOVE_PH_HEAL_SAP),
...
static const struct LevelUpMove sCombuskenLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_FEET_MULTIHIT_FIXED + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 1, MOVE_PH_FEET_MULTIHIT_FIXED + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 1, MOVE_SAND_ATTACK),
    ...
    LEVEL_UP_MOVE(10, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE(14, MOVE_PECK),
    LEVEL_UP_MOVE(20, MOVE_PH_PRIORITY),
    LEVEL_UP_MOVE(25, ORIGINAL_TYPE_MOVE(MOVE_PH_PRIORITY + MOVES_PH_TYPE2, TYPE_NORMAL)), //MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE(31, MOVE_BULK_UP),
    LEVEL_UP_MOVE(36, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE(42, ORIGINAL_TYPE_MOVE(MOVE_PH_BLADE + MOVES_PH_TYPE2, TYPE_NORMAL)), //MOVE_SLASH),
    LEVEL_UP_MOVE(47, MOVE_MIRROR_MOVE),
    LEVEL_UP_MOVE(53, MOVE_SKY_UPPERCUT),
    LEVEL_UP_MOVE(58, MOVE_PH_BODY),
    LEVEL_UP_END
};

static const struct LevelUpMove sBlazikenLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_KICK),
    LEVEL_UP_MOVE( 1, MOVE_PH_KICK),
    LEVEL_UP_MOVE( 1, MOVE_PH_FEET_MULTIHIT_FIXED + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 1, MOVE_PH_BODY),
    LEVEL_UP_MOVE( 1, MOVE_PH_FIST),
    ...
    LEVEL_UP_MOVE(44, ORIGINAL_TYPE_MOVE(MOVE_PH_BLADE + MOVES_PH_TYPE2, TYPE_NORMAL)), //MOVE_SLASH),
    LEVEL_UP_MOVE(50, MOVE_BRAVE_BIRD),
    LEVEL_UP_MOVE(57, MOVE_SKY_UPPERCUT),
    LEVEL_UP_MOVE(63, MOVE_PH_BODY),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMudkipLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 4, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 9, ORIGINAL_TYPE_MOVE(MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2, TYPE_GROUND)), // MUD SLAP
    LEVEL_UP_MOVE(12, MOVE_FORESIGHT),
    LEVEL_UP_MOVE(17, MOVE_BIDE),
    LEVEL_UP_MOVE(20, ORIGINAL_TYPE_MOVE(MOVE_PH_TYPE_EFF + MOVES_PH_TYPE2, TYPE_GROUND)),
    LEVEL_UP_MOVE(25, MOVE_ROCK_THROW),
    LEVEL_UP_MOVE(28, MOVE_PROTECT),
    LEVEL_UP_MOVE(33, MOVE_PH_HAZARD),
    LEVEL_UP_MOVE(36, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(41, MOVE_PH_BEAM3),
    LEVEL_UP_MOVE(44, MOVE_ENDEAVOR),
    LEVEL_UP_END
};

static const struct LevelUpMove sMarshtompLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_BEAM1 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM1 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    ...
    LEVEL_UP_MOVE(22, MOVE_PH_BALL + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(28, MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE(32, MOVE_PROTECT),
    LEVEL_UP_MOVE(38, MOVE_PH_SPATK_ADJACENT1_MUD),
    LEVEL_UP_MOVE(42, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(48, MOVE_PH_SPATK_ADJACENT2 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(52, MOVE_ENDEAVOR),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSwampertLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(28, MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE(32, MOVE_PROTECT),
    LEVEL_UP_MOVE(39, MOVE_PH_SPATK_ADJACENT1_MUD),
    LEVEL_UP_MOVE(44, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(51, MOVE_PH_SPATK_ADJACENT2 + MOVES_PH_TYPE2),
...
static const struct LevelUpMove sPoochyenaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(31, MOVE_TAUNT),
    LEVEL_UP_MOVE(34, MOVE_PH_BITE2), //MOVE_CRUNCH),
    LEVEL_UP_MOVE(37, ORIGINAL_TYPE_MOVE(MOVE_PH_STATUS2, TYPE_NORMAL)), //MOVE_YAWN),
    LEVEL_UP_MOVE(40, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(43, MOVE_PH_PRIORITY), //MOVE_SUCKER_PUNCH),
    LEVEL_UP_MOVE(46, ORIGINAL_TYPE_MOVE(MOVE_PH_BODY, TYPE_FAIRY)),//MOVE_PLAY_ROUGH),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMightyenaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_THUNDER_FANG),
    LEVEL_UP_MOVE( 1, MOVE_ICE_FANG),
    LEVEL_UP_MOVE( 1, MOVE_PH_BITE2), //MOVE_CRUNCH),
    ...
    LEVEL_UP_MOVE(40, MOVE_PH_BITE2), //MOVE_CRUNCH),
    LEVEL_UP_MOVE(44, ORIGINAL_TYPE_MOVE(MOVE_PH_STATUS2, TYPE_NORMAL)), //MOVE_YAWN),
    LEVEL_UP_MOVE(48, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(52, MOVE_PH_PRIORITY), //MOVE_SUCKER_PUNCH),
    LEVEL_UP_MOVE(56, ORIGINAL_TYPE_MOVE(MOVE_PH_BODY, TYPE_FAIRY)),//MOVE_PLAY_ROUGH),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sZigzagoonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(31, MOVE_PH_BODY_RECOIL), //MOVE_TAKE_DOWN),
...
static const struct LevelUpMove sLinooneLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_ODOR_SLEUTH),
    LEVEL_UP_MOVE(17, MOVE_MUD_SPORT),
    LEVEL_UP_MOVE(19, MOVE_PH_ATK_WEAK), //MOVE_FURY_SWIPES),
...
static const struct LevelUpMove sBeautiflyLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(12, MOVE_ABSORB),
    LEVEL_UP_MOVE(15, MOVE_STUN_SPORE),
    LEVEL_UP_MOVE(17, MOVE_MORNING_SUN),
    LEVEL_UP_MOVE(20, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2),
    ...
    LEVEL_UP_MOVE(35, MOVE_PH_BEAM3),
...
static const struct LevelUpMove sDustoxLevelUpLearnset[] = {    // BUG, POISON
    LEVEL_UP_MOVE( 0, ORIGINAL_TYPE_MOVE(MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2, TYPE_FLYING)), //MOVE_GUST),
    LEVEL_UP_MOVE( 1, ORIGINAL_TYPE_MOVE(MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2, TYPE_FLYING)), //MOVE_GUST),
    LEVEL_UP_MOVE(12, MOVE_CONFUSION),
    LEVEL_UP_MOVE(15, MOVE_PH_STATUS4 + MOVES_PH_TYPE2), //MOVE_POISON_POWDER),
    LEVEL_UP_MOVE(17, MOVE_MOONLIGHT),
    LEVEL_UP_MOVE(20, MOVE_PH_VARDMG + MOVES_PH_TYPE2), //MOVE_VENOSHOCK),
    LEVEL_UP_MOVE(22, MOVE_PSYBEAM),
    LEVEL_UP_MOVE(25, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(27, MOVE_LIGHT_SCREEN),
    LEVEL_UP_MOVE(30, MOVE_WHIRLWIND),
    LEVEL_UP_MOVE(32, MOVE_PH_STATUS3 + MOVES_PH_TYPE2), //MOVE_TOXIC),
    LEVEL_UP_MOVE(35, MOVE_PH_BEAM3),
...
static const struct LevelUpMove sLotadLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_ASTONISH),
    LEVEL_UP_MOVE( 3, MOVE_GROWL),
    LEVEL_UP_MOVE( 6, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 9, MOVE_PH_ELEMENT_WEAK2),
    LEVEL_UP_MOVE(12, MOVE_NATURAL_GIFT),
    LEVEL_UP_MOVE(15, MOVE_MIST),
    LEVEL_UP_MOVE(18, MOVE_PH_BEAM1 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(21, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE(24, MOVE_NATURE_POWER),
    LEVEL_UP_MOVE(27, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
    LEVEL_UP_MOVE(30, MOVE_PH_BEAM2 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(33, MOVE_ZEN_HEADBUTT),
    LEVEL_UP_MOVE(36, MOVE_PH_BALL + MOVES_PH_TYPE2),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sLombreLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(20, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE(24, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE(28, MOVE_NATURE_POWER),
    LEVEL_UP_MOVE(32, MOVE_UPROAR),
    LEVEL_UP_MOVE(36, ORIGINAL_TYPE_MOVE(MOVE_PH_HORN + MOVES_PH_TYPE2, TYPE_DARK)), //MOVE_KNOCK_OFF),
    LEVEL_UP_MOVE(40, MOVE_ZEN_HEADBUTT),
    LEVEL_UP_MOVE(44, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSeedotLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(21, MOVE_PH_RECOVER), //MOVE_SYNTHESIS),
    LEVEL_UP_MOVE(27, MOVE_PH_WEATHER), //MOVE_SUNNY_DAY),
    LEVEL_UP_MOVE(33, MOVE_EXPLOSION),
    LEVEL_UP_END
};

static const struct LevelUpMove sNuzleafLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_SPATK_ADJACENT1), //MOVE_RAZOR_LEAF),
    LEVEL_UP_MOVE( 1, MOVE_PH_SPATK_ADJACENT1), //MOVE_RAZOR_LEAF),
    LEVEL_UP_MOVE( 1, MOVE_POUND),
    LEVEL_UP_MOVE( 3, MOVE_HARDEN),
    ...
    LEVEL_UP_MOVE(24, MOVE_PH_SWIFT + MOVES_PH_TYPE2), //MOVE_FEINT_ATTACK),
    LEVEL_UP_MOVE(28, MOVE_PH_BLADE),
...
static const struct LevelUpMove sShiftryLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_PH_SPATK_ADJACENT1), //MOVE_RAZOR_LEAF),
    LEVEL_UP_MOVE( 1, MOVE_PH_SWIFT + MOVES_PH_TYPE2), //MOVE_FEINT_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_WHIRLWIND),
    LEVEL_UP_MOVE( 1, MOVE_NASTY_PLOT),
    LEVEL_UP_MOVE(20, MOVE_PH_STRONGWIND), //MOVE_LEAF_TORNADO),
...
static const struct LevelUpMove sNincadaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_FURY_SWIPES),
    LEVEL_UP_MOVE(17, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2), //MOVE_MUD_SLAP),
    LEVEL_UP_MOVE(21, MOVE_METAL_CLAW),
    LEVEL_UP_MOVE(25, MOVE_MIND_READER),
    LEVEL_UP_MOVE(29, MOVE_BIDE),
    LEVEL_UP_MOVE(33, MOVE_FALSE_SWIPE),
    LEVEL_UP_MOVE(37, MOVE_PH_BODY_2TURN + MOVES_PH_TYPE2), //MOVE_DIG),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sNinjaskLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_FURY_SWIPES),
    LEVEL_UP_MOVE(17, MOVE_AGILITY),
    LEVEL_UP_MOVE(23, ORIGINAL_TYPE_MOVE(MOVE_PH_BLADE + MOVES_PH_TYPE2, TYPE_NORMAL)), //MOVE_SLASH),
    LEVEL_UP_MOVE(29, MOVE_MIND_READER),
    LEVEL_UP_MOVE(35, MOVE_BATON_PASS),
    LEVEL_UP_MOVE(41, MOVE_SWORDS_DANCE),
    LEVEL_UP_MOVE(47, MOVE_PH_BLADE), //MOVE_X_SCISSOR),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sShedinjaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(25, MOVE_MIND_READER),
    LEVEL_UP_MOVE(29, MOVE_CONFUSE_RAY),
    LEVEL_UP_MOVE(33, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_SHADOW_BALL),
    LEVEL_UP_MOVE(37, MOVE_GRUDGE),
    LEVEL_UP_MOVE(41, MOVE_HEAL_BLOCK),
    LEVEL_UP_MOVE(45, MOVE_PH_BODY_2TURN + MOVES_PH_TYPE2), //MOVE_PHANTOM_FORCE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sTaillowLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 5, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE( 9, MOVE_PH_PRIORITY), //MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE(13, MOVE_WING_ATTACK),
    LEVEL_UP_MOVE(17, MOVE_DOUBLE_TEAM),
    LEVEL_UP_MOVE(21, MOVE_PH_BLADE + MOVES_PH_TYPE2), //MOVE_AERIAL_ACE),
    LEVEL_UP_MOVE(25, MOVE_QUICK_GUARD),
    LEVEL_UP_MOVE(29, MOVE_AGILITY),
    LEVEL_UP_MOVE(33, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
    LEVEL_UP_MOVE(37, MOVE_ENDEAVOR),
    LEVEL_UP_MOVE(41, MOVE_PH_BODY_RECOIL + MOVES_PH_TYPE2), //MOVE_BRAVE_BIRD),
...
static const struct LevelUpMove sSwellowLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(33, MOVE_AGILITY),
    LEVEL_UP_MOVE(39, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
    LEVEL_UP_MOVE(45, MOVE_ENDEAVOR),
    LEVEL_UP_MOVE(51, MOVE_PH_BODY_RECOIL + MOVES_PH_TYPE2), //MOVE_BRAVE_BIRD),
...
static const struct LevelUpMove sShroomishLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 8, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(12, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(15, MOVE_HEADBUTT),
    LEVEL_UP_MOVE(19, MOVE_POISON_POWDER),
    LEVEL_UP_MOVE(22, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE(26, MOVE_PH_BEAM2),
...
static const struct LevelUpMove sBreloomLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(28, MOVE_PH_FIST3 + MOVES_PH_TYPE2), //MOVE_FORCE_PALM),
    LEVEL_UP_MOVE(33, MOVE_MIND_READER),
...
static const struct LevelUpMove sWingullLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(15, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(19, MOVE_PH_PRIORITY + MOVES_PH_TYPE2), //MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE(22, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(26, MOVE_PURSUIT),
    LEVEL_UP_MOVE(29, MOVE_PH_BLADE + MOVES_PH_TYPE2), //MOVE_AERIAL_ACE),
    LEVEL_UP_MOVE(33, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(36, MOVE_AGILITY),
    LEVEL_UP_MOVE(40, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
    LEVEL_UP_MOVE(43, MOVE_PH_BEAM4 + MOVES_PH_TYPE2), //MOVE_HURRICANE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sPelipperLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(22, MOVE_PH_VARDMG), //MOVE_BRINE),
    LEVEL_UP_MOVE(28, MOVE_FLING),
    LEVEL_UP_MOVE(33, MOVE_STOCKPILE),
    LEVEL_UP_MOVE(33, MOVE_SWALLOW),
    LEVEL_UP_MOVE(33, MOVE_SPIT_UP),
    LEVEL_UP_MOVE(39, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(44, MOVE_TAILWIND),
    LEVEL_UP_MOVE(50, MOVE_PH_BEAM3),
    LEVEL_UP_MOVE(55, MOVE_PH_BEAM4 + MOVES_PH_TYPE2), //MOVE_HURRICANE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSurskitLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(14, MOVE_PH_TYPE_EFF + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(17, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE(22, MOVE_AGILITY),
    LEVEL_UP_MOVE(25, MOVE_MIST),
    LEVEL_UP_MOVE(25, MOVE_HAZE),
    LEVEL_UP_MOVE(30, MOVE_PH_BODY_ATK_SPEED + MOVES_PH_TYPE2), //MOVE_AQUA_JET),
    LEVEL_UP_MOVE(35, MOVE_BATON_PASS),
...
static const struct LevelUpMove sMasquerainLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_SWEET_SCENT),
    LEVEL_UP_MOVE( 1, ORIGINAL_TYPE_MOVE(MOVE_PH_TYPE_EFF + MOVES_PH_TYPE2, TYPE_WATER)),
    LEVEL_UP_MOVE( 6, MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE( 9, MOVE_SWEET_SCENT),
    LEVEL_UP_MOVE(14, ORIGINAL_TYPE_MOVE(MOVE_PH_TYPE_EFF + MOVES_PH_TYPE2, TYPE_WATER)),
    LEVEL_UP_MOVE(17, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(22, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(22, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(26, MOVE_STUN_SPORE),
    LEVEL_UP_MOVE(32, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(38, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
    LEVEL_UP_MOVE(42, MOVE_PH_BEAM3),
...
static const struct LevelUpMove sWailmerLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 7, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE(10, MOVE_ROLLOUT),
    LEVEL_UP_MOVE(13, MOVE_PH_HAZARD),
    LEVEL_UP_MOVE(16, MOVE_ASTONISH),
    LEVEL_UP_MOVE(19, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(22, MOVE_MIST),
    LEVEL_UP_MOVE(25, MOVE_PH_VARDMG), //MOVE_BRINE),
    LEVEL_UP_MOVE(29, MOVE_REST),
    LEVEL_UP_MOVE(33, MOVE_PH_SPATK_ADJACENT2), //MOVE_WATER_SPOUT),
    LEVEL_UP_MOVE(37, MOVE_AMNESIA),
    LEVEL_UP_MOVE(41, MOVE_PH_BODY_2TURN), //MOVE_DIVE),
    LEVEL_UP_MOVE(45, MOVE_BOUNCE),
    LEVEL_UP_MOVE(49, MOVE_PH_BEAM3),
...
static const struct LevelUpMove sWailordLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(33, MOVE_PH_SPATK_ADJACENT2), //MOVE_WATER_SPOUT),
    LEVEL_UP_MOVE(37, MOVE_AMNESIA),
    LEVEL_UP_MOVE(44, MOVE_PH_BODY_2TURN), //MOVE_DIVE),
...
static const struct LevelUpMove sSkittyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 7, ORIGINAL_TYPE_MOVE(MOVE_PH_STATUS, TYPE_FAIRY)), //MOVE_SING),
    LEVEL_UP_MOVE(10, MOVE_ATTRACT),
    LEVEL_UP_MOVE(13, ORIGINAL_TYPE_MOVE(MOVE_PH_SPATK_ADJACENT1, TYPE_FAIRY)), //MOVE_DISARMING_VOICE),
    LEVEL_UP_MOVE(16, MOVE_DOUBLE_SLAP),
    LEVEL_UP_MOVE(19, MOVE_COPYCAT),
    LEVEL_UP_MOVE(22, ORIGINAL_TYPE_MOVE(MOVE_PH_SWIFT, TYPE_DARK)), //MOVE_FEINT_ATTACK),
...
static const struct LevelUpMove sDelcattyLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_FAKE_OUT),
    LEVEL_UP_MOVE( 1, ORIGINAL_TYPE_MOVE(MOVE_PH_STATUS, TYPE_FAIRY)), //MOVE_SING),
...
static const struct LevelUpMove sBaltoyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 7, MOVE_PH_ELEMENT_WEAK), //MOVE_MUD_SLAP),
    LEVEL_UP_MOVE(10, MOVE_HEAL_BLOCK),
    LEVEL_UP_MOVE(13, MOVE_ROCK_TOMB),
    LEVEL_UP_MOVE(16, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_PSYBEAM),
    ...
    LEVEL_UP_MOVE(31, MOVE_PH_BALL + MOVES_PH_TYPE2), //MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE(34, MOVE_GUARD_SPLIT),
    LEVEL_UP_MOVE(34, MOVE_POWER_SPLIT),
    LEVEL_UP_MOVE(37, MOVE_PH_ELEMENT_STRONG), //MOVE_EARTH_POWER),
    LEVEL_UP_MOVE(40, MOVE_PH_WEATHER), //MOVE_SANDSTORM),
...
static const struct LevelUpMove sClaydolLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(34, MOVE_GUARD_SPLIT),
    LEVEL_UP_MOVE(34, MOVE_POWER_SPLIT),
    LEVEL_UP_MOVE(40, MOVE_PH_ELEMENT_STRONG), //MOVE_EARTH_POWER),
    LEVEL_UP_MOVE(46, MOVE_PH_WEATHER), //MOVE_SANDSTORM),
...
static const struct LevelUpMove sNosepassLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(10, MOVE_PH_ATK_THROW), //MOVE_ROCK_THROW),
    LEVEL_UP_MOVE(13, MOVE_THUNDER_WAVE),
    LEVEL_UP_MOVE(16, MOVE_REST),
    LEVEL_UP_MOVE(19, MOVE_SPARK),
    LEVEL_UP_MOVE(22, MOVE_PH_SPATK_ADJACENT1), //MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE(25, MOVE_PH_ELEMENT_STRONG), //MOVE_POWER_GEM),
    LEVEL_UP_MOVE(28, MOVE_PH_ATK_WEAK), //MOVE_ROCK_BLAST),
    LEVEL_UP_MOVE(31, ORIGINAL_TYPE_MOVE(MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2, TYPE_STEEL)), //MOVE_DISCHARGE),
    LEVEL_UP_MOVE(34, MOVE_PH_WEATHER), //MOVE_SANDSTORM),
    LEVEL_UP_MOVE(37, MOVE_EARTH_POWER),
    LEVEL_UP_MOVE(40, MOVE_PH_HORN), //MOVE_STONE_EDGE),
...
static const struct LevelUpMove sTorkoalLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(18, MOVE_PH_HEAD), //MOVE_FLAME_WHEEL),
    LEVEL_UP_MOVE(22, MOVE_CURSE),
    LEVEL_UP_MOVE(25, MOVE_PH_ELEMENT_STRONG2), //MOVE_LAVA_PLUME),
...
static const struct LevelUpMove sSableyeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(19, MOVE_PH_SWIFT), //MOVE_FEINT_ATTACK),
    LEVEL_UP_MOVE(21, MOVE_FAKE_OUT),
    LEVEL_UP_MOVE(24, MOVE_PUNISHMENT),
    LEVEL_UP_MOVE(26, MOVE_PH_HORN), //MOVE_KNOCK_OFF),
    ...
    LEVEL_UP_MOVE(39, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_SHADOW_BALL),
...
static const struct LevelUpMove sBarboachLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2), //MOVE_MUD_SLAP),
    LEVEL_UP_MOVE( 6, MOVE_PH_TYPE_EFF + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 6, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE( 9, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE(13, MOVE_PH_BALL + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(15, MOVE_AMNESIA),
    LEVEL_UP_MOVE(17, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(20, MOVE_PH_VARDMG + MOVES_PH_TYPE2), //MOVE_MAGNITUDE),
    LEVEL_UP_MOVE(25, MOVE_REST),
    LEVEL_UP_MOVE(25, MOVE_SNORE),
    LEVEL_UP_MOVE(28, MOVE_PH_TAIL), //MOVE_AQUA_TAIL),
    LEVEL_UP_MOVE(32, MOVE_PH_SPATK_ADJACENT2 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(35, MOVE_PH_SPATK_ADJACENT1_MUD),
...
static const struct LevelUpMove sLuvdiscLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(34, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(37, MOVE_CAPTIVATE),
    LEVEL_UP_MOVE(40, MOVE_PH_HEAL_SAP),
...
static const struct LevelUpMove sCorphishLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(14, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE(17, MOVE_PROTECT),
    LEVEL_UP_MOVE(20, MOVE_DOUBLE_HIT),
    LEVEL_UP_MOVE(23, ORIGINAL_TYPE_MOVE(MOVE_PH_HORN + MOVES_PH_TYPE2, TYPE_DARK)), //MOVE_KNOCK_OFF),
    LEVEL_UP_MOVE(26, ORIGINAL_TYPE_MOVE(MOVE_PH_BLADE2 + MOVES_PH_TYPE2, TYPE_DARK)), //MOVE_NIGHT_SLASH),
    LEVEL_UP_MOVE(31, MOVE_PH_HORN), //MOVE_RAZOR_SHELL),
    LEVEL_UP_MOVE(34, MOVE_TAUNT),
    LEVEL_UP_MOVE(37, MOVE_SWORDS_DANCE),
    LEVEL_UP_MOVE(39, ORIGINAL_TYPE_MOVE(MOVE_PH_BITE2 + MOVES_PH_TYPE2, TYPE_DARK)), //MOVE_CRUNCH),
...
static const struct LevelUpMove sCrawdauntLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, ORIGINAL_TYPE_MOVE(MOVE_PH_SWIFT + MOVES_PH_TYPE2, TYPE_NORMAL)), //MOVE_SWIFT),
    LEVEL_UP_MOVE( 1, ORIGINAL_TYPE_MOVE(MOVE_PH_SWIFT + MOVES_PH_TYPE2, TYPE_NORMAL)), //MOVE_SWIFT),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK2),
    LEVEL_UP_MOVE( 1, MOVE_HARDEN),
    LEVEL_UP_MOVE( 1, MOVE_VISE_GRIP),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    ...
    LEVEL_UP_MOVE(17, MOVE_PROTECT),
    LEVEL_UP_MOVE(20, MOVE_DOUBLE_HIT),
    LEVEL_UP_MOVE(23, MOVE_PH_HORN + MOVES_PH_TYPE2), //MOVE_KNOCK_OFF),
    LEVEL_UP_MOVE(26, MOVE_PH_BLADE2 + MOVES_PH_TYPE2), //MOVE_NIGHT_SLASH),
    LEVEL_UP_MOVE(32, MOVE_PH_HORN), //MOVE_RAZOR_SHELL),
    LEVEL_UP_MOVE(36, MOVE_TAUNT),
    LEVEL_UP_MOVE(40, MOVE_SWORDS_DANCE),
    LEVEL_UP_MOVE(43, MOVE_PH_BITE2 + MOVES_PH_TYPE2), //MOVE_CRUNCH),
...
static const struct LevelUpMove sCarvanhaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(11, MOVE_PH_PRIORITY), //MOVE_AQUA_JET),
    LEVEL_UP_MOVE(15, MOVE_ASSURANCE),
    ...
    LEVEL_UP_MOVE(36, MOVE_PH_BITE2 + MOVES_PH_TYPE2), //MOVE_CRUNCH),
...
static const struct LevelUpMove sSharpedoLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_SLASH),
    LEVEL_UP_MOVE( 1, MOVE_SLASH),
    LEVEL_UP_MOVE( 1, MOVE_PH_BLADE2 + MOVES_PH_TYPE2), //MOVE_NIGHT_SLASH),
    LEVEL_UP_MOVE( 1, MOVE_FEINT),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_BITE),
    LEVEL_UP_MOVE( 1, MOVE_RAGE),
    ...
    LEVEL_UP_MOVE(40, MOVE_PH_BITE2 + MOVES_PH_TYPE2), //MOVE_CRUNCH),
    LEVEL_UP_MOVE(45, MOVE_AGILITY),
    LEVEL_UP_MOVE(51, MOVE_SKULL_BASH),
    LEVEL_UP_MOVE(56, MOVE_TAUNT),
    LEVEL_UP_MOVE(62, MOVE_PH_BLADE2 + MOVES_PH_TYPE2), //MOVE_NIGHT_SLASH),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sTrapinchLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_BIDE),
    LEVEL_UP_MOVE( 5, MOVE_PH_ELEMENT_WEAK), //MOVE_MUD_SLAP),
    LEVEL_UP_MOVE( 8, MOVE_PH_PRIORITY), //MOVE_BULLDOZE),
    LEVEL_UP_MOVE(12, MOVE_PH_ATK_TRAP), //MOVE_SAND_TOMB),
    LEVEL_UP_MOVE(15, MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE(19, MOVE_PH_BODY_2TURN), //MOVE_DIG),
    LEVEL_UP_MOVE(22, MOVE_CRUNCH),
    LEVEL_UP_MOVE(26, MOVE_PH_ELEMENT_STRONG), //MOVE_EARTH_POWER),
    LEVEL_UP_MOVE(29, MOVE_FEINT),
    LEVEL_UP_MOVE(33, MOVE_PH_SPATK_ADJACENT2),
    LEVEL_UP_MOVE(36, MOVE_PH_WEATHER), //MOVE_SANDSTORM),
    LEVEL_UP_MOVE(40, MOVE_SUPERPOWER),
...
static const struct LevelUpMove sVibravaLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_DRAGON_BREATH),
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_DRAGON_BREATH),
    LEVEL_UP_MOVE( 1, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_SONIC_BOOM),
    LEVEL_UP_MOVE( 1, MOVE_FEINT_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_BIDE),
...
static const struct LevelUpMove sFlygonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_BLADE + MOVES_PH_TYPE2), //MOVE_DRAGON_CLAW),
    LEVEL_UP_MOVE( 1, MOVE_PH_BLADE + MOVES_PH_TYPE2), //MOVE_DRAGON_CLAW),
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_DRAGON_BREATH),
    ...
    LEVEL_UP_MOVE(22, MOVE_SCREECH),
    LEVEL_UP_MOVE(26, MOVE_PH_ELEMENT_STRONG), //MOVE_EARTH_POWER),
    LEVEL_UP_MOVE(29, MOVE_PH_TAIL + MOVES_PH_TYPE2), //MOVE_DRAGON_TAIL),
    LEVEL_UP_MOVE(33, MOVE_PH_SPATK_ADJACENT2),
    LEVEL_UP_MOVE(36, MOVE_PH_WEATHER), //MOVE_SANDSTORM),
    LEVEL_UP_MOVE(40, MOVE_UPROAR),
    LEVEL_UP_MOVE(43, MOVE_HYPER_BEAM),
    LEVEL_UP_MOVE(47, MOVE_PH_BODY + MOVES_PH_TYPE2), //MOVE_DRAGON_RUSH),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMakuhitaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE( 4, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE( 7, MOVE_PH_FIST2), //MOVE_ARM_THRUST),
    LEVEL_UP_MOVE(10, MOVE_FAKE_OUT),
    LEVEL_UP_MOVE(13, MOVE_PH_FIST3), //MOVE_FORCE_PALM),
    LEVEL_UP_MOVE(16, MOVE_WHIRLWIND),
    LEVEL_UP_MOVE(19, MOVE_KNOCK_OFF),
    LEVEL_UP_MOVE(22, MOVE_PH_ATK_THROW), //MOVE_VITAL_THROW),
    LEVEL_UP_MOVE(25, MOVE_BELLY_DRUM),
    LEVEL_UP_MOVE(28, MOVE_SMELLING_SALTS),
    LEVEL_UP_MOVE(31, MOVE_PH_VARDMG), //MOVE_SEISMIC_TOSS),
    LEVEL_UP_MOVE(34, MOVE_WAKE_UP_SLAP),
    LEVEL_UP_MOVE(37, MOVE_ENDURE),
    LEVEL_UP_MOVE(40, MOVE_PH_BODY_RECOIL), //MOVE_CLOSE_COMBAT),
...
static const struct LevelUpMove sHariyamaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE( 1, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_PH_FIST2), //MOVE_ARM_THRUST),
    LEVEL_UP_MOVE( 4, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE( 7, MOVE_PH_FIST2), //MOVE_ARM_THRUST),
    LEVEL_UP_MOVE(10, MOVE_FAKE_OUT),
    LEVEL_UP_MOVE(13, MOVE_PH_FIST3), //MOVE_FORCE_PALM),
    ...
    LEVEL_UP_MOVE(34, MOVE_PH_VARDMG), //MOVE_SEISMIC_TOSS),
    LEVEL_UP_MOVE(38, MOVE_WAKE_UP_SLAP),
    LEVEL_UP_MOVE(42, MOVE_ENDURE),
    LEVEL_UP_MOVE(46, MOVE_PH_BODY_RECOIL), //MOVE_CLOSE_COMBAT),
    LEVEL_UP_MOVE(50, MOVE_REVERSAL),
...
static const struct LevelUpMove sElectrikeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(10, MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE(13, MOVE_PH_HEAD), //MOVE_SPARK),
    LEVEL_UP_MOVE(16, MOVE_ODOR_SLEUTH),
    LEVEL_UP_MOVE(19, MOVE_THUNDER_FANG),
    LEVEL_UP_MOVE(24, MOVE_BITE),
    LEVEL_UP_MOVE(29, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISCHARGE),
    LEVEL_UP_MOVE(34, MOVE_ROAR),
    LEVEL_UP_MOVE(39, MOVE_WILD_CHARGE),
    LEVEL_UP_MOVE(44, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(49, MOVE_PH_BEAM4), //MOVE_THUNDER),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sManectricLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(19, MOVE_THUNDER_FANG),
    LEVEL_UP_MOVE(24, MOVE_BITE),
    LEVEL_UP_MOVE(30, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISCHARGE),
    LEVEL_UP_MOVE(36, MOVE_ROAR),
    LEVEL_UP_MOVE(42, MOVE_WILD_CHARGE),
    LEVEL_UP_MOVE(48, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(54, MOVE_PH_BEAM4), //MOVE_THUNDER),
...
static const struct LevelUpMove sNumelLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 8, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE(12, MOVE_PH_VARDMG + MOVES_PH_TYPE2), //MOVE_MAGNITUDE),
    LEVEL_UP_MOVE(15, MOVE_PH_SPATK_ADJACENT1),
    LEVEL_UP_MOVE(19, MOVE_AMNESIA),
    LEVEL_UP_MOVE(22, MOVE_PH_ELEMENT_STRONG2), //MOVE_LAVA_PLUME),
    LEVEL_UP_MOVE(26, MOVE_PH_ELEMENT_STRONG + MOVES_PH_TYPE2), //MOVE_EARTH_POWER),
...
static const struct LevelUpMove sSphealLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(17, MOVE_PH_VARDMG + MOVES_PH_TYPE2), //MOVE_BRINE),
    LEVEL_UP_MOVE(21, MOVE_PH_BEAM1), //MOVE_AURORA_BEAM),
    LEVEL_UP_MOVE(26, MOVE_BODY_SLAM),
    LEVEL_UP_MOVE(31, MOVE_REST),
    LEVEL_UP_MOVE(31, MOVE_SNORE),
    LEVEL_UP_MOVE(36, MOVE_HAIL),
    LEVEL_UP_MOVE(41, MOVE_PH_SPATK_ADJACENT2), //MOVE_BLIZZARD),
...
static const struct LevelUpMove sSealeoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(45, MOVE_PH_SPATK_ADJACENT2), //MOVE_BLIZZARD),
...
static const struct LevelUpMove sWalreinLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_ICE_BALL),
    LEVEL_UP_MOVE(19, MOVE_PH_VARDMG + MOVES_PH_TYPE2), //MOVE_BRINE),
    LEVEL_UP_MOVE(19, MOVE_PH_BEAM1), //MOVE_AURORA_BEAM),
    LEVEL_UP_MOVE(25, MOVE_BODY_SLAM),
    LEVEL_UP_MOVE(31, MOVE_REST),
    LEVEL_UP_MOVE(31, MOVE_SNORE),
    LEVEL_UP_MOVE(38, MOVE_HAIL),
    LEVEL_UP_MOVE(49, MOVE_PH_SPATK_ADJACENT2), //MOVE_BLIZZARD),
...
static const struct LevelUpMove sCacneaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 4, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 7, MOVE_GROWTH),
    LEVEL_UP_MOVE(10, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(13, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE(16, MOVE_NEEDLE_ARM),
    LEVEL_UP_MOVE(19, ORIGINAL_TYPE_MOVE(MOVE_PH_SWIFT + MOVES_PH_TYPE2, TYPE_DARK)), //MOVE_FEINT_ATTACK),
    LEVEL_UP_MOVE(22, MOVE_INGRAIN),
    LEVEL_UP_MOVE(26, MOVE_PAYBACK),
    LEVEL_UP_MOVE(30, MOVE_SPIKES),
    LEVEL_UP_MOVE(34, ORIGINAL_TYPE_MOVE(MOVE_PH_PRIORITY + MOVES_PH_TYPE2, TYPE_DARK)), //MOVE_SUCKER_PUNCH),
    LEVEL_UP_MOVE(38, MOVE_PIN_MISSILE),
    LEVEL_UP_MOVE(42, MOVE_PH_BALL),
...
static const struct LevelUpMove sCacturneLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE(16, MOVE_NEEDLE_ARM),
    LEVEL_UP_MOVE(19, MOVE_PH_SWIFT + MOVES_PH_TYPE2), //MOVE_FEINT_ATTACK),
    LEVEL_UP_MOVE(22, MOVE_INGRAIN),
    LEVEL_UP_MOVE(26, MOVE_PAYBACK),
    LEVEL_UP_MOVE(30, MOVE_SPIKES),
    LEVEL_UP_MOVE(35, MOVE_PH_PRIORITY + MOVES_PH_TYPE2), //MOVE_SUCKER_PUNCH),
    LEVEL_UP_MOVE(38, MOVE_PIN_MISSILE),
    LEVEL_UP_MOVE(44, MOVE_PH_BALL),
...
static const struct LevelUpMove sSnoruntLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(46, MOVE_PH_SPATK_ADJACENT2), //MOVE_BLIZZARD),
...
static const struct LevelUpMove sLunatoneLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_STRONG), //MOVE_POWER_GEM),
    ...
    LEVEL_UP_MOVE(21, MOVE_PH_SPATK_ADJACENT1), //MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE(25, MOVE_COSMIC_POWER),
    LEVEL_UP_MOVE(29, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_PSYCHIC),
    LEVEL_UP_MOVE(33, MOVE_HEAL_BLOCK),
    LEVEL_UP_MOVE(37, MOVE_PH_HORN), //MOVE_STONE_EDGE),
    LEVEL_UP_MOVE(41, MOVE_PH_BEAM3 + MOVES_PH_TYPE2), //MOVE_FUTURE_SIGHT),
...
static const struct LevelUpMove sAzurillLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 2, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE( 5, ORIGINAL_TYPE_MOVE(MOVE_PH_TYPE_EFF, TYPE_WATER)),
    LEVEL_UP_MOVE( 7, MOVE_BUBBLE),
    LEVEL_UP_MOVE(10, MOVE_CHARM),
    LEVEL_UP_MOVE(13, ORIGINAL_TYPE_MOVE(MOVE_PH_BEAM2, TYPE_WATER)), //MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE(16, MOVE_HELPING_HAND),
...
static const struct LevelUpMove sSpoinkLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(10, MOVE_ODOR_SLEUTH),
    LEVEL_UP_MOVE(14, MOVE_PH_BEAM1), //MOVE_PSYBEAM),
    ...
    LEVEL_UP_MOVE(44, MOVE_PH_BEAM2), //MOVE_PSYCHIC),
...
static const struct LevelUpMove sGrumpigLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PSYWAVE),
    LEVEL_UP_MOVE( 1, MOVE_ODOR_SLEUTH),
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM1), //MOVE_PSYBEAM),
    LEVEL_UP_MOVE( 7, MOVE_PSYWAVE),
    LEVEL_UP_MOVE(10, MOVE_ODOR_SLEUTH),
    LEVEL_UP_MOVE(14, MOVE_PH_BEAM1), //MOVE_PSYBEAM),
    LEVEL_UP_MOVE(15, MOVE_PSYCH_UP),
    ...
    LEVEL_UP_MOVE(52, MOVE_PH_BEAM2), //MOVE_PSYCHIC),
    LEVEL_UP_MOVE(60, MOVE_BOUNCE),
    LEVEL_UP_END
};

static const struct LevelUpMove sPlusleLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_PH_ATK_WEAK), //MOVE_NUZZLE),
    LEVEL_UP_MOVE( 1, MOVE_PLAY_NICE),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_PH_STATUS3), //MOVE_THUNDER_WAVE),
    LEVEL_UP_MOVE( 1, MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE( 4, MOVE_HELPING_HAND),
    LEVEL_UP_MOVE( 7, MOVE_PH_HEAD), //MOVE_SPARK),
    LEVEL_UP_MOVE(10, MOVE_ENCORE),
    LEVEL_UP_MOVE(13, MOVE_BESTOW),
    LEVEL_UP_MOVE(16, MOVE_SWIFT),
    LEVEL_UP_MOVE(19, MOVE_PH_VARDMG), //MOVE_ELECTRO_BALL),
    LEVEL_UP_MOVE(22, MOVE_COPYCAT),
    LEVEL_UP_MOVE(25, MOVE_CHARM),
    LEVEL_UP_MOVE(28, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(31, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISCHARGE),
...
static const struct LevelUpMove sMawileLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_PH_BODY + MOVES_PH_TYPE2), //MOVE_PLAY_ROUGH),
    LEVEL_UP_MOVE( 1, MOVE_PH_HEAD), //MOVE_IRON_HEAD),
    LEVEL_UP_MOVE( 1, MOVE_TAUNT),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    ...
    LEVEL_UP_MOVE(45, MOVE_PH_HEAD), //MOVE_IRON_HEAD),
    LEVEL_UP_MOVE(49, MOVE_PH_BODY + MOVES_PH_TYPE2), //MOVE_PLAY_ROUGH),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMedititeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 7, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 9, MOVE_DETECT),
    LEVEL_UP_MOVE(12, MOVE_ENDURE),
    LEVEL_UP_MOVE(15, MOVE_FEINT),
    LEVEL_UP_MOVE(17, MOVE_PH_FIST3), //MOVE_FORCE_PALM),
...
static const struct LevelUpMove sSwabluLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(23, MOVE_PH_BODY_RECOIL), //MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(26, MOVE_REFRESH),
    LEVEL_UP_MOVE(30, MOVE_MIRROR_MOVE),
    LEVEL_UP_MOVE(34, MOVE_COTTON_GUARD),
    LEVEL_UP_MOVE(38, ORIGINAL_TYPE_MOVE(MOVE_PH_BEAM2, TYPE_DRAGON)), //MOVE_DRAGON_PULSE),
...
static const struct LevelUpMove sAltariaLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_BEAM1), //MOVE_DRAGON_BREATH),
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM1), //MOVE_DRAGON_BREATH),
    LEVEL_UP_MOVE( 1, MOVE_SKY_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_PLUCK),
    LEVEL_UP_MOVE( 1, MOVE_PECK),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    ...
    LEVEL_UP_MOVE(17, MOVE_ROUND),
    LEVEL_UP_MOVE(20, MOVE_NATURAL_GIFT),
    LEVEL_UP_MOVE(23, ORIGINAL_TYPE_MOVE(MOVE_PH_BODY_RECOIL, TYPE_NORMAL)), //MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(26, MOVE_REFRESH),
    LEVEL_UP_MOVE(30, MOVE_DRAGON_DANCE),
    LEVEL_UP_MOVE(34, MOVE_COTTON_GUARD),
    LEVEL_UP_MOVE(40, MOVE_PH_BEAM2), //MOVE_DRAGON_PULSE),
    LEVEL_UP_MOVE(46, MOVE_PERISH_SONG),
...
static const struct LevelUpMove sDuskullLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(33, MOVE_PH_HEAL_SAP),
...
static const struct LevelUpMove sDusclopsLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(33, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(40, MOVE_HEX),
    LEVEL_UP_MOVE(45, MOVE_PH_BEAM2), //MOVE_SHADOW_BALL),
...
static const struct LevelUpMove sRoseliaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 7, MOVE_PH_ATK_WEAK + MOVES_PH_TYPE2), //MOVE_POISON_STING),
    LEVEL_UP_MOVE(10, MOVE_STUN_SPORE),
    LEVEL_UP_MOVE(13, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(16, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(19, MOVE_MAGICAL_LEAF),
    LEVEL_UP_MOVE(22, MOVE_GRASS_WHISTLE),
    LEVEL_UP_MOVE(25, MOVE_PH_BEAM2),
    LEVEL_UP_MOVE(28, MOVE_PH_HAZARD + MOVES_PH_TYPE2), //MOVE_TOXIC_SPIKES),
    LEVEL_UP_MOVE(31, MOVE_SWEET_SCENT),
    LEVEL_UP_MOVE(34, MOVE_INGRAIN),
    LEVEL_UP_MOVE(37, MOVE_PETAL_BLIZZARD),
    LEVEL_UP_MOVE(40, MOVE_PH_STATUS3 + MOVES_PH_TYPE2), //MOVE_TOXIC),
    LEVEL_UP_MOVE(43, MOVE_AROMATHERAPY),
    LEVEL_UP_MOVE(46, MOVE_PH_RECOVER), //MOVE_SYNTHESIS),
...
static const struct LevelUpMove sSlakothLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_PH_STATUS2), //MOVE_YAWN),
    ...
    LEVEL_UP_MOVE(25, MOVE_PH_BLADE2), //MOVE_CHIP_AWAY),
...
static const struct LevelUpMove sVigorothLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(27, MOVE_PH_BLADE2), //MOVE_CHIP_AWAY),
...
static const struct LevelUpMove sSwalotLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(37, MOVE_PH_BEAM2), //MOVE_SLUDGE_BOMB),
    LEVEL_UP_MOVE(42, MOVE_PH_TYPE_EFF), //MOVE_GASTRO_ACID),
...
static const struct LevelUpMove sTropiusLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(26, MOVE_PH_STRONGWIND), //MOVE_LEAF_TORNADO),
    LEVEL_UP_MOVE(30, MOVE_NATURAL_GIFT),
    LEVEL_UP_MOVE(36, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
    LEVEL_UP_MOVE(41, MOVE_BODY_SLAM),
    LEVEL_UP_MOVE(46, MOVE_BESTOW),
    LEVEL_UP_MOVE(50, MOVE_PH_RECOVER), //MOVE_SYNTHESIS),
    LEVEL_UP_MOVE(56, MOVE_PH_BEAM4),
    LEVEL_UP_MOVE(61, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sWhismurLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_POUND),
    LEVEL_UP_MOVE( 4, MOVE_PH_ELEMENT_WEAK), //MOVE_ECHOED_VOICE),
    LEVEL_UP_MOVE( 8, MOVE_ASTONISH),
    ...
    LEVEL_UP_MOVE(39, MOVE_PH_SPATK_ADJACENT1),
    LEVEL_UP_MOVE(43, MOVE_SYNCHRONOISE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sLoudredLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_BITE),
    LEVEL_UP_MOVE( 1, MOVE_POUND),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK), //MOVE_ECHOED_VOICE),
    LEVEL_UP_MOVE( 1, MOVE_ASTONISH),
    LEVEL_UP_MOVE( 1, MOVE_HOWL),
    LEVEL_UP_MOVE( 4, MOVE_PH_ELEMENT_WEAK), //MOVE_ECHOED_VOICE),
    LEVEL_UP_MOVE( 9, MOVE_ASTONISH),
    ...
    LEVEL_UP_MOVE(45, MOVE_PH_SPATK_ADJACENT1),
    LEVEL_UP_MOVE(50, MOVE_SYNCHRONOISE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sClamperlLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 1, MOVE_PH_HAZARD),
...
static const struct LevelUpMove sHuntailLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(19, MOVE_PH_VARDMG), //MOVE_BRINE),
    LEVEL_UP_MOVE(23, MOVE_SUCKER_PUNCH),
    LEVEL_UP_MOVE(26, MOVE_PH_BODY_2TURN), //MOVE_DIVE),
    LEVEL_UP_MOVE(29, MOVE_BATON_PASS),
    LEVEL_UP_MOVE(34, MOVE_CRUNCH),
    LEVEL_UP_MOVE(39, MOVE_PH_TAIL), //MOVE_AQUA_TAIL),
...
static const struct LevelUpMove sAbsolLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(22, ORIGINAL_TYPE_MOVE(MOVE_PH_BLADE, TYPE_NORMAL)), //MOVE_SLASH),
    LEVEL_UP_MOVE(25, MOVE_SWORDS_DANCE),
    LEVEL_UP_MOVE(29, MOVE_PH_BLADE2), //MOVE_NIGHT_SLASH),
    LEVEL_UP_MOVE(33, MOVE_DETECT),
    LEVEL_UP_MOVE(37, ORIGINAL_TYPE_MOVE(MOVE_PH_BLADE2, TYPE_PSYCHIC)), //MOVE_PSYCHO_CUT),
    LEVEL_UP_MOVE(41, MOVE_ME_FIRST),
    LEVEL_UP_MOVE(45, MOVE_PH_PRIORITY), //MOVE_SUCKER_PUNCH),
...
static const struct LevelUpMove sShuppetLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(26, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(30, MOVE_PH_BEAM2), //MOVE_SHADOW_BALL),
    ...
    LEVEL_UP_MOVE(54, MOVE_PH_BODY_2TURN), //MOVE_PHANTOM_FORCE),
    LEVEL_UP_END
};

static const struct LevelUpMove sBanetteLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_PH_BODY_2TURN), //MOVE_PHANTOM_FORCE),
    LEVEL_UP_MOVE( 1, MOVE_KNOCK_OFF),
    LEVEL_UP_MOVE( 1, MOVE_SCREECH),
    LEVEL_UP_MOVE( 1, MOVE_NIGHT_SHADE),
    LEVEL_UP_MOVE( 1, MOVE_SPITE),
    ...
    LEVEL_UP_MOVE(64, MOVE_PH_BODY_2TURN), //MOVE_PHANTOM_FORCE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSeviperLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 9, MOVE_PH_TAIL), //MOVE_POISON_TAIL),
    LEVEL_UP_MOVE(11, MOVE_FEINT),
    LEVEL_UP_MOVE(14, MOVE_SCREECH),
    LEVEL_UP_MOVE(16, MOVE_PH_VARDMG), //MOVE_VENOSHOCK),
    LEVEL_UP_MOVE(19, MOVE_GLARE),
    LEVEL_UP_MOVE(21, MOVE_PH_BITE), //MOVE_POISON_FANG),
    LEVEL_UP_MOVE(24, MOVE_VENOM_DRENCH),
    LEVEL_UP_MOVE(26, MOVE_NIGHT_SLASH),
    LEVEL_UP_MOVE(29, MOVE_PH_TYPE_EFF), //MOVE_GASTRO_ACID),
    LEVEL_UP_MOVE(31, MOVE_PH_HORN), //MOVE_POISON_JAB),
...
static const struct LevelUpMove sRelicanthLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(26, MOVE_PH_BODY_2TURN), //MOVE_DIVE),
    LEVEL_UP_MOVE(31, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(35, ORIGINAL_TYPE_MOVE(MOVE_PH_STATUS2, TYPE_NORMAL)), //MOVE_YAWN),
...
static const struct LevelUpMove sAronLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(22, MOVE_PH_HEAD), //MOVE_IRON_HEAD),
    LEVEL_UP_MOVE(25, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2), //MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE(28, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(31, MOVE_METAL_SOUND),
    LEVEL_UP_MOVE(34, MOVE_PH_TAIL), //MOVE_IRON_TAIL),
    LEVEL_UP_MOVE(37, MOVE_IRON_DEFENSE),
    LEVEL_UP_MOVE(40, MOVE_DOUBLE_EDGE),
...
static const struct LevelUpMove sLaironLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(28, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(31, MOVE_METAL_SOUND),
    LEVEL_UP_MOVE(35, MOVE_PH_TAIL), //MOVE_IRON_TAIL),
    LEVEL_UP_MOVE(39, MOVE_IRON_DEFENSE),
    LEVEL_UP_MOVE(43, MOVE_DOUBLE_EDGE),
...
static const struct LevelUpMove sLileepLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(26, MOVE_PH_BEAM2 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(31, MOVE_GASTRO_ACID),
    LEVEL_UP_MOVE(36, MOVE_AMNESIA),
    LEVEL_UP_MOVE(41, MOVE_PH_BALL + MOVES_PH_TYPE2),
...
static const struct LevelUpMove sCradilyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(31, MOVE_GASTRO_ACID),
    LEVEL_UP_MOVE(36, MOVE_AMNESIA),
    LEVEL_UP_MOVE(44, MOVE_PH_BALL + MOVES_PH_TYPE2),
...
static const struct LevelUpMove sAnorithLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(21, MOVE_ANCIENT_POWER),
    LEVEL_UP_MOVE(25, MOVE_PH_BITE + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(29, MOVE_BRINE),
    LEVEL_UP_MOVE(34, MOVE_SLASH),
    LEVEL_UP_MOVE(39, MOVE_CRUSH_CLAW),
    LEVEL_UP_MOVE(44, MOVE_PH_BLADE + MOVES_PH_TYPE2), //MOVE_X_SCISSOR),
    LEVEL_UP_MOVE(49, MOVE_PROTECT),
    LEVEL_UP_MOVE(55, MOVE_PH_ATK_WEAK), //MOVE_ROCK_BLAST),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sArmaldoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(34, MOVE_SLASH),
    LEVEL_UP_MOVE(39, MOVE_CRUSH_CLAW),
    LEVEL_UP_MOVE(46, MOVE_PH_BLADE + MOVES_PH_TYPE2), //MOVE_X_SCISSOR),
    LEVEL_UP_MOVE(53, MOVE_PROTECT),
    LEVEL_UP_MOVE(61, MOVE_PH_ATK_WEAK), //MOVE_ROCK_BLAST),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sRaltsLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(27, MOVE_PH_BEAM2), //MOVE_PSYCHIC),
    LEVEL_UP_MOVE(29, MOVE_IMPRISON),
    LEVEL_UP_MOVE(32, MOVE_PH_BEAM3), //MOVE_FUTURE_SIGHT),
...
static const struct LevelUpMove sKirliaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(37, MOVE_PH_BEAM3), //MOVE_FUTURE_SIGHT),
...
static const struct LevelUpMove sGardevoirLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(23, MOVE_DRAINING_KISS),
    LEVEL_UP_MOVE(26, MOVE_CALM_MIND),
    LEVEL_UP_MOVE(31, MOVE_PH_BEAM2), //MOVE_PSYCHIC),
    LEVEL_UP_MOVE(35, MOVE_IMPRISON),
    LEVEL_UP_MOVE(40, MOVE_PH_BEAM3), //MOVE_FUTURE_SIGHT),
...
static const struct LevelUpMove sBagonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(10, MOVE_BITE),
    LEVEL_UP_MOVE(13, MOVE_PH_BEAM1), //MOVE_DRAGON_BREATH),
    LEVEL_UP_MOVE(17, MOVE_HEADBUTT),
    LEVEL_UP_MOVE(21, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE(25, MOVE_CRUNCH),
    LEVEL_UP_MOVE(29, MOVE_PH_BLADE), //MOVE_DRAGON_CLAW),
    LEVEL_UP_MOVE(34, MOVE_ZEN_HEADBUTT),
...
static const struct LevelUpMove sSalamenceLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_BODY_2TURN + MOVES_PH_TYPE2), //MOVE_FLY),
    LEVEL_UP_MOVE( 1, MOVE_PH_BODY_2TURN + MOVES_PH_TYPE2), //MOVE_FLY),
    LEVEL_UP_MOVE( 1, MOVE_PROTECT),
    LEVEL_UP_MOVE( 1, MOVE_PH_TAIL), //MOVE_DRAGON_TAIL),
    LEVEL_UP_MOVE( 1, MOVE_FIRE_FANG),
    LEVEL_UP_MOVE( 1, MOVE_THUNDER_FANG),
    LEVEL_UP_MOVE( 1, MOVE_RAGE),
    LEVEL_UP_MOVE( 1, MOVE_EMBER),
...
static const struct LevelUpMove sRegirockLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(37, MOVE_IRON_DEFENSE),
    LEVEL_UP_MOVE(43, MOVE_PH_HORN), //MOVE_STONE_EDGE),
...
static const struct LevelUpMove sRegiceLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(31, MOVE_ANCIENT_POWER),
    LEVEL_UP_MOVE(37, MOVE_AMNESIA),
    LEVEL_UP_MOVE(43, MOVE_PH_BEAM2), //MOVE_ICE_BEAM),
    LEVEL_UP_MOVE(49, MOVE_HAMMER_ARM),
    LEVEL_UP_MOVE(55, MOVE_LOCK_ON),
    LEVEL_UP_MOVE(55, MOVE_ZAP_CANNON),
    LEVEL_UP_MOVE(61, MOVE_SUPERPOWER),
...
static const struct LevelUpMove sRegisteelLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(37, MOVE_IRON_DEFENSE),
    LEVEL_UP_MOVE(37, MOVE_AMNESIA),
    LEVEL_UP_MOVE(43, MOVE_PH_HEAD), //MOVE_IRON_HEAD),
    LEVEL_UP_MOVE(43, MOVE_PH_BEAM2), //MOVE_FLASH_CANNON),
    LEVEL_UP_MOVE(49, MOVE_HAMMER_ARM),
    LEVEL_UP_MOVE(55, MOVE_LOCK_ON),
    LEVEL_UP_MOVE(55, MOVE_ZAP_CANNON),
    LEVEL_UP_MOVE(61, MOVE_SUPERPOWER),
...
static const struct LevelUpMove sKyogreLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(15, MOVE_PH_TAIL), //MOVE_AQUA_TAIL),
    LEVEL_UP_MOVE(20, MOVE_BODY_SLAM),
    LEVEL_UP_MOVE(30, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(35, MOVE_ICE_BEAM),
    LEVEL_UP_MOVE(45, MOVE_ORIGIN_PULSE),
    LEVEL_UP_MOVE(50, MOVE_CALM_MIND),
    LEVEL_UP_MOVE(60, MOVE_PH_SPATK_ADJACENT1_MUD),
    LEVEL_UP_MOVE(65, MOVE_SHEER_COLD),
    LEVEL_UP_MOVE(75, MOVE_PH_BEAM3),
    LEVEL_UP_MOVE(80, MOVE_DOUBLE_EDGE),
    LEVEL_UP_MOVE(90, MOVE_PH_SPATK_ADJACENT2), //MOVE_WATER_SPOUT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sGroudonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE( 5, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(15, MOVE_PH_ELEMENT_STRONG), //MOVE_EARTH_POWER),
    LEVEL_UP_MOVE(20, MOVE_LAVA_PLUME),
    LEVEL_UP_MOVE(30, MOVE_REST),
    LEVEL_UP_MOVE(35, MOVE_PH_SPATK_ADJACENT2),
    ...
    LEVEL_UP_MOVE(75, ORIGINAL_TYPE_MOVE(MOVE_PH_BEAM4, TYPE_FIRE)), //MOVE_FIRE_BLAST),
...
static const struct LevelUpMove sRayquazaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(30, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
    LEVEL_UP_MOVE(35, MOVE_REST),
    LEVEL_UP_MOVE(45, MOVE_EXTREME_SPEED),
    LEVEL_UP_MOVE(50, MOVE_PH_BEAM2), //MOVE_DRAGON_PULSE),
    LEVEL_UP_MOVE(60, MOVE_DRAGON_DANCE),
    LEVEL_UP_MOVE(65, MOVE_PH_BODY_2TURN + MOVES_PH_TYPE2), //MOVE_FLY),
    LEVEL_UP_MOVE(75, MOVE_HYPER_VOICE),
    LEVEL_UP_MOVE(80, MOVE_PH_THRASH), //MOVE_OUTRAGE),
...
static const struct LevelUpMove sLatiasLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(20, MOVE_PH_BEAM1), //MOVE_DRAGON_BREATH),
    ...
    LEVEL_UP_MOVE(51, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_PSYCHIC),
    LEVEL_UP_MOVE(56, MOVE_PH_BEAM2), //MOVE_DRAGON_PULSE),
...
static const struct LevelUpMove sJirachiLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(20, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_PSYCHIC),
    ...
    LEVEL_UP_MOVE(55, MOVE_PH_BEAM3 + MOVES_PH_TYPE2), //MOVE_FUTURE_SIGHT),
...
static const struct LevelUpMove sTurtwigLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 9, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE(13, MOVE_PH_SPATK_ADJACENT1), //MOVE_RAZOR_LEAF),
    LEVEL_UP_MOVE(17, MOVE_CURSE),
    LEVEL_UP_MOVE(21, MOVE_BITE),
    LEVEL_UP_MOVE(25, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(29, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(33, MOVE_PH_RECOVER), //MOVE_SYNTHESIS),
    LEVEL_UP_MOVE(37, MOVE_CRUNCH),
    LEVEL_UP_MOVE(41, MOVE_PH_BEAM2),
    LEVEL_UP_MOVE(45, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sGrotleLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(27, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(32, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(37, MOVE_PH_RECOVER), //MOVE_SYNTHESIS),
    LEVEL_UP_MOVE(42, MOVE_CRUNCH),
    LEVEL_UP_MOVE(47, MOVE_PH_BEAM2),
    LEVEL_UP_MOVE(52, MOVE_PH_BEAM3),
    LEVEL_UP_END
};

static const struct LevelUpMove sTorterraLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_SPATK_ADJACENT2 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 1, MOVE_PH_SPATK_ADJACENT2 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 1, MOVE_WOOD_HAMMER),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_WITHDRAW),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK),
    ...
    LEVEL_UP_MOVE(51, MOVE_PH_BEAM2),
    LEVEL_UP_MOVE(57, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMonfernoLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_PRIORITY + MOVES_PH_TYPE2), //MOVE_MACH_PUNCH),
    LEVEL_UP_MOVE( 1, MOVE_PH_PRIORITY + MOVES_PH_TYPE2), //MOVE_MACH_PUNCH),
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 7, MOVE_PH_ELEMENT_WEAK),
    ...
    LEVEL_UP_MOVE(36, MOVE_PH_BODY_RECOIL + MOVES_PH_TYPE2), //MOVE_CLOSE_COMBAT),
    LEVEL_UP_MOVE(39, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(46, MOVE_ACROBATICS),
    LEVEL_UP_MOVE(49, MOVE_SLACK_OFF),
    LEVEL_UP_MOVE(56, MOVE_PH_BODY),
    LEVEL_UP_END
};

static const struct LevelUpMove sInfernapeLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_BODY_RECOIL + MOVES_PH_TYPE2), //MOVE_CLOSE_COMBAT),
    LEVEL_UP_MOVE( 1, MOVE_PH_BODY_RECOIL + MOVES_PH_TYPE2), //MOVE_CLOSE_COMBAT),
    LEVEL_UP_MOVE( 1, MOVE_PH_PRIORITY + MOVES_PH_TYPE2), //MOVE_MACH_PUNCH),
    LEVEL_UP_MOVE( 1, MOVE_PH_BODY),
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
...
static const struct LevelUpMove sPiplupLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_POUND),
    LEVEL_UP_MOVE( 4, MOVE_GROWL),
    LEVEL_UP_MOVE( 8, MOVE_PH_ELEMENT_WEAK2),
    LEVEL_UP_MOVE(11, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE(15, MOVE_PECK),
    LEVEL_UP_MOVE(18, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE(22, MOVE_BIDE),
    LEVEL_UP_MOVE(25, MOVE_FURY_ATTACK),
    LEVEL_UP_MOVE(29, MOVE_PH_VARDMG), //MOVE_BRINE),
    LEVEL_UP_MOVE(32, MOVE_PH_HAZARD),
    LEVEL_UP_MOVE(36, MOVE_MIST),
...
static const struct LevelUpMove sPrinplupLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(11, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE(15, MOVE_PECK),
    LEVEL_UP_MOVE(19, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE(24, MOVE_BIDE),
    LEVEL_UP_MOVE(28, MOVE_FURY_ATTACK),
    LEVEL_UP_MOVE(33, MOVE_PH_VARDMG), //MOVE_BRINE),
    LEVEL_UP_MOVE(37, MOVE_PH_HAZARD),
...
static const struct LevelUpMove sEmpoleonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_BODY_ATK_SPEED), //MOVE_AQUA_JET),
    LEVEL_UP_MOVE( 1, MOVE_PH_BODY_ATK_SPEED), //MOVE_AQUA_JET),
    LEVEL_UP_MOVE( 1, MOVE_METAL_CLAW),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    ...
    LEVEL_UP_MOVE(28, MOVE_FURY_ATTACK),
    LEVEL_UP_MOVE(33, MOVE_PH_VARDMG), //MOVE_BRINE),
    LEVEL_UP_MOVE(39, MOVE_PH_HAZARD),
...
static const struct LevelUpMove sStarlyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(21, MOVE_WHIRLWIND),
    LEVEL_UP_MOVE(25, MOVE_PH_BLADE + MOVES_PH_TYPE2), //MOVE_AERIAL_ACE),
    LEVEL_UP_MOVE(29, MOVE_PH_BODY_RECOIL), //MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(33, MOVE_AGILITY),
    LEVEL_UP_MOVE(37, MOVE_PH_BODY_RECOIL + MOVES_PH_TYPE2), //MOVE_BRAVE_BIRD),
...
static const struct LevelUpMove sStaraviaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(28, MOVE_PH_BLADE + MOVES_PH_TYPE2), //MOVE_AERIAL_ACE),
    LEVEL_UP_MOVE(33, MOVE_PH_BODY_RECOIL), //MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(38, MOVE_AGILITY),
    LEVEL_UP_MOVE(43, MOVE_PH_BODY_RECOIL + MOVES_PH_TYPE2), //MOVE_BRAVE_BIRD),
...
static const struct LevelUpMove sStaraptorLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(33, MOVE_PH_BODY_RECOIL), //MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(41, MOVE_AGILITY),
    LEVEL_UP_MOVE(49, MOVE_PH_BODY_RECOIL + MOVES_PH_TYPE2), //MOVE_BRAVE_BIRD),
    LEVEL_UP_MOVE(57, MOVE_FINAL_GAMBIT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sBidoofLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 5, MOVE_DEFENSE_CURL),
    LEVEL_UP_MOVE( 9, ORIGINAL_TYPE_MOVE(MOVE_PH_ELEMENT_WEAK, TYPE_ROCK)), //MOVE_ROLLOUT),
    LEVEL_UP_MOVE(13, MOVE_PH_HEAD),
    LEVEL_UP_MOVE(17, MOVE_HYPER_FANG),
    LEVEL_UP_MOVE(21, ORIGINAL_TYPE_MOVE(MOVE_PH_STATUS2, TYPE_NORMAL)), //MOVE_YAWN),
    LEVEL_UP_MOVE(25, MOVE_CRUNCH),
    LEVEL_UP_MOVE(29, MOVE_PH_BODY_RECOIL), //MOVE_TAKE_DOWN),
...
static const struct LevelUpMove sBibarelLevelUpLearnset[] = {   // NORMAL, WATER
    LEVEL_UP_MOVE( 0, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 1, MOVE_PH_BODY_ATK_SPEED + MOVES_PH_TYPE2), //MOVE_AQUA_JET),
    LEVEL_UP_MOVE( 1, MOVE_ROTOTILLER),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 5, MOVE_DEFENSE_CURL),
    ...
    LEVEL_UP_MOVE(23, ORIGINAL_TYPE_MOVE(MOVE_PH_STATUS2, TYPE_NORMAL)), //MOVE_YAWN),
...
static const struct LevelUpMove sKricketuneLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(22, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE(26, MOVE_SLASH),
    LEVEL_UP_MOVE(30, MOVE_PH_BLADE), //MOVE_X_SCISSOR),
...
static const struct LevelUpMove sShinxLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 9, MOVE_PH_HEAL_SAP),
...
static const struct LevelUpMove sLuxioLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(43, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(48, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISCHARGE),
...
static const struct LevelUpMove sLuxrayLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(56, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISCHARGE),
...
static const struct LevelUpMove sBudewLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(10, MOVE_STUN_SPORE),
    LEVEL_UP_MOVE(13, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(16, MOVE_PH_TYPE_EFF),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sShieldonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(42, MOVE_PH_HEAD + MOVES_PH_TYPE2), //MOVE_IRON_HEAD),
    LEVEL_UP_MOVE(46, MOVE_HEAVY_SLAM),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sBastiodonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(51, MOVE_PH_HEAD + MOVES_PH_TYPE2), //MOVE_IRON_HEAD),
...
static const struct LevelUpMove sWormadamLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(26, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2), //MOVE_RAZOR_LEAF),
    LEVEL_UP_MOVE(29, MOVE_GROWTH),
...
static const struct LevelUpMove sMothimLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(20, MOVE_HIDDEN_POWER),
    LEVEL_UP_MOVE(23, MOVE_CONFUSION),
    LEVEL_UP_MOVE(26, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(29, MOVE_POISON_POWDER),
    LEVEL_UP_MOVE(32, MOVE_PSYBEAM),
    LEVEL_UP_MOVE(35, MOVE_CAMOUFLAGE),
    LEVEL_UP_MOVE(38, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(41, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
    LEVEL_UP_MOVE(44, MOVE_PSYCHIC),
...
static const struct LevelUpMove sCombeeLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SWEET_SCENT),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(13, MOVE_PH_BITE),
    LEVEL_UP_MOVE(29, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sVespiquenLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(29, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(33, MOVE_TOXIC),
    LEVEL_UP_MOVE(37, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
...
static const struct LevelUpMove sPachirisuLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_PH_HEAD), //MOVE_SPARK),
    LEVEL_UP_MOVE(17, MOVE_ENDURE),
    LEVEL_UP_MOVE(19, MOVE_PH_ATK_WEAK), //MOVE_NUZZLE),
...
static const struct LevelUpMove sBuizelLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(15, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE(18, MOVE_PURSUIT),
    LEVEL_UP_MOVE(21, MOVE_SWIFT),
    LEVEL_UP_MOVE(24, MOVE_PH_PRIORITY), //MOVE_AQUA_JET),
    LEVEL_UP_MOVE(27, MOVE_DOUBLE_HIT),
    LEVEL_UP_MOVE(31, MOVE_PH_HAZARD),
    LEVEL_UP_MOVE(35, MOVE_RAZOR_WIND),
    LEVEL_UP_MOVE(38, MOVE_PH_TAIL), //MOVE_AQUA_TAIL),
    LEVEL_UP_MOVE(41, MOVE_AGILITY),
    LEVEL_UP_MOVE(45, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sFloatzelLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(35, MOVE_PH_HAZARD),
    LEVEL_UP_MOVE(41, MOVE_RAZOR_WIND),
    LEVEL_UP_MOVE(46, MOVE_PH_TAIL), //MOVE_AQUA_TAIL),
...
static const struct LevelUpMove sCherubiLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(28, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE(31, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(37, MOVE_PH_BEAM4),
...
static const struct LevelUpMove sCherrimLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(19, MOVE_MAGICAL_LEAF),
    LEVEL_UP_MOVE(22, MOVE_SUNNY_DAY),
    LEVEL_UP_MOVE(30, MOVE_PH_TYPE_EFF),
...
static const struct LevelUpMove sShellosLevelUpLearnset[] = {   // WATER
    LEVEL_UP_MOVE( 1, ORIGINAL_TYPE_MOVE(MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2, TYPE_GROUND)), //MOVE_MUD_SLAP),
    LEVEL_UP_MOVE( 2, ORIGINAL_TYPE_MOVE(MOVE_PH_TYPE_EFF + MOVES_PH_TYPE2, TYPE_GROUND)),
    LEVEL_UP_MOVE( 4, MOVE_HARDEN),
    LEVEL_UP_MOVE( 7, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(11, ORIGINAL_TYPE_MOVE(MOVE_PH_BALL + MOVES_PH_TYPE2, TYPE_GROUND)),
...
static const struct LevelUpMove sGastrodonLevelUpLearnset[] = { // WATER, GROUND
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK), //MOVE_MUD_SLAP),
    LEVEL_UP_MOVE( 1, MOVE_PH_TYPE_EFF + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 1, MOVE_HARDEN),
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE( 2, MOVE_PH_TYPE_EFF + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 4, MOVE_HARDEN),
    LEVEL_UP_MOVE( 7, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(11, MOVE_PH_BALL + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(16, MOVE_HIDDEN_POWER),
    LEVEL_UP_MOVE(22, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
    LEVEL_UP_MOVE(29, MOVE_BODY_SLAM),
    LEVEL_UP_MOVE(41, MOVE_PH_SPATK_ADJACENT1_MUD),
...
static const struct LevelUpMove sDrifloonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 8, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    ...
    LEVEL_UP_MOVE(36, MOVE_PH_BEAM2), //MOVE_SHADOW_BALL),
    LEVEL_UP_MOVE(40, MOVE_AMNESIA),
...
static const struct LevelUpMove sDrifblimLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(40, MOVE_PH_BEAM2), //MOVE_SHADOW_BALL),
    LEVEL_UP_MOVE(46, MOVE_AMNESIA),
    LEVEL_UP_MOVE(52, MOVE_BATON_PASS),
    LEVEL_UP_MOVE(60, MOVE_EXPLOSION),
    LEVEL_UP_MOVE(65, MOVE_PH_BODY_2TURN), //MOVE_PHANTOM_FORCE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sBunearyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(16, MOVE_PH_PRIORITY), //MOVE_QUICK_ATTACK),
...
static const struct LevelUpMove sHonchkrowLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_PH_BLADE2), //MOVE_NIGHT_SLASH),
    LEVEL_UP_MOVE( 1, MOVE_PH_PRIORITY), //MOVE_SUCKER_PUNCH),
    LEVEL_UP_MOVE( 1, MOVE_ASTONISH),
    LEVEL_UP_MOVE( 1, MOVE_PURSUIT),
    ...
    LEVEL_UP_MOVE(45, MOVE_FOUL_PLAY),
    LEVEL_UP_MOVE(55, MOVE_PH_BLADE2), //MOVE_NIGHT_SLASH),
    LEVEL_UP_MOVE(65, MOVE_QUASH),
...
static const struct LevelUpMove sGlameowLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(20, MOVE_PH_ATK_WEAK), //MOVE_FURY_SWIPES),
    LEVEL_UP_MOVE(25, MOVE_CHARM),
...
static const struct LevelUpMove sStunkyLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE( 3, MOVE_PH_STATUS), //MOVE_POISON_GAS),
    ...
    LEVEL_UP_MOVE(21, MOVE_BITE),
    LEVEL_UP_MOVE(25, MOVE_SLASH),
    LEVEL_UP_MOVE(27, MOVE_PH_STATUS3), //MOVE_TOXIC),
    LEVEL_UP_MOVE(31, MOVE_PH_BLADE2 + MOVES_PH_TYPE2), //MOVE_NIGHT_SLASH),
    LEVEL_UP_MOVE(33, MOVE_MEMENTO),
    LEVEL_UP_MOVE(37, MOVE_VENOM_DRENCH),
    LEVEL_UP_MOVE(39, MOVE_PH_PRIORITY + MOVES_PH_TYPE2), //MOVE_SUCKER_PUNCH),
...
static const struct LevelUpMove sBronzorLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(21, MOVE_FEINT_ATTACK),
    LEVEL_UP_MOVE(25, MOVE_SAFEGUARD),
    LEVEL_UP_MOVE(29, MOVE_PH_BEAM3 + MOVES_PH_TYPE2), //MOVE_FUTURE_SIGHT),
    LEVEL_UP_MOVE(31, MOVE_METAL_SOUND),
    LEVEL_UP_MOVE(35, MOVE_GYRO_BALL),
    LEVEL_UP_MOVE(39, MOVE_PH_BALL + MOVES_PH_TYPE2), //MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE(41, MOVE_PAYBACK),
...
static const struct LevelUpMove sBronzongLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(42, MOVE_PH_BALL + MOVES_PH_TYPE2), //MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE(46, MOVE_PAYBACK),
...
static const struct LevelUpMove sChatotLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_PH_SPATK_ADJACENT1),
    ...
    LEVEL_UP_MOVE(37, MOVE_PH_ELEMENT_WEAK2), //MOVE_ECHOED_VOICE),
    LEVEL_UP_MOVE(41, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(45, MOVE_UPROAR),
    LEVEL_UP_MOVE(49, MOVE_SYNCHRONOISE),
    LEVEL_UP_MOVE(50, MOVE_FEATHER_DANCE),
    LEVEL_UP_MOVE(57, MOVE_PH_SPATK_ADJACENT1),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSpiritombLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 7, MOVE_PH_SWIFT + MOVES_PH_TYPE2), //MOVE_FEINT_ATTACK),
    LEVEL_UP_MOVE(13, MOVE_HYPNOSIS),
    LEVEL_UP_MOVE(19, MOVE_DREAM_EATER),
    LEVEL_UP_MOVE(25, MOVE_OMINOUS_WIND),
    LEVEL_UP_MOVE(31, MOVE_PH_PRIORITY + MOVES_PH_TYPE2), //MOVE_SUCKER_PUNCH),
...
static const struct LevelUpMove sGibleLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_PH_WEATHER + MOVES_PH_TYPE2), //MOVE_SANDSTORM),
    LEVEL_UP_MOVE(15, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(19, MOVE_PH_ATK_TRAP + MOVES_PH_TYPE2), //MOVE_SAND_TOMB),
    LEVEL_UP_MOVE(25, MOVE_SLASH),
    LEVEL_UP_MOVE(27, MOVE_PH_BLADE), //MOVE_DRAGON_CLAW),
    LEVEL_UP_MOVE(31, MOVE_PH_BODY_2TURN + MOVES_PH_TYPE2), //MOVE_DIG),
    LEVEL_UP_MOVE(37, MOVE_PH_BODY), //MOVE_DRAGON_RUSH),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sGabiteLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(19, MOVE_PH_ATK_TRAP + MOVES_PH_TYPE2), //MOVE_SAND_TOMB),
    LEVEL_UP_MOVE(28, MOVE_SLASH),
    LEVEL_UP_MOVE(33, MOVE_PH_BLADE), //MOVE_DRAGON_CLAW),
    LEVEL_UP_MOVE(40, MOVE_PH_BODY_2TURN + MOVES_PH_TYPE2), //MOVE_DIG),
    LEVEL_UP_MOVE(49, MOVE_PH_BODY), //MOVE_DRAGON_RUSH),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sGarchompLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_DRAGON_RAGE),
    LEVEL_UP_MOVE( 1, MOVE_PH_WEATHER + MOVES_PH_TYPE2), //MOVE_SANDSTORM),
    LEVEL_UP_MOVE( 3, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE( 7, MOVE_DRAGON_RAGE),
    LEVEL_UP_MOVE(13, MOVE_PH_WEATHER + MOVES_PH_TYPE2), //MOVE_SANDSTORM),
    LEVEL_UP_MOVE(15, MOVE_TAKE_DOWN),
    ...
    LEVEL_UP_MOVE(33, MOVE_PH_BLADE), //MOVE_DRAGON_CLAW),
    LEVEL_UP_MOVE(40, MOVE_PH_BODY_2TURN + MOVES_PH_TYPE2), //MOVE_DIG),
    LEVEL_UP_MOVE(55, MOVE_PH_BODY), //MOVE_DRAGON_RUSH),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sRioluLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(11, MOVE_FEINT),
    LEVEL_UP_MOVE(15, MOVE_PH_FIST3), //MOVE_FORCE_PALM),
    LEVEL_UP_MOVE(19, MOVE_COPYCAT),
...
static const struct LevelUpMove sHippopotasLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(19, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(19, MOVE_PH_BODY_2TURN), //MOVE_DIG),
    LEVEL_UP_MOVE(25, MOVE_PH_ATK_TRAP), //MOVE_SAND_TOMB),
    LEVEL_UP_MOVE(31, MOVE_CRUNCH),
    LEVEL_UP_MOVE(37, MOVE_PH_SPATK_ADJACENT2),
...
static const struct LevelUpMove sHippowdonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(25, MOVE_PH_ATK_TRAP), //MOVE_SAND_TOMB),
    LEVEL_UP_MOVE(31, MOVE_CRUNCH),
    LEVEL_UP_MOVE(40, MOVE_PH_SPATK_ADJACENT2),
    LEVEL_UP_MOVE(50, MOVE_DOUBLE_EDGE),
...
static const struct LevelUpMove sSkorupiLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_ATK_WEAK), //MOVE_POISON_STING),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 5, ORIGINAL_TYPE_MOVE(MOVE_PH_HORN + MOVES_PH_TYPE2, TYPE_DARK)), //MOVE_KNOCK_OFF),
    LEVEL_UP_MOVE( 9, MOVE_PIN_MISSILE),
    LEVEL_UP_MOVE(13, MOVE_ACUPRESSURE),
    LEVEL_UP_MOVE(16, MOVE_PURSUIT),
    LEVEL_UP_MOVE(20, MOVE_PH_BITE + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(23, MOVE_PH_BITE), //MOVE_POISON_FANG),
    LEVEL_UP_MOVE(27, MOVE_PH_VARDMG), //MOVE_VENOSHOCK),
    LEVEL_UP_MOVE(30, MOVE_HONE_CLAWS),
    LEVEL_UP_MOVE(34, MOVE_PH_HAZARD), //MOVE_TOXIC_SPIKES),
    LEVEL_UP_MOVE(38, ORIGINAL_TYPE_MOVE(MOVE_PH_BLADE2 + MOVES_PH_TYPE2, TYPE_DARK)), //MOVE_NIGHT_SLASH),
    LEVEL_UP_MOVE(41, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(45, ORIGINAL_TYPE_MOVE(MOVE_PH_BITE2 + MOVES_PH_TYPE2, TYPE_DARK)), //MOVE_CRUNCH),
...
static const struct LevelUpMove sDrapionLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_ATK_WEAK), //MOVE_POISON_STING),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_PH_HORN + MOVES_PH_TYPE2), //MOVE_KNOCK_OFF),
    LEVEL_UP_MOVE( 5, MOVE_PH_HORN + MOVES_PH_TYPE2), //MOVE_KNOCK_OFF),
    LEVEL_UP_MOVE( 9, MOVE_PIN_MISSILE),
    LEVEL_UP_MOVE(13, MOVE_ACUPRESSURE),
    LEVEL_UP_MOVE(16, MOVE_PURSUIT),
    LEVEL_UP_MOVE(20, ORIGINAL_TYPE_MOVE(MOVE_PH_BITE + MOVES_PH_TYPE2, TYPE_BUG)), //MOVE_BUG_BITE
    LEVEL_UP_MOVE(23, MOVE_PH_BITE), //MOVE_POISON_FANG),
    LEVEL_UP_MOVE(27, MOVE_PH_VARDMG), //MOVE_VENOSHOCK),
    LEVEL_UP_MOVE(30, MOVE_HONE_CLAWS),
    LEVEL_UP_MOVE(34, MOVE_PH_HAZARD), //MOVE_TOXIC_SPIKES),
    LEVEL_UP_MOVE(38, MOVE_PH_BLADE2 + MOVES_PH_TYPE2), //MOVE_NIGHT_SLASH),
    LEVEL_UP_MOVE(43, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(49, MOVE_PH_BITE2 + MOVES_PH_TYPE2), //MOVE_CRUNCH),
...
static const struct LevelUpMove sCroagunkLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 8, MOVE_PH_ATK_WEAK), //MOVE_POISON_STING),
    ...
    LEVEL_UP_MOVE(31, MOVE_SUCKER_PUNCH),
    LEVEL_UP_MOVE(36, MOVE_PH_VARDMG), //MOVE_VENOSHOCK),
    LEVEL_UP_MOVE(38, MOVE_NASTY_PLOT),
    LEVEL_UP_MOVE(43, MOVE_PH_FIST), //MOVE_POISON_JAB),
    LEVEL_UP_MOVE(45, MOVE_PH_BEAM2), //MOVE_SLUDGE_BOMB),
...
static const struct LevelUpMove sToxicroakLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(49, MOVE_PH_FIST), //MOVE_POISON_JAB),
    LEVEL_UP_MOVE(54, MOVE_PH_BEAM2), //MOVE_SLUDGE_BOMB),
...
static const struct LevelUpMove sCarnivineLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(31, MOVE_PH_STRONGWIND), //MOVE_LEAF_TORNADO),
...
static const struct LevelUpMove sFinneonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 6, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE(10, MOVE_ATTRACT),
    LEVEL_UP_MOVE(13, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
    LEVEL_UP_MOVE(17, MOVE_GUST),
    LEVEL_UP_MOVE(22, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(26, MOVE_CAPTIVATE),
    LEVEL_UP_MOVE(29, MOVE_SAFEGUARD),
    LEVEL_UP_MOVE(33, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(38, MOVE_PH_HAZARD),
...
static const struct LevelUpMove sLumineonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(26, MOVE_CAPTIVATE),
    LEVEL_UP_MOVE(29, MOVE_SAFEGUARD),
    LEVEL_UP_MOVE(35, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(42, MOVE_PH_HAZARD),
...
static const struct LevelUpMove sSnoverLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_POWDER_SNOW),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 5, MOVE_PH_SPATK_ADJACENT1), //MOVE_RAZOR_LEAF),
    ...
    LEVEL_UP_MOVE(41, MOVE_PH_SPATK_ADJACENT2 + MOVES_PH_TYPE2), //MOVE_BLIZZARD),
    LEVEL_UP_MOVE(46, MOVE_SHEER_COLD),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sAbomasnowLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(31, MOVE_INGRAIN),
    LEVEL_UP_MOVE(36, MOVE_WOOD_HAMMER),
    LEVEL_UP_MOVE(47, MOVE_PH_SPATK_ADJACENT2 + MOVES_PH_TYPE2), //MOVE_BLIZZARD),
...
static const struct LevelUpMove sWeavileLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(28, MOVE_FLING),
    LEVEL_UP_MOVE(32, MOVE_SCREECH),
    LEVEL_UP_MOVE(35, MOVE_PH_BLADE2), //MOVE_NIGHT_SLASH),
    LEVEL_UP_MOVE(40, MOVE_SNATCH),
    LEVEL_UP_MOVE(44, MOVE_PUNISHMENT),
...
static const struct LevelUpMove sLickilickyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(25, MOVE_DISABLE),
    LEVEL_UP_MOVE(29, MOVE_SLAM),
    LEVEL_UP_MOVE(33, ORIGINAL_TYPE_MOVE(MOVE_PH_ELEMENT_WEAK, TYPE_DARK)), //MOVE_ROLLOUT),
    LEVEL_UP_MOVE(37, MOVE_PH_BLADE2), //MOVE_CHIP_AWAY),
    LEVEL_UP_MOVE(41, MOVE_ME_FIRST),
    LEVEL_UP_MOVE(45, MOVE_REFRESH),
    LEVEL_UP_MOVE(49, MOVE_SCREECH),
...
static const struct LevelUpMove sLeafeonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(33, MOVE_PH_RECOVER), //MOVE_SYNTHESIS),
    LEVEL_UP_MOVE(37, MOVE_PH_WEATHER), //MOVE_SUNNY_DAY),
    LEVEL_UP_MOVE(41, MOVE_LAST_RESORT),
    LEVEL_UP_MOVE(45, MOVE_PH_BLADE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sGalladeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(31, MOVE_PH_BLADE2), //MOVE_PSYCHO_CUT),
    LEVEL_UP_MOVE(35, MOVE_HELPING_HAND),
    LEVEL_UP_MOVE(40, MOVE_FEINT),
    LEVEL_UP_MOVE(44, MOVE_FALSE_SWIPE),
    LEVEL_UP_MOVE(49, MOVE_PROTECT),
    LEVEL_UP_MOVE(53, MOVE_PH_BODY_RECOIL + MOVES_PH_TYPE2), //MOVE_CLOSE_COMBAT),
    LEVEL_UP_MOVE(58, MOVE_STORED_POWER),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sProbopassLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(25, MOVE_PH_ELEMENT_STRONG), //MOVE_POWER_GEM),
    LEVEL_UP_MOVE(28, MOVE_PH_ATK_WEAK), //MOVE_ROCK_BLAST),
    LEVEL_UP_MOVE(31, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2), //MOVE_DISCHARGE),
    LEVEL_UP_MOVE(34, MOVE_PH_WEATHER), //MOVE_SANDSTORM),
    LEVEL_UP_MOVE(37, MOVE_EARTH_POWER),
    LEVEL_UP_MOVE(40, MOVE_PH_HORN), //MOVE_STONE_EDGE),
    LEVEL_UP_MOVE(43, MOVE_LOCK_ON),
...
static const struct LevelUpMove sFroslassLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(41, MOVE_CAPTIVATE),
    LEVEL_UP_MOVE(42, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_SHADOW_BALL),
    LEVEL_UP_MOVE(48, MOVE_PH_SPATK_ADJACENT2), //MOVE_BLIZZARD),
    LEVEL_UP_MOVE(54, MOVE_HAIL),
...
static const struct LevelUpMove sRotomLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(43, MOVE_PH_VARDMG), //MOVE_ELECTRO_BALL),
    LEVEL_UP_MOVE(50, MOVE_HEX),
    LEVEL_UP_MOVE(57, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(64, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISCHARGE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sUxieLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(21, MOVE_SWIFT),
    LEVEL_UP_MOVE(31, ORIGINAL_TYPE_MOVE(MOVE_PH_STATUS2, TYPE_NORMAL)), //MOVE_YAWN),
    LEVEL_UP_MOVE(36, MOVE_PH_BEAM3), //MOVE_FUTURE_SIGHT),
    LEVEL_UP_MOVE(46, MOVE_AMNESIA),
    LEVEL_UP_MOVE(50, MOVE_PH_BALL), //MOVE_EXTRASENSORY),
...
static const struct LevelUpMove sDialgaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(28, MOVE_PH_BLADE + MOVES_PH_TYPE2), //MOVE_DRAGON_CLAW),
    LEVEL_UP_MOVE(33, MOVE_EARTH_POWER),
    LEVEL_UP_MOVE(37, MOVE_AURA_SPHERE),
    LEVEL_UP_MOVE(42, MOVE_PH_TAIL), //MOVE_IRON_TAIL),
    LEVEL_UP_MOVE(46, MOVE_ROAR_OF_TIME),
    LEVEL_UP_MOVE(50, MOVE_PH_BEAM2), //MOVE_FLASH_CANNON),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sPalkiaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(33, MOVE_EARTH_POWER),
    LEVEL_UP_MOVE(37, MOVE_AURA_SPHERE),
    LEVEL_UP_MOVE(42, MOVE_PH_TAIL), //MOVE_AQUA_TAIL),
...
static const struct LevelUpMove sHeatranLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_HEAT_WAVE),
    LEVEL_UP_MOVE( 1, MOVE_EARTH_POWER),
    LEVEL_UP_MOVE( 1, MOVE_PH_HEAD + MOVES_PH_TYPE2), //MOVE_IRON_HEAD),
    LEVEL_UP_MOVE( 1, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE( 1, MOVE_ANCIENT_POWER),
    LEVEL_UP_MOVE( 9, MOVE_LEER),
    LEVEL_UP_MOVE(17, MOVE_PH_BITE), //MOVE_FIRE_FANG),
    LEVEL_UP_MOVE(25, MOVE_METAL_SOUND),
    LEVEL_UP_MOVE(33, MOVE_CRUNCH),
    LEVEL_UP_MOVE(41, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(49, MOVE_PH_ELEMENT_STRONG2), //MOVE_LAVA_PLUME),
    LEVEL_UP_MOVE(57, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(65, MOVE_PH_HEAD + MOVES_PH_TYPE2), //MOVE_IRON_HEAD),
...
static const struct LevelUpMove sCresseliaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_BLADE2), //MOVE_PSYCHO_CUT),
    ...
    LEVEL_UP_MOVE(29, MOVE_AURORA_BEAM),
    LEVEL_UP_MOVE(38, MOVE_PH_BEAM3), //MOVE_FUTURE_SIGHT),
    LEVEL_UP_MOVE(47, MOVE_SLASH),
    LEVEL_UP_MOVE(57, MOVE_MOONLIGHT),
    LEVEL_UP_MOVE(66, MOVE_PH_BLADE2), //MOVE_PSYCHO_CUT),
    LEVEL_UP_MOVE(75, MOVE_PSYCHO_SHIFT),
    LEVEL_UP_MOVE(84, MOVE_LUNAR_DANCE),
    LEVEL_UP_MOVE(93, MOVE_PH_BEAM2), //MOVE_PSYCHIC),
...
static const struct LevelUpMove sPhioneLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(39, MOVE_PH_HAZARD),
    LEVEL_UP_MOVE(46, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(54, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(61, MOVE_PH_BODY_2TURN), //MOVE_DIVE),
    LEVEL_UP_MOVE(69, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sDarkraiLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(29, MOVE_PH_SWIFT), //MOVE_FEINT_ATTACK),
...
static const struct LevelUpMove sShayminLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(46, MOVE_NATURAL_GIFT),
    LEVEL_UP_MOVE(55, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE(64, MOVE_AROMATHERAPY),
    LEVEL_UP_MOVE(73, MOVE_PH_BALL),
...
static const struct LevelUpMove sArceusLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(30, MOVE_PH_SPATK_ADJACENT1),
...
static const struct LevelUpMove sVictiniLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(17, MOVE_HEADBUTT),
    LEVEL_UP_MOVE(25, MOVE_PH_PRIORITY + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(33, MOVE_REVERSAL),
    LEVEL_UP_MOVE(41, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(49, MOVE_ZEN_HEADBUTT),
    LEVEL_UP_MOVE(57, MOVE_INFERNO),
    LEVEL_UP_MOVE(65, MOVE_DOUBLE_EDGE),
    LEVEL_UP_MOVE(73, MOVE_PH_BODY + MOVES_PH_TYPE2),
...
static const struct LevelUpMove sSnivyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(16, MOVE_PH_STRONGWIND), //MOVE_LEAF_TORNADO),
    LEVEL_UP_MOVE(19, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(22, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(25, MOVE_SLAM),
    LEVEL_UP_MOVE(28, MOVE_PH_BLADE),
...
static const struct LevelUpMove sServineLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_GROWTH),
    LEVEL_UP_MOVE(16, MOVE_PH_STRONGWIND), //MOVE_LEAF_TORNADO),
    LEVEL_UP_MOVE(20, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(24, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(28, MOVE_SLAM),
    LEVEL_UP_MOVE(32, MOVE_PH_BLADE),
    LEVEL_UP_MOVE(36, MOVE_COIL),
    LEVEL_UP_MOVE(40, MOVE_PH_BEAM2),
    LEVEL_UP_MOVE(44, MOVE_WRING_OUT),
...
static const struct LevelUpMove sSerperiorLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(44, MOVE_PH_BEAM2),
    LEVEL_UP_MOVE(50, MOVE_WRING_OUT),
    LEVEL_UP_MOVE(56, MOVE_GASTRO_ACID),
    LEVEL_UP_MOVE(62, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sTepigLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_DEFENSE_CURL),
    LEVEL_UP_MOVE(15, MOVE_PH_PRIORITY),
    ...
    LEVEL_UP_MOVE(33, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(37, MOVE_HEAD_SMASH),
    LEVEL_UP_MOVE(39, MOVE_ROAR),
    LEVEL_UP_MOVE(43, MOVE_PH_BODY),
    LEVEL_UP_END
};

static const struct LevelUpMove sPigniteLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_FIST2 + MOVES_PH_TYPE2), //MOVE_ARM_THRUST),
    LEVEL_UP_MOVE( 1, MOVE_PH_FIST2 + MOVES_PH_TYPE2), //MOVE_ARM_THRUST),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK),
    ...
    LEVEL_UP_MOVE(39, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(44, MOVE_HEAD_SMASH),
    LEVEL_UP_MOVE(47, MOVE_ROAR),
    LEVEL_UP_MOVE(52, MOVE_PH_BODY),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sOshawottLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(11, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE(13, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE(17, MOVE_PH_HORN), //MOVE_RAZOR_SHELL),
    LEVEL_UP_MOVE(19, MOVE_FURY_CUTTER),
    LEVEL_UP_MOVE(23, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(25, MOVE_REVENGE),
    LEVEL_UP_MOVE(29, MOVE_PH_PRIORITY), //MOVE_AQUA_JET),
    LEVEL_UP_MOVE(31, MOVE_ENCORE),
    LEVEL_UP_MOVE(35, MOVE_PH_TAIL), //MOVE_AQUA_TAIL),
...
static const struct LevelUpMove sDewottLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(11, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE(13, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE(18, MOVE_PH_HORN), //MOVE_RAZOR_SHELL),
    LEVEL_UP_MOVE(21, MOVE_FURY_CUTTER),
    LEVEL_UP_MOVE(26, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(29, MOVE_REVENGE),
    LEVEL_UP_MOVE(34, MOVE_PH_PRIORITY), //MOVE_AQUA_JET),
...
static const struct LevelUpMove sLillipupLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(12, MOVE_HELPING_HAND),
    LEVEL_UP_MOVE(15, MOVE_PH_BODY_RECOIL), //MOVE_TAKE_DOWN),
...
static const struct LevelUpMove sPurrloinLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(10, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE(12, ORIGINAL_TYPE_MOVE(MOVE_PH_ATK_WEAK, TYPE_NORMAL)), //MOVE_FURY_SWIPES),
    LEVEL_UP_MOVE(15, MOVE_PURSUIT),
    ...
    LEVEL_UP_MOVE(37, MOVE_PH_BLADE2), //MOVE_NIGHT_SLASH),
    LEVEL_UP_MOVE(39, MOVE_SNATCH),
    LEVEL_UP_MOVE(42, MOVE_NASTY_PLOT),
    LEVEL_UP_MOVE(46, MOVE_PH_PRIORITY), //MOVE_SUCKER_PUNCH),
...
static const struct LevelUpMove sLiepardLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(34, MOVE_SLASH),
    LEVEL_UP_MOVE(38, MOVE_TAUNT),
    LEVEL_UP_MOVE(43, MOVE_PH_BLADE2), //MOVE_NIGHT_SLASH),
...
static const struct LevelUpMove sPansearLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_FURY_SWIPES),
    LEVEL_UP_MOVE(16, ORIGINAL_TYPE_MOVE(MOVE_PH_STATUS2, TYPE_NORMAL)), //MOVE_YAWN),
    LEVEL_UP_MOVE(19, MOVE_BITE),
    LEVEL_UP_MOVE(22, MOVE_PH_SPATK_ADJACENT1),
    LEVEL_UP_MOVE(25, MOVE_AMNESIA),
    LEVEL_UP_MOVE(28, MOVE_FLING),
    LEVEL_UP_MOVE(31, MOVE_ACROBATICS),
    LEVEL_UP_MOVE(34, MOVE_PH_BEAM4), //MOVE_FIRE_BLAST),
    LEVEL_UP_MOVE(37, MOVE_RECYCLE),
    LEVEL_UP_MOVE(40, MOVE_NATURAL_GIFT),
    LEVEL_UP_MOVE(43, MOVE_CRUNCH),
    LEVEL_UP_END
...
static const struct LevelUpMove sMunnaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 7, ORIGINAL_TYPE_MOVE(MOVE_PH_STATUS2, TYPE_NORMAL)), //MOVE_YAWN),
    LEVEL_UP_MOVE(11, MOVE_PH_BEAM1), //MOVE_PSYBEAM),
    ...
    LEVEL_UP_MOVE(31, MOVE_PH_BEAM3), //MOVE_FUTURE_SIGHT),
...
static const struct LevelUpMove sPidoveLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 4, MOVE_GROWL),
    LEVEL_UP_MOVE( 8, MOVE_LEER),
    LEVEL_UP_MOVE(11, MOVE_PH_PRIORITY), //MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE(15, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(18, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(22, MOVE_DETECT),
    LEVEL_UP_MOVE(25, MOVE_TAUNT),
    LEVEL_UP_MOVE(29, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
...
static const struct LevelUpMove sTranquillLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(32, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
...
static const struct LevelUpMove sBlitzleLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(15, MOVE_PH_STATUS3), //MOVE_THUNDER_WAVE),
    LEVEL_UP_MOVE(18, MOVE_FLAME_CHARGE),
    LEVEL_UP_MOVE(22, MOVE_PURSUIT),
    LEVEL_UP_MOVE(25, MOVE_PH_HEAD), //MOVE_SPARK),
    LEVEL_UP_MOVE(29, MOVE_STOMP),
    LEVEL_UP_MOVE(32, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISCHARGE),
    LEVEL_UP_MOVE(36, MOVE_AGILITY),
    LEVEL_UP_MOVE(39, MOVE_WILD_CHARGE),
...
static const struct LevelUpMove sZebstrikaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(58, MOVE_PH_TYPE_EFF),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sRoggenrolaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(14, MOVE_PH_ATK_WEAK), //MOVE_ROCK_BLAST),
    LEVEL_UP_MOVE(17, MOVE_MUD_SLAP),
    LEVEL_UP_MOVE(20, MOVE_IRON_DEFENSE),
    LEVEL_UP_MOVE(23, MOVE_SMACK_DOWN),
    LEVEL_UP_MOVE(27, MOVE_PH_SPATK_ADJACENT1), //MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE(30, MOVE_PH_HAZARD), //MOVE_STEALTH_ROCK),
    LEVEL_UP_MOVE(33, MOVE_PH_WEATHER), //MOVE_SANDSTORM),
    LEVEL_UP_MOVE(36, MOVE_PH_HORN), //MOVE_STONE_EDGE),
    LEVEL_UP_MOVE(40, MOVE_EXPLOSION),
    LEVEL_UP_END
};

static const struct LevelUpMove sBoldoreLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_ELEMENT_STRONG), //MOVE_POWER_GEM),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_STRONG), //MOVE_POWER_GEM),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_HARDEN),
    LEVEL_UP_MOVE( 1, MOVE_SAND_ATTACK),
    ...
    LEVEL_UP_MOVE(20, MOVE_IRON_DEFENSE),
    LEVEL_UP_MOVE(23, MOVE_SMACK_DOWN),
    LEVEL_UP_MOVE(30, MOVE_PH_SPATK_ADJACENT1), //MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE(36, MOVE_PH_HAZARD), //MOVE_STEALTH_ROCK),
    LEVEL_UP_MOVE(42, MOVE_PH_WEATHER), //MOVE_SANDSTORM),
    LEVEL_UP_MOVE(48, MOVE_PH_HORN), //MOVE_STONE_EDGE),
...
static const struct LevelUpMove sWoobatLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(32, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
    LEVEL_UP_MOVE(36, MOVE_PH_BEAM3), //MOVE_FUTURE_SIGHT),
    LEVEL_UP_MOVE(41, MOVE_PH_BEAM2), //MOVE_PSYCHIC),
    LEVEL_UP_MOVE(47, MOVE_ENDEAVOR),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sDrilburLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 8, MOVE_PH_ELEMENT_WEAK), //MOVE_MUD_SLAP),
    LEVEL_UP_MOVE(12, MOVE_FURY_SWIPES),
...
static const struct LevelUpMove sExcadrillLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(26, MOVE_SLASH),
    LEVEL_UP_MOVE(29, MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE(36, MOVE_PH_SPATK_ADJACENT2),
    LEVEL_UP_MOVE(42, MOVE_SWORDS_DANCE),
    LEVEL_UP_MOVE(49, MOVE_PH_WEATHER), //MOVE_SANDSTORM),
...
static const struct LevelUpMove sAudinoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(49, MOVE_DOUBLE_EDGE),
    LEVEL_UP_MOVE(53, MOVE_PH_SPATK_ADJACENT1),
    LEVEL_UP_MOVE(57, MOVE_LAST_RESORT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sTimburrLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(24, ORIGINAL_TYPE_MOVE(MOVE_PH_BLADE2, TYPE_NORMAL)), //MOVE_CHIP_AWAY),
...
static const struct LevelUpMove sTympoleLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(12, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE(16, MOVE_MUD_SHOT),
    LEVEL_UP_MOVE(20, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(23, MOVE_UPROAR),
    LEVEL_UP_MOVE(27, MOVE_PH_SPATK_ADJACENT1_MUD),
    LEVEL_UP_MOVE(31, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
...
static const struct LevelUpMove sPalpitoadLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 9, MOVE_ROUND),
    LEVEL_UP_MOVE(12, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE(16, MOVE_PH_BEAM1 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(20, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(23, MOVE_UPROAR),
    LEVEL_UP_MOVE(28, MOVE_PH_SPATK_ADJACENT1_MUD),
    LEVEL_UP_MOVE(33, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
...
static const struct LevelUpMove sThrohLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_BIDE),
    LEVEL_UP_MOVE( 1, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE( 5, MOVE_PH_VARDMG), //MOVE_SEISMIC_TOSS),
    LEVEL_UP_MOVE( 9, MOVE_PH_ATK_THROW), //MOVE_VITAL_THROW),
...
static const struct LevelUpMove sSawkLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_BIDE),
    LEVEL_UP_MOVE( 1, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE( 5, MOVE_PH_FEET_MULTIHIT_FIXED),
    LEVEL_UP_MOVE( 9, MOVE_LOW_SWEEP),
    LEVEL_UP_MOVE(13, MOVE_COUNTER),
    LEVEL_UP_MOVE(17, MOVE_PH_BLADE2), //MOVE_KARATE_CHOP),
    LEVEL_UP_MOVE(21, MOVE_BRICK_BREAK),
    LEVEL_UP_MOVE(25, MOVE_BULK_UP),
    LEVEL_UP_MOVE(29, MOVE_RETALIATE),
    LEVEL_UP_MOVE(33, MOVE_ENDURE),
    LEVEL_UP_MOVE(37, MOVE_QUICK_GUARD),
    LEVEL_UP_MOVE(41, MOVE_PH_BODY_RECOIL), //MOVE_CLOSE_COMBAT),
    LEVEL_UP_MOVE(45, MOVE_REVERSAL),
    LEVEL_UP_END
};

static const struct LevelUpMove sSewaddleLevelUpLearnset[] = {  // BUG, GRASS
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_STRING_SHOT),
    LEVEL_UP_MOVE( 8, MOVE_PH_BITE),
    LEVEL_UP_MOVE(15, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2), //MOVE_RAZOR_LEAF),
    LEVEL_UP_MOVE(22, MOVE_STRUGGLE_BUG),
    LEVEL_UP_MOVE(29, MOVE_ENDURE),
    LEVEL_UP_MOVE(31, MOVE_STICKY_WEB),
    LEVEL_UP_MOVE(36, MOVE_PH_BEAM3),
    LEVEL_UP_MOVE(43, MOVE_FLAIL),
    LEVEL_UP_END
};

static const struct LevelUpMove sSwadloonLevelUpLearnset[] = {  // BUG, GRASS
    LEVEL_UP_MOVE( 0, MOVE_PROTECT),
    LEVEL_UP_MOVE( 1, MOVE_PROTECT),
    ...
    LEVEL_UP_MOVE( 1, MOVE_STRING_SHOT),
    LEVEL_UP_MOVE( 1, MOVE_PH_BITE),
    LEVEL_UP_MOVE( 1, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2), //MOVE_RAZOR_LEAF),
    LEVEL_UP_END
};

static const struct LevelUpMove sLeavannyLevelUpLearnset[] = {  // BUG, GRASS
    LEVEL_UP_MOVE( 0, MOVE_SLASH),
    LEVEL_UP_MOVE( 1, MOVE_SLASH),
    ...
    LEVEL_UP_MOVE(36, MOVE_PH_BLADE + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(39, MOVE_PH_BLADE), //MOVE_X_SCISSOR),
    LEVEL_UP_MOVE(43, MOVE_ENTRAINMENT),
    LEVEL_UP_MOVE(46, MOVE_SWORDS_DANCE),
    LEVEL_UP_MOVE(50, MOVE_PH_BEAM3 + MOVES_PH_TYPE2),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sVenipedeLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_DEFENSE_CURL),
    LEVEL_UP_MOVE( 1, MOVE_ROLLOUT),
    LEVEL_UP_MOVE( 5, MOVE_PH_ATK_WEAK + MOVES_PH_TYPE2), //MOVE_POISON_STING),
    LEVEL_UP_MOVE( 8, MOVE_SCREECH),
    LEVEL_UP_MOVE(12, MOVE_PURSUIT),
    LEVEL_UP_MOVE(15, MOVE_PROTECT),
    LEVEL_UP_MOVE(19, MOVE_PH_TAIL + MOVES_PH_TYPE2), //MOVE_POISON_TAIL),
    LEVEL_UP_MOVE(22, MOVE_PH_BITE),
    LEVEL_UP_MOVE(26, MOVE_PH_VARDMG + MOVES_PH_TYPE2), //MOVE_VENOSHOCK),
    LEVEL_UP_MOVE(29, MOVE_AGILITY),
    LEVEL_UP_MOVE(33, MOVE_STEAMROLLER),
    LEVEL_UP_MOVE(36, MOVE_PH_STATUS3 + MOVES_PH_TYPE2), //MOVE_TOXIC),
...
static const struct LevelUpMove sWhirlipedeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(15, MOVE_PROTECT),
    LEVEL_UP_MOVE(19, MOVE_PH_TAIL + MOVES_PH_TYPE2), //MOVE_POISON_TAIL),
    LEVEL_UP_MOVE(23, MOVE_PH_BITE),
    LEVEL_UP_MOVE(28, MOVE_PH_VARDMG + MOVES_PH_TYPE2), //MOVE_VENOSHOCK),
    LEVEL_UP_MOVE(32, MOVE_AGILITY),
    LEVEL_UP_MOVE(37, MOVE_STEAMROLLER),
    LEVEL_UP_MOVE(41, MOVE_PH_STATUS3 + MOVES_PH_TYPE2), //MOVE_TOXIC),
...
static const struct LevelUpMove sScolipedeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(44, MOVE_PH_STATUS3 + MOVES_PH_TYPE2), //MOVE_TOXIC),
    LEVEL_UP_MOVE(47, MOVE_VENOM_DRENCH),
    LEVEL_UP_MOVE(50, MOVE_ROCK_CLIMB),
    LEVEL_UP_MOVE(55, MOVE_DOUBLE_EDGE),
    LEVEL_UP_MOVE(65, MOVE_PH_HORN),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sCottoneeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(35, MOVE_PH_BALL),
    LEVEL_UP_MOVE(37, MOVE_COTTON_GUARD),
    LEVEL_UP_MOVE(40, MOVE_PH_WEATHER), //MOVE_SUNNY_DAY),
    LEVEL_UP_MOVE(44, MOVE_ENDEAVOR),
    LEVEL_UP_MOVE(46, MOVE_PH_BEAM4),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sPetililLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(17, MOVE_PH_RECOVER), //MOVE_SYNTHESIS),
    LEVEL_UP_MOVE(19, MOVE_MAGICAL_LEAF),
...
static const struct LevelUpMove sBasculinLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 7, MOVE_BITE),
    LEVEL_UP_MOVE( 9, MOVE_PH_PRIORITY), //MOVE_AQUA_JET),
...
static const struct LevelUpMove sSandileLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_PH_ATK_TRAP), //MOVE_SAND_TOMB),
    LEVEL_UP_MOVE(16, MOVE_ASSURANCE),
    LEVEL_UP_MOVE(19, MOVE_PH_ELEMENT_WEAK), //MOVE_MUD_SLAP),
    LEVEL_UP_MOVE(22, MOVE_EMBARGO),
    LEVEL_UP_MOVE(25, MOVE_SWAGGER),
    LEVEL_UP_MOVE(28, MOVE_PH_BITE2 + MOVES_PH_TYPE2), //MOVE_CRUNCH),
    LEVEL_UP_MOVE(31, MOVE_PH_BODY_2TURN), //MOVE_DIG),
...
static const struct LevelUpMove sKrokorokLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(25, MOVE_SWAGGER),
    LEVEL_UP_MOVE(28, MOVE_PH_BITE2 + MOVES_PH_TYPE2), //MOVE_CRUNCH),
    LEVEL_UP_MOVE(32, MOVE_PH_BODY_2TURN), //MOVE_DIG),
    LEVEL_UP_MOVE(36, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(40, MOVE_FOUL_PLAY),
    LEVEL_UP_MOVE(44, MOVE_PH_WEATHER), //MOVE_SANDSTORM),
    LEVEL_UP_MOVE(48, MOVE_PH_SPATK_ADJACENT2),
...
static const struct LevelUpMove sKrookodileLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(48, MOVE_PH_WEATHER), //MOVE_SANDSTORM),
    LEVEL_UP_MOVE(54, MOVE_PH_SPATK_ADJACENT2),
...
static const struct LevelUpMove sMaractusLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(15, MOVE_PH_RECOVER), //MOVE_SYNTHESIS),
    ...
    LEVEL_UP_MOVE(45, MOVE_PH_WEATHER), //MOVE_SUNNY_DAY),
    LEVEL_UP_MOVE(48, MOVE_PETAL_BLIZZARD),
    LEVEL_UP_MOVE(50, MOVE_PH_BEAM4),
...
static const struct LevelUpMove sDwebbleLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_FURY_CUTTER),
    LEVEL_UP_MOVE( 5, MOVE_PH_ATK_WEAK + MOVES_PH_TYPE2), //MOVE_ROCK_BLAST),
    LEVEL_UP_MOVE( 7, MOVE_WITHDRAW),
    ...
    LEVEL_UP_MOVE(19, MOVE_ROCK_POLISH),
    LEVEL_UP_MOVE(23, MOVE_PH_BITE),
    LEVEL_UP_MOVE(24, MOVE_PH_HAZARD + MOVES_PH_TYPE2), //MOVE_STEALTH_ROCK),
    LEVEL_UP_MOVE(29, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2), //MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE(31, MOVE_SLASH),
    LEVEL_UP_MOVE(35, MOVE_PH_BLADE), //MOVE_X_SCISSOR),
...
static const struct LevelUpMove sCrustleLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SHELL_SMASH),
    LEVEL_UP_MOVE( 1, MOVE_PH_ATK_WEAK + MOVES_PH_TYPE2), //MOVE_ROCK_BLAST),
    LEVEL_UP_MOVE( 1, MOVE_WITHDRAW),
    LEVEL_UP_MOVE( 1, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE( 5, MOVE_PH_ATK_WEAK + MOVES_PH_TYPE2), //MOVE_ROCK_BLAST),
    LEVEL_UP_MOVE( 7, MOVE_WITHDRAW),
    ...
    LEVEL_UP_MOVE(29, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2), //MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE(31, MOVE_SLASH),
    LEVEL_UP_MOVE(38, MOVE_PH_BLADE), //MOVE_X_SCISSOR),
...
static const struct LevelUpMove sScraggyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_HEADBUTT),
    LEVEL_UP_MOVE( 5, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE( 9, MOVE_PH_SWIFT), //MOVE_FEINT_ATTACK),
    ...
    LEVEL_UP_MOVE(27, ORIGINAL_TYPE_MOVE(MOVE_PH_BLADE2 + MOVES_PH_TYPE2, TYPE_NORMAL)), //MOVE_CHIP_AWAY),
    LEVEL_UP_MOVE(31, MOVE_HIGH_JUMP_KICK),
    LEVEL_UP_MOVE(34, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(38, MOVE_PH_BITE2), //MOVE_CRUNCH),
...
static const struct LevelUpMove sScraftyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_HEADBUTT),
    LEVEL_UP_MOVE( 1, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_PH_SWIFT), //MOVE_FEINT_ATTACK),
    LEVEL_UP_MOVE( 5, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE( 9, MOVE_PH_SWIFT), //MOVE_FEINT_ATTACK),
    LEVEL_UP_MOVE(12, MOVE_SWAGGER),
    LEVEL_UP_MOVE(16, MOVE_LOW_KICK),
...
static const struct LevelUpMove sSigilyphLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(18, MOVE_PH_BEAM1), //MOVE_PSYBEAM),
    LEVEL_UP_MOVE(21, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2),
...
static const struct LevelUpMove sYamaskLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(37, MOVE_PH_BEAM2), //MOVE_SHADOW_BALL),
...
static const struct LevelUpMove sCofagrigusLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(33, MOVE_POWER_SPLIT),
    LEVEL_UP_MOVE(33, MOVE_GUARD_SPLIT),
    LEVEL_UP_MOVE(39, MOVE_PH_BEAM2), //MOVE_SHADOW_BALL),
...
static const struct LevelUpMove sTirtougaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_WITHDRAW),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 5, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2), //MOVE_ROLLOUT),
    LEVEL_UP_MOVE( 8, MOVE_BITE),
    LEVEL_UP_MOVE(11, MOVE_PROTECT),
    LEVEL_UP_MOVE(15, MOVE_PH_PRIORITY), //MOVE_AQUA_JET),
    LEVEL_UP_MOVE(18, MOVE_ANCIENT_POWER),
    ...
    LEVEL_UP_MOVE(41, MOVE_PH_TAIL), //MOVE_AQUA_TAIL),
    LEVEL_UP_MOVE(45, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2), //MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE(48, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
    LEVEL_UP_MOVE(50, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sCarracostaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(45, MOVE_PH_TAIL), //MOVE_AQUA_TAIL),
    LEVEL_UP_MOVE(51, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2), //MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE(56, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
    LEVEL_UP_MOVE(61, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sArchenLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_WING_ATTACK),
    LEVEL_UP_MOVE( 5, MOVE_PH_ATK_THROW), //MOVE_ROCK_THROW),
    ...
    LEVEL_UP_MOVE(45, MOVE_PH_SPATK_ADJACENT1), //MOVE_ROCK_SLIDE),
...
static const struct LevelUpMove sArcheopsLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(51, MOVE_PH_SPATK_ADJACENT1), //MOVE_ROCK_SLIDE),
...
static const struct LevelUpMove sTrubbishLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 7, MOVE_PH_HAZARD), //MOVE_TOXIC_SPIKES),
    ...
    LEVEL_UP_MOVE(36, MOVE_PH_STATUS3), //MOVE_TOXIC),
    LEVEL_UP_MOVE(40, MOVE_AMNESIA),
    LEVEL_UP_MOVE(42, MOVE_BELCH),
...
static const struct LevelUpMove sGarbodorLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_STATUS), //MOVE_POISON_GAS),
    LEVEL_UP_MOVE( 1, MOVE_RECYCLE),
    LEVEL_UP_MOVE( 1, MOVE_PH_HAZARD), //MOVE_TOXIC_SPIKES),
    LEVEL_UP_MOVE( 3, MOVE_RECYCLE),
    LEVEL_UP_MOVE( 7, MOVE_PH_HAZARD), //MOVE_TOXIC_SPIKES),
    LEVEL_UP_MOVE(12, MOVE_ACID_SPRAY),
    LEVEL_UP_MOVE(14, MOVE_DOUBLE_SLAP),
    ...
    LEVEL_UP_MOVE(29, MOVE_PH_BEAM2), //MOVE_SLUDGE_BOMB),
    LEVEL_UP_MOVE(34, MOVE_CLEAR_SMOG),
    LEVEL_UP_MOVE(39, MOVE_PH_STATUS3), //MOVE_TOXIC),
    LEVEL_UP_MOVE(46, MOVE_AMNESIA),
    LEVEL_UP_MOVE(49, MOVE_BELCH),
...
static const struct LevelUpMove sZoruaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_FURY_SWIPES),
    LEVEL_UP_MOVE(17, MOVE_PH_SWIFT), //MOVE_FEINT_ATTACK),
    LEVEL_UP_MOVE(21, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(25, MOVE_TAUNT),
...
static const struct LevelUpMove sZoroarkLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_BLADE2), //MOVE_NIGHT_SLASH),
    LEVEL_UP_MOVE( 1, MOVE_PH_BLADE2), //MOVE_NIGHT_SLASH),
...
static const struct LevelUpMove sDucklettLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 3, MOVE_PH_TYPE_EFF),
    ...
    LEVEL_UP_MOVE(24, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(27, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
    LEVEL_UP_MOVE(30, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(34, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
    LEVEL_UP_MOVE(37, MOVE_TAILWIND),
    LEVEL_UP_MOVE(41, MOVE_PH_BODY_RECOIL + MOVES_PH_TYPE2), //MOVE_BRAVE_BIRD),
    LEVEL_UP_MOVE(46, MOVE_PH_BEAM4 + MOVES_PH_TYPE2), //MOVE_HURRICANE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSwannaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(47, MOVE_PH_BODY_RECOIL + MOVES_PH_TYPE2), //MOVE_BRAVE_BIRD),
    LEVEL_UP_MOVE(55, MOVE_PH_BEAM4 + MOVES_PH_TYPE2), //MOVE_HURRICANE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sVanilliteLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(31, MOVE_ACID_ARMOR),
    LEVEL_UP_MOVE(35, MOVE_PH_BEAM2), //MOVE_ICE_BEAM),
...
static const struct LevelUpMove sVanillishLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(26, MOVE_MIRROR_SHOT),
    LEVEL_UP_MOVE(31, MOVE_ACID_ARMOR),
    LEVEL_UP_MOVE(36, MOVE_PH_BEAM2), //MOVE_ICE_BEAM),
    LEVEL_UP_MOVE(42, MOVE_HAIL),
    LEVEL_UP_MOVE(47, MOVE_MIRROR_COAT),
    LEVEL_UP_MOVE(53, MOVE_PH_SPATK_ADJACENT2), //MOVE_BLIZZARD),
    LEVEL_UP_MOVE(58, MOVE_SHEER_COLD),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sVanilluxeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(59, MOVE_PH_SPATK_ADJACENT2), //MOVE_BLIZZARD),
...
static const struct LevelUpMove sDeerlingLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(16, MOVE_FEINT_ATTACK),
    LEVEL_UP_MOVE(20, MOVE_PH_BODY_RECOIL), //MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(24, MOVE_JUMP_KICK),
    LEVEL_UP_MOVE(28, MOVE_AROMATHERAPY),
    LEVEL_UP_MOVE(32, MOVE_PH_BALL + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(36, MOVE_CHARM),
    LEVEL_UP_MOVE(41, MOVE_NATURE_POWER),
    LEVEL_UP_MOVE(46, MOVE_DOUBLE_EDGE),
    LEVEL_UP_MOVE(51, MOVE_PH_BEAM4 + MOVES_PH_TYPE2),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSawsbuckLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(60, MOVE_PH_BEAM4 + MOVES_PH_TYPE2),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sEmolgaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(10, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(13, MOVE_PH_HEAD), //MOVE_SPARK),
    LEVEL_UP_MOVE(15, MOVE_PH_ATK_WEAK), //MOVE_NUZZLE),
    LEVEL_UP_MOVE(16, MOVE_PURSUIT),
    LEVEL_UP_MOVE(19, MOVE_DOUBLE_TEAM),
    LEVEL_UP_MOVE(22, MOVE_SHOCK_WAVE),
    LEVEL_UP_MOVE(26, MOVE_PH_VARDMG), //MOVE_ELECTRO_BALL),
...
static const struct LevelUpMove sKarrablastLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(28, MOVE_PH_BEAM3),
    LEVEL_UP_MOVE(32, MOVE_SLASH),
    LEVEL_UP_MOVE(37, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(40, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(44, MOVE_PH_BLADE), //MOVE_X_SCISSOR),
...
static const struct LevelUpMove sEscavalierLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(28, MOVE_PH_BEAM3),
    LEVEL_UP_MOVE(32, MOVE_SLASH),
    LEVEL_UP_MOVE(37, MOVE_PH_HEAD + MOVES_PH_TYPE2), //MOVE_IRON_HEAD),
...
static const struct LevelUpMove sFoongusLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(28, MOVE_PH_BEAM2),
    LEVEL_UP_MOVE(32, MOVE_PH_STATUS3 + MOVES_PH_TYPE2), //MOVE_TOXIC),
    LEVEL_UP_MOVE(35, MOVE_PH_RECOVER), //MOVE_SYNTHESIS),
...
static const struct LevelUpMove sAmoongussLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(49, MOVE_PH_BEAM4),
...
static const struct LevelUpMove sFrillishLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(32, MOVE_PH_VARDMG), //MOVE_BRINE),
    LEVEL_UP_MOVE(37, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
    LEVEL_UP_MOVE(43, MOVE_HEX),
    LEVEL_UP_MOVE(49, MOVE_PH_BEAM3),
    LEVEL_UP_MOVE(55, MOVE_WRING_OUT),
    LEVEL_UP_MOVE(61, MOVE_PH_SPATK_ADJACENT2), //MOVE_WATER_SPOUT),
    LEVEL_UP_END
};

static const struct LevelUpMove sJellicentLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_PH_SPATK_ADJACENT2), //MOVE_WATER_SPOUT),
    LEVEL_UP_MOVE( 1, MOVE_WRING_OUT),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK2),
    LEVEL_UP_MOVE( 1, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE( 1, MOVE_ABSORB),
    ...
    LEVEL_UP_MOVE(53, MOVE_PH_BEAM3),
    LEVEL_UP_MOVE(61, MOVE_WRING_OUT),
    LEVEL_UP_MOVE(69, MOVE_PH_SPATK_ADJACENT2), //MOVE_WATER_SPOUT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sAlomomolaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_POUND),
    LEVEL_UP_MOVE( 1, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE( 5, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE( 9, MOVE_PH_PRIORITY), //MOVE_AQUA_JET),
    LEVEL_UP_MOVE(13, MOVE_DOUBLE_SLAP),
    ...
    LEVEL_UP_MOVE(41, MOVE_PH_VARDMG), //MOVE_BRINE),
    LEVEL_UP_MOVE(45, MOVE_SAFEGUARD),
    LEVEL_UP_MOVE(49, MOVE_PH_HAZARD),
    LEVEL_UP_MOVE(53, MOVE_HELPING_HAND),
    LEVEL_UP_MOVE(57, MOVE_HEALING_WISH),
    LEVEL_UP_MOVE(61, MOVE_WIDE_GUARD),
    LEVEL_UP_MOVE(65, MOVE_PH_BEAM3),
    LEVEL_UP_END
};

static const struct LevelUpMove sJoltikLevelUpLearnset[] = {    // BUG, ELECTRIC
    LEVEL_UP_MOVE( 1, MOVE_STRING_SHOT),
    LEVEL_UP_MOVE( 1, MOVE_ABSORB),
    LEVEL_UP_MOVE( 1, MOVE_SPIDER_WEB),
    LEVEL_UP_MOVE( 4, MOVE_PH_STATUS3 + MOVES_PH_TYPE2), //MOVE_THUNDER_WAVE),
    LEVEL_UP_MOVE( 7, MOVE_SCREECH),
    LEVEL_UP_MOVE(12, MOVE_FURY_CUTTER),
    LEVEL_UP_MOVE(15, MOVE_ELECTROWEB),
    LEVEL_UP_MOVE(18, MOVE_PH_BITE),
    LEVEL_UP_MOVE(23, MOVE_GASTRO_ACID),
    LEVEL_UP_MOVE(26, MOVE_SLASH),
    LEVEL_UP_MOVE(29, MOVE_PH_VARDMG + MOVES_PH_TYPE2), //MOVE_ELECTRO_BALL),
    LEVEL_UP_MOVE(34, MOVE_SIGNAL_BEAM),
    LEVEL_UP_MOVE(37, MOVE_AGILITY),
    LEVEL_UP_MOVE(40, MOVE_SUCKER_PUNCH),
    LEVEL_UP_MOVE(45, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2), //MOVE_DISCHARGE),
    LEVEL_UP_MOVE(48, MOVE_PH_BEAM3),
    LEVEL_UP_END
};

static const struct LevelUpMove sGalvantulaLevelUpLearnset[] = {    // BUG, ELECTRIC
    ...
    LEVEL_UP_MOVE(46, MOVE_SUCKER_PUNCH),
    LEVEL_UP_MOVE(54, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2), //MOVE_DISCHARGE),
    LEVEL_UP_MOVE(60, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sFerroseedLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(43, MOVE_PH_HEAD + MOVES_PH_TYPE2), //MOVE_IRON_HEAD),
...
static const struct LevelUpMove sFerrothornLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(35, MOVE_INGRAIN),
    LEVEL_UP_MOVE(38, MOVE_SELF_DESTRUCT),
    LEVEL_UP_MOVE(46, MOVE_PH_HEAD + MOVES_PH_TYPE2), //MOVE_IRON_HEAD),
    LEVEL_UP_MOVE(53, MOVE_PAYBACK),
    LEVEL_UP_MOVE(61, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_FLASH_CANNON),
...
static const struct LevelUpMove sKlinkLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(39, MOVE_SCREECH),
    LEVEL_UP_MOVE(42, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISCHARGE),
    LEVEL_UP_MOVE(45, MOVE_METAL_SOUND),
...
static const struct LevelUpMove sKlangLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(36, MOVE_MIRROR_SHOT),
    LEVEL_UP_MOVE(40, MOVE_SCREECH),
    LEVEL_UP_MOVE(44, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISCHARGE),
...
static const struct LevelUpMove sTynamoLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_PH_STATUS3), //MOVE_THUNDER_WAVE),
    LEVEL_UP_MOVE( 1, MOVE_PH_HEAD), //MOVE_SPARK),
    LEVEL_UP_MOVE( 1, MOVE_CHARGE_BEAM),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sEelektrikLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(29, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISCHARGE),
    LEVEL_UP_MOVE(44, MOVE_PH_ELEMENT_STRONG), //MOVE_THUNDERBOLT),
...
static const struct LevelUpMove sElgyemLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(11, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE(15, MOVE_PH_BEAM1), //MOVE_PSYBEAM),
...
static const struct LevelUpMove sLitwickLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 7, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    ...
    LEVEL_UP_MOVE(43, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(49, MOVE_PH_BEAM2), //MOVE_SHADOW_BALL),
...
static const struct LevelUpMove sLampentLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(33, MOVE_MEMENTO),
    LEVEL_UP_MOVE(38, MOVE_INFERNO),
    LEVEL_UP_MOVE(45, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(53, MOVE_PH_BEAM2), //MOVE_SHADOW_BALL),
...
static const struct LevelUpMove sChandelureLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_SMOG),
    LEVEL_UP_MOVE( 1, MOVE_CONFUSE_RAY),
    LEVEL_UP_MOVE( 1, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2),
...
static const struct LevelUpMove sAxewLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(28, MOVE_PH_BLADE), //MOVE_DRAGON_CLAW),
    LEVEL_UP_MOVE(32, MOVE_DRAGON_DANCE),
    LEVEL_UP_MOVE(36, MOVE_TAUNT),
    LEVEL_UP_MOVE(41, MOVE_PH_BEAM2), //MOVE_DRAGON_PULSE),
    LEVEL_UP_MOVE(46, MOVE_SWORDS_DANCE),
    LEVEL_UP_MOVE(50, MOVE_GUILLOTINE),
    LEVEL_UP_MOVE(56, MOVE_PH_THRASH), //MOVE_OUTRAGE),
...
static const struct LevelUpMove sFraxureLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(32, MOVE_DRAGON_DANCE),
    LEVEL_UP_MOVE(36, MOVE_TAUNT),
    LEVEL_UP_MOVE(42, MOVE_PH_BEAM2), //MOVE_DRAGON_PULSE),
    LEVEL_UP_MOVE(48, MOVE_SWORDS_DANCE),
    LEVEL_UP_MOVE(54, MOVE_GUILLOTINE),
    LEVEL_UP_MOVE(60, MOVE_PH_THRASH), //MOVE_OUTRAGE),
    LEVEL_UP_MOVE(66, MOVE_GIGA_IMPACT),
    LEVEL_UP_END
};

static const struct LevelUpMove sHaxorusLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_PH_THRASH), //MOVE_OUTRAGE),
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_ASSURANCE),
    LEVEL_UP_MOVE( 1, MOVE_DRAGON_RAGE),
    ...
    LEVEL_UP_MOVE(66, MOVE_PH_THRASH), //MOVE_OUTRAGE),
...
static const struct LevelUpMove sCryogonalLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 9, MOVE_HAZE),
    LEVEL_UP_MOVE(13, MOVE_PH_BEAM1), //MOVE_AURORA_BEAM),
    LEVEL_UP_MOVE(17, MOVE_ACID_ARMOR),
    LEVEL_UP_MOVE(21, MOVE_ANCIENT_POWER),
    LEVEL_UP_MOVE(25, MOVE_PH_BEAM2), //MOVE_ICE_BEAM),
    LEVEL_UP_MOVE(29, MOVE_LIGHT_SCREEN),
...
static const struct LevelUpMove sShelmetLevelUpLearnset[] = {   // BUG
    LEVEL_UP_MOVE( 1, MOVE_ABSORB),
    ...
    LEVEL_UP_MOVE(25, ORIGINAL_TYPE_MOVE(MOVE_PH_STATUS2, TYPE_NORMAL)), //MOVE_YAWN),
    LEVEL_UP_MOVE(28, MOVE_PROTECT),
...
static const struct LevelUpMove sAccelgorLevelUpLearnset[] = {  // BUG
...
static const struct LevelUpMove sStunfiskLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(21, MOVE_PH_BALL),
    LEVEL_UP_MOVE(25, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2), //MOVE_DISCHARGE),
    LEVEL_UP_MOVE(30, MOVE_ENDURE),
    LEVEL_UP_MOVE(35, MOVE_BOUNCE),
    LEVEL_UP_MOVE(40, MOVE_MUDDY_WATER),
    LEVEL_UP_MOVE(45, MOVE_PH_ELEMENT_STRONG + MOVES_PH_TYPE2), //MOVE_THUNDERBOLT),
...
static const struct LevelUpMove sMienfooLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(29, MOVE_PH_FIST3), //MOVE_FORCE_PALM),
...
static const struct LevelUpMove sDruddigonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(45, MOVE_PH_TAIL), //MOVE_DRAGON_TAIL),
    LEVEL_UP_MOVE(49, MOVE_ROCK_CLIMB),
    LEVEL_UP_MOVE(55, MOVE_SUPERPOWER),
    LEVEL_UP_MOVE(62, MOVE_PH_THRASH), //MOVE_OUTRAGE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sGolettLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(45, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(50, MOVE_PH_SPATK_ADJACENT2),
...
static const struct LevelUpMove sGolurkLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(35, MOVE_DYNAMIC_PUNCH),
    LEVEL_UP_MOVE(40, MOVE_NIGHT_SHADE),
    LEVEL_UP_MOVE(47, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(54, MOVE_PH_SPATK_ADJACENT2),
    LEVEL_UP_MOVE(61, MOVE_HAMMER_ARM),
    LEVEL_UP_MOVE(69, MOVE_FOCUS_PUNCH),
    LEVEL_UP_MOVE(76, MOVE_PH_BODY_2TURN + MOVES_PH_TYPE2), //MOVE_PHANTOM_FORCE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sPawniardLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(49, MOVE_PH_BLADE2), //MOVE_NIGHT_SLASH),
    LEVEL_UP_MOVE(54, MOVE_PH_HEAD + MOVES_PH_TYPE2), //MOVE_IRON_HEAD),
    LEVEL_UP_MOVE(57, MOVE_SWORDS_DANCE),
...
static const struct LevelUpMove sBisharpLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(46, MOVE_IRON_DEFENSE),
    LEVEL_UP_MOVE(49, MOVE_PH_BLADE2), //MOVE_NIGHT_SLASH),
    LEVEL_UP_MOVE(57, MOVE_PH_HEAD + MOVES_PH_TYPE2), //MOVE_IRON_HEAD),
...
static const struct LevelUpMove sRuffletLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(19, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(23, MOVE_PH_BLADE + MOVES_PH_TYPE2), //MOVE_AERIAL_ACE),
    LEVEL_UP_MOVE(28, MOVE_SLASH),
    ...
    LEVEL_UP_MOVE(59, MOVE_PH_BODY_RECOIL + MOVES_PH_TYPE2), //MOVE_BRAVE_BIRD),
...
static const struct LevelUpMove sBraviaryLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(63, MOVE_PH_BODY_RECOIL + MOVES_PH_TYPE2), //MOVE_BRAVE_BIRD),
...
static const struct LevelUpMove sVullabyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(23, MOVE_PH_SWIFT), //MOVE_FEINT_ATTACK),
...
static const struct LevelUpMove sDurantLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(16, MOVE_PH_BITE),
    LEVEL_UP_MOVE(21, MOVE_CRUNCH),
    LEVEL_UP_MOVE(26, MOVE_PH_HEAD + MOVES_PH_TYPE2), //MOVE_IRON_HEAD),
...
static const struct LevelUpMove sDeinoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(17, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_DRAGON_BREATH),
    LEVEL_UP_MOVE(20, MOVE_ROAR),
    LEVEL_UP_MOVE(25, MOVE_PH_BITE2), //MOVE_CRUNCH),
    LEVEL_UP_MOVE(28, MOVE_SLAM),
    LEVEL_UP_MOVE(32, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_DRAGON_PULSE),
    LEVEL_UP_MOVE(38, MOVE_WORK_UP),
    LEVEL_UP_MOVE(42, MOVE_PH_BODY + MOVES_PH_TYPE2), //MOVE_DRAGON_RUSH),
    LEVEL_UP_MOVE(48, MOVE_BODY_SLAM),
    LEVEL_UP_MOVE(50, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(58, MOVE_HYPER_VOICE),
    LEVEL_UP_MOVE(62, MOVE_PH_THRASH + MOVES_PH_TYPE2), //MOVE_OUTRAGE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sZweilousLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(71, MOVE_PH_THRASH + MOVES_PH_TYPE2), //MOVE_OUTRAGE),
    LEVEL_UP_END
};

static const struct LevelUpMove sHydreigonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_PH_THRASH + MOVES_PH_TYPE2), //MOVE_OUTRAGE),
    ...
    LEVEL_UP_MOVE(79, MOVE_PH_THRASH + MOVES_PH_TYPE2), //MOVE_OUTRAGE),
    LEVEL_UP_END
};

static const struct LevelUpMove sLarvestaLevelUpLearnset[] = {  // BUG, FIRE
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 1, MOVE_STRING_SHOT),
    LEVEL_UP_MOVE(10, MOVE_ABSORB),
    LEVEL_UP_MOVE(20, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(30, MOVE_PH_PRIORITY + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(40, MOVE_PH_BITE),
    LEVEL_UP_MOVE(50, MOVE_DOUBLE_EDGE),
    LEVEL_UP_MOVE(60, MOVE_PH_HEAD + MOVES_PH_TYPE2), //MOVE_FLAME_WHEEL),
    LEVEL_UP_MOVE(70, MOVE_PH_BEAM3),
    LEVEL_UP_MOVE(80, MOVE_AMNESIA),
    LEVEL_UP_MOVE(90, MOVE_THRASH),
    LEVEL_UP_MOVE(100, MOVE_PH_BODY + MOVES_PH_TYPE2),
    LEVEL_UP_END
};

static const struct LevelUpMove sVolcaronaLevelUpLearnset[] = { // BUG, FIRE
    LEVEL_UP_MOVE( 0, MOVE_QUIVER_DANCE),
    LEVEL_UP_MOVE( 1, MOVE_QUIVER_DANCE),
    ...
    LEVEL_UP_MOVE( 1, MOVE_HEAT_WAVE),
    LEVEL_UP_MOVE( 1, MOVE_PH_BODY + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 1, MOVE_THRASH),
    LEVEL_UP_MOVE( 1, MOVE_AMNESIA),
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM3),
    LEVEL_UP_MOVE( 1, MOVE_PH_HEAD + MOVES_PH_TYPE2), //MOVE_FLAME_WHEEL),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 1, MOVE_STRING_SHOT),
    LEVEL_UP_MOVE( 1, MOVE_ABSORB),
    LEVEL_UP_MOVE( 1, MOVE_GUST),
...
static const struct LevelUpMove sCobalionLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(25, MOVE_PH_HEAD), //MOVE_IRON_HEAD),
    LEVEL_UP_MOVE(31, MOVE_PH_HORN + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(37, MOVE_SWORDS_DANCE),
    LEVEL_UP_MOVE(42, MOVE_QUICK_GUARD),
    LEVEL_UP_MOVE(49, MOVE_WORK_UP),
    LEVEL_UP_MOVE(55, MOVE_METAL_BURST),
    LEVEL_UP_MOVE(61, MOVE_PH_BODY_RECOIL + MOVES_PH_TYPE2), //MOVE_CLOSE_COMBAT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sTerrakionLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_HELPING_HAND),
    LEVEL_UP_MOVE(19, MOVE_RETALIATE),
    LEVEL_UP_MOVE(25, MOVE_PH_SPATK_ADJACENT1), //MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE(31, MOVE_PH_HORN + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(37, MOVE_SWORDS_DANCE),
    LEVEL_UP_MOVE(42, MOVE_QUICK_GUARD),
    LEVEL_UP_MOVE(49, MOVE_WORK_UP),
    LEVEL_UP_MOVE(55, MOVE_PH_HORN), //MOVE_STONE_EDGE),
    LEVEL_UP_MOVE(61, MOVE_PH_BODY_RECOIL + MOVES_PH_TYPE2), //MOVE_CLOSE_COMBAT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sVirizionLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(42, MOVE_QUICK_GUARD),
    LEVEL_UP_MOVE(49, MOVE_WORK_UP),
    LEVEL_UP_MOVE(55, MOVE_PH_BLADE),
    LEVEL_UP_MOVE(61, MOVE_PH_BODY_RECOIL + MOVES_PH_TYPE2), //MOVE_CLOSE_COMBAT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sTornadusLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_THRASH),
    LEVEL_UP_MOVE( 1, MOVE_HAMMER_ARM),
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM4), //MOVE_HURRICANE),
    LEVEL_UP_MOVE( 1, MOVE_UPROAR),
    LEVEL_UP_MOVE( 1, MOVE_ASTONISH),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 1, MOVE_SWAGGER),
    ...
    LEVEL_UP_MOVE(31, MOVE_AGILITY),
    LEVEL_UP_MOVE(37, MOVE_PH_BEAM1), //MOVE_AIR_SLASH),
    LEVEL_UP_MOVE(43, MOVE_CRUNCH),
    LEVEL_UP_MOVE(49, MOVE_TAILWIND),
    LEVEL_UP_MOVE(55, MOVE_RAIN_DANCE),
    LEVEL_UP_MOVE(61, MOVE_PH_BEAM4), //MOVE_HURRICANE),
...
static const struct LevelUpMove sThundurusLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(37, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISCHARGE),
    LEVEL_UP_MOVE(43, MOVE_CRUNCH),
    LEVEL_UP_MOVE(49, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(55, MOVE_NASTY_PLOT),
    LEVEL_UP_MOVE(61, MOVE_PH_BEAM4), //MOVE_THUNDER),
    LEVEL_UP_MOVE(67, MOVE_DARK_PULSE),
    LEVEL_UP_MOVE(73, MOVE_HAMMER_ARM),
    LEVEL_UP_MOVE(79, MOVE_THRASH),
    LEVEL_UP_END
...
static const struct LevelUpMove sReshiramLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_PH_BITE + MOVES_PH_TYPE2), //MOVE_FIRE_FANG),
    LEVEL_UP_MOVE( 1, MOVE_DRAGON_RAGE),
    LEVEL_UP_MOVE( 8, MOVE_IMPRISON),
    LEVEL_UP_MOVE(15, MOVE_ANCIENT_POWER),
    LEVEL_UP_MOVE(22, MOVE_PH_BEAM1 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(29, MOVE_PH_BEAM1), //MOVE_DRAGON_BREATH),
    LEVEL_UP_MOVE(36, MOVE_SLASH),
    LEVEL_UP_MOVE(43, MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE(50, MOVE_FUSION_FLARE),
    LEVEL_UP_MOVE(54, MOVE_PH_BEAM2), //MOVE_DRAGON_PULSE),
    LEVEL_UP_MOVE(64, MOVE_NOBLE_ROAR),
    LEVEL_UP_MOVE(71, MOVE_CRUNCH),
    LEVEL_UP_MOVE(78, MOVE_PH_BEAM4 + MOVES_PH_TYPE2), //MOVE_FIRE_BLAST),
    LEVEL_UP_MOVE(85, MOVE_PH_THRASH), //MOVE_OUTRAGE),
...
static const struct LevelUpMove sZekromLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 8, MOVE_IMPRISON),
    LEVEL_UP_MOVE(15, MOVE_ANCIENT_POWER),
    LEVEL_UP_MOVE(22, MOVE_PH_ELEMENT_STRONG + MOVES_PH_TYPE2), //MOVE_THUNDERBOLT),
    LEVEL_UP_MOVE(29, MOVE_PH_BEAM1), //MOVE_DRAGON_BREATH),
    LEVEL_UP_MOVE(36, MOVE_SLASH),
    LEVEL_UP_MOVE(43, MOVE_ZEN_HEADBUTT),
    LEVEL_UP_MOVE(50, MOVE_FUSION_BOLT),
    LEVEL_UP_MOVE(54, MOVE_PH_BLADE), //MOVE_DRAGON_CLAW),
    LEVEL_UP_MOVE(64, MOVE_NOBLE_ROAR),
    LEVEL_UP_MOVE(71, MOVE_CRUNCH),
    LEVEL_UP_MOVE(78, MOVE_PH_BEAM4 + MOVES_PH_TYPE2), //MOVE_THUNDER),
    LEVEL_UP_MOVE(85, MOVE_PH_THRASH), //MOVE_OUTRAGE),
    LEVEL_UP_MOVE(92, MOVE_HYPER_VOICE),
...
static const struct LevelUpMove sLandorusLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_PH_PRIORITY), //MOVE_BULLDOZE),
    LEVEL_UP_MOVE(19, MOVE_ROCK_THROW),
    LEVEL_UP_MOVE(25, MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE(31, MOVE_SWORDS_DANCE),
    LEVEL_UP_MOVE(37, MOVE_PH_ELEMENT_STRONG), //MOVE_EARTH_POWER),
    LEVEL_UP_MOVE(43, MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE(49, MOVE_PH_SPATK_ADJACENT2),
    LEVEL_UP_MOVE(55, MOVE_PH_WEATHER), //MOVE_SANDSTORM),
    LEVEL_UP_MOVE(61, MOVE_FISSURE),
...
static const struct LevelUpMove sKyuremLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 8, MOVE_IMPRISON),
    LEVEL_UP_MOVE(15, MOVE_ANCIENT_POWER),
    LEVEL_UP_MOVE(22, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_ICE_BEAM),
    LEVEL_UP_MOVE(29, MOVE_PH_BEAM1), //MOVE_DRAGON_BREATH),
    LEVEL_UP_MOVE(36, MOVE_SLASH),
    LEVEL_UP_MOVE(43, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(50, MOVE_GLACIATE),
    LEVEL_UP_MOVE(57, MOVE_PH_BEAM2), //MOVE_DRAGON_PULSE),
    LEVEL_UP_MOVE(64, MOVE_NOBLE_ROAR),
    LEVEL_UP_MOVE(71, MOVE_ENDEAVOR),
    LEVEL_UP_MOVE(78, MOVE_PH_SPATK_ADJACENT2 + MOVES_PH_TYPE2), //MOVE_BLIZZARD),
    LEVEL_UP_MOVE(85, MOVE_PH_THRASH), //MOVE_OUTRAGE),
    LEVEL_UP_MOVE(92, MOVE_HYPER_VOICE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sKeldeoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_FEET_MULTIHIT_FIXED + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE( 7, MOVE_PH_FEET_MULTIHIT_FIXED + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(13, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE(19, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(25, MOVE_HELPING_HAND),
    LEVEL_UP_MOVE(31, MOVE_RETALIATE),
    LEVEL_UP_MOVE(37, MOVE_PH_TAIL), //MOVE_AQUA_TAIL),
    LEVEL_UP_MOVE(43, MOVE_PH_HORN + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(49, MOVE_SWORDS_DANCE),
    LEVEL_UP_MOVE(55, MOVE_QUICK_GUARD),
    LEVEL_UP_MOVE(61, MOVE_WORK_UP),
    LEVEL_UP_MOVE(67, MOVE_PH_BEAM3),
    LEVEL_UP_MOVE(73, MOVE_PH_BODY_RECOIL + MOVES_PH_TYPE2), //MOVE_CLOSE_COMBAT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMeloettaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 1, MOVE_SING),
    LEVEL_UP_MOVE( 6, MOVE_PH_PRIORITY), //MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE(11, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(16, MOVE_SING),
    LEVEL_UP_MOVE(21, MOVE_TEETER_DANCE),
    LEVEL_UP_MOVE(26, MOVE_ACROBATICS),
    LEVEL_UP_MOVE(31, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_PSYBEAM),
    LEVEL_UP_MOVE(36, MOVE_PH_ELEMENT_WEAK2), //MOVE_ECHOED_VOICE),
    LEVEL_UP_MOVE(43, MOVE_U_TURN),
    LEVEL_UP_MOVE(50, MOVE_WAKE_UP_SLAP),
    LEVEL_UP_MOVE(57, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_PSYCHIC),
    LEVEL_UP_MOVE(64, MOVE_HYPER_VOICE),
...
static const struct LevelUpMove sGenesectLevelUpLearnset[] = {  // BUG, STEEL
    LEVEL_UP_MOVE( 1, MOVE_FELL_STINGER),
    ...
    LEVEL_UP_MOVE(51, MOVE_PH_BLADE), //MOVE_X_SCISSOR),
    LEVEL_UP_MOVE(55, MOVE_PH_BEAM3),
...
static const struct LevelUpMove sFennekinLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 5, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE(11, MOVE_HOWL),
    LEVEL_UP_MOVE(14, MOVE_PH_PRIORITY),
    LEVEL_UP_MOVE(17, ORIGINAL_TYPE_MOVE(MOVE_PH_BEAM1 + MOVES_PH_TYPE2, TYPE_PSYCHIC)), //MOVE_PSYBEAM),
    LEVEL_UP_MOVE(20, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(25, MOVE_LUCKY_CHANT),
    LEVEL_UP_MOVE(27, MOVE_LIGHT_SCREEN),
    LEVEL_UP_MOVE(31, MOVE_PSYSHOCK),
    LEVEL_UP_MOVE(35, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(38, MOVE_WILL_O_WISP),
    LEVEL_UP_MOVE(41, ORIGINAL_TYPE_MOVE(MOVE_PH_BEAM2 + MOVES_PH_TYPE2, TYPE_PSYCHIC)), //MOVE_PSYCHIC),
    LEVEL_UP_MOVE(43, MOVE_PH_WEATHER), //MOVE_SUNNY_DAY),
    LEVEL_UP_MOVE(46, MOVE_MAGIC_ROOM),
    LEVEL_UP_MOVE(48, MOVE_PH_BEAM4), //MOVE_FIRE_BLAST),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sBraixenLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(11, MOVE_HOWL),
    LEVEL_UP_MOVE(14, MOVE_PH_PRIORITY),
    LEVEL_UP_MOVE(18, ORIGINAL_TYPE_MOVE(MOVE_PH_BEAM1 + MOVES_PH_TYPE2, TYPE_PSYCHIC)), //MOVE_PSYBEAM),
    LEVEL_UP_MOVE(22, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(28, MOVE_LUCKY_CHANT),
    LEVEL_UP_MOVE(31, MOVE_LIGHT_SCREEN),
    LEVEL_UP_MOVE(36, MOVE_PSYSHOCK),
    LEVEL_UP_MOVE(41, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(45, MOVE_WILL_O_WISP),
    LEVEL_UP_MOVE(49, ORIGINAL_TYPE_MOVE(MOVE_PH_BEAM2 + MOVES_PH_TYPE2, TYPE_PSYCHIC)), //MOVE_PSYCHIC),
    LEVEL_UP_MOVE(52, MOVE_PH_WEATHER), //MOVE_SUNNY_DAY),
    LEVEL_UP_MOVE(56, MOVE_MAGIC_ROOM),
    LEVEL_UP_MOVE(59, MOVE_PH_BEAM4), //MOVE_FIRE_BLAST),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sDelphoxLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_MYSTICAL_FIRE),
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM3 + MOVES_PH_TYPE2), //MOVE_FUTURE_SIGHT),
    ...
    LEVEL_UP_MOVE(11, MOVE_HOWL),
    LEVEL_UP_MOVE(14, MOVE_PH_PRIORITY),
    LEVEL_UP_MOVE(18, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_PSYBEAM),
    LEVEL_UP_MOVE(22, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(28, MOVE_LUCKY_CHANT),
    LEVEL_UP_MOVE(31, MOVE_LIGHT_SCREEN),
    LEVEL_UP_MOVE(38, MOVE_PSYSHOCK),
    LEVEL_UP_MOVE(45, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(51, MOVE_WILL_O_WISP),
    LEVEL_UP_MOVE(57, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_PSYCHIC),
    LEVEL_UP_MOVE(62, MOVE_PH_WEATHER), //MOVE_SUNNY_DAY),
    LEVEL_UP_MOVE(68, MOVE_MAGIC_ROOM),
    LEVEL_UP_MOVE(74, MOVE_PH_BEAM4), //MOVE_FIRE_BLAST),
    LEVEL_UP_MOVE(80, MOVE_PH_BEAM3 + MOVES_PH_TYPE2), //MOVE_FUTURE_SIGHT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sFroakieLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_POUND),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 5, MOVE_PH_ELEMENT_WEAK2),
    LEVEL_UP_MOVE( 8, MOVE_QUICK_ATTACK),
...
static const struct LevelUpMove sFrogadierLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(56, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sGreninjaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(28, MOVE_SPIKES),
    LEVEL_UP_MOVE(33, MOVE_PH_SWIFT + MOVES_PH_TYPE2), //MOVE_FEINT_ATTACK),
    LEVEL_UP_MOVE(42, MOVE_SUBSTITUTE),
    LEVEL_UP_MOVE(49, MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE(56, MOVE_DOUBLE_TEAM),
    LEVEL_UP_MOVE(68, MOVE_PH_BEAM3),
    LEVEL_UP_MOVE(70, MOVE_HAZE),
    LEVEL_UP_MOVE(77, MOVE_PH_BLADE2 + MOVES_PH_TYPE2), //MOVE_NIGHT_SLASH),
    LEVEL_UP_END
};

static const struct LevelUpMove sBunnelbyLevelUpLearnset[] = {  // NORMAL
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_AGILITY),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 7, MOVE_PH_PRIORITY), //MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE(10, MOVE_DOUBLE_SLAP),
    LEVEL_UP_MOVE(13, ORIGINAL_TYPE_MOVE(MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2, TYPE_GROUND)), //MOVE_MUD_SLAP),
    LEVEL_UP_MOVE(15, MOVE_PH_BODY_RECOIL), //MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(18, MOVE_MUD_SHOT),
    LEVEL_UP_MOVE(20, MOVE_DOUBLE_KICK),
    LEVEL_UP_MOVE(25, MOVE_ODOR_SLEUTH),
    LEVEL_UP_MOVE(29, MOVE_FLAIL),
    LEVEL_UP_MOVE(33, ORIGINAL_TYPE_MOVE(MOVE_PH_BODY_2TURN + MOVES_PH_TYPE2, TYPE_GROUND)), //MOVE_DIG),
    LEVEL_UP_MOVE(38, MOVE_BOUNCE),
    LEVEL_UP_MOVE(42, MOVE_SUPER_FANG),
    LEVEL_UP_MOVE(47, MOVE_FACADE),
    LEVEL_UP_MOVE(49, ORIGINAL_TYPE_MOVE(MOVE_PH_SPATK_ADJACENT2 + MOVES_PH_TYPE2, TYPE_GROUND)),
    LEVEL_UP_END
};

static const struct LevelUpMove sDiggersbyLevelUpLearnset[] = { // NORMAL, GROUND
    LEVEL_UP_MOVE( 1, MOVE_HAMMER_ARM),
    LEVEL_UP_MOVE( 1, MOVE_ROTOTILLER),
    LEVEL_UP_MOVE( 1, MOVE_PH_PRIORITY + MOVES_PH_TYPE2), //MOVE_BULLDOZE),
    LEVEL_UP_MOVE( 1, MOVE_SWORDS_DANCE),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_AGILITY),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 7, MOVE_PH_PRIORITY), //MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE(13, MOVE_DOUBLE_SLAP),
    LEVEL_UP_MOVE(13, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2), //MOVE_MUD_SLAP),
    LEVEL_UP_MOVE(15, MOVE_PH_BODY_RECOIL), //MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(18, MOVE_PH_BEAM1 + MOVES_PH_TYPE2),
    ...
    LEVEL_UP_MOVE(57, MOVE_PH_SPATK_ADJACENT2 + MOVES_PH_TYPE2),
...
static const struct LevelUpMove sFletchlingLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(21, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
...
static const struct LevelUpMove sFletchinderLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_AGILITY),
    LEVEL_UP_MOVE(16, MOVE_FLAIL),
    LEVEL_UP_MOVE(25, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(27, MOVE_RAZOR_WIND),
    LEVEL_UP_MOVE(31, MOVE_NATURAL_GIFT),
    LEVEL_UP_MOVE(38, MOVE_PH_BODY_ATK_SPEED),
...
static const struct LevelUpMove sTalonflameLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(27, MOVE_RAZOR_WIND),
    LEVEL_UP_MOVE(31, MOVE_NATURAL_GIFT),
    LEVEL_UP_MOVE(39, MOVE_PH_BODY_ATK_SPEED),
    ...
    LEVEL_UP_MOVE(64, MOVE_PH_BODY_RECOIL + MOVES_PH_TYPE2), //MOVE_BRAVE_BIRD),
    LEVEL_UP_END
};

static const struct LevelUpMove sScatterbugLevelUpLearnset[] = {    // BUG
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_STRING_SHOT),
    LEVEL_UP_MOVE( 6, MOVE_STUN_SPORE),
    LEVEL_UP_MOVE(15, MOVE_PH_BITE),
...
static const struct LevelUpMove sSpewpaLevelUpLearnset[] = {    // BUG
    LEVEL_UP_MOVE( 0, MOVE_PROTECT),
    LEVEL_UP_MOVE( 1, MOVE_PROTECT),
    LEVEL_UP_MOVE( 1, MOVE_HARDEN),
    LEVEL_UP_END
...
static const struct LevelUpMove sVivillonLevelUpLearnset[] = {  // BUG, FLYING
    LEVEL_UP_MOVE( 0, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    ...
    LEVEL_UP_MOVE(50, MOVE_PH_BEAM4 + MOVES_PH_TYPE2), //MOVE_HURRICANE),
    LEVEL_UP_MOVE(55, MOVE_POWDER),
    LEVEL_UP_END
};

static const struct LevelUpMove sLitleoLevelUpLearnset[] = {    // FIRE, NORMAL
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 5, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 8, MOVE_WORK_UP),
    LEVEL_UP_MOVE(11, MOVE_PH_HEAD + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(15, MOVE_NOBLE_ROAR),
    LEVEL_UP_MOVE(20, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(23, MOVE_PH_BITE), //MOVE_FIRE_FANG),
    LEVEL_UP_MOVE(28, MOVE_ENDEAVOR),
    LEVEL_UP_MOVE(33, MOVE_PH_ELEMENT_WEAK2 + MOVES_PH_TYPE2), //MOVE_ECHOED_VOICE),
    LEVEL_UP_MOVE(36, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(39, MOVE_CRUNCH),
    LEVEL_UP_MOVE(43, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(46, MOVE_INCINERATE),
    LEVEL_UP_MOVE(50, MOVE_OVERHEAT),
    LEVEL_UP_END
};

static const struct LevelUpMove sPyroarLevelUpLearnset[] = {    // FIRE, NORMAL
    LEVEL_UP_MOVE( 1, MOVE_HYPER_BEAM),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK),
    ...
    LEVEL_UP_MOVE(38, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(42, MOVE_CRUNCH),
    LEVEL_UP_MOVE(48, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2),
...
static const struct LevelUpMove sSkiddoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_PH_SPATK_ADJACENT1), //MOVE_RAZOR_LEAF),
    LEVEL_UP_MOVE(16, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE(20, MOVE_PH_RECOVER), //MOVE_SYNTHESIS),
...
static const struct LevelUpMove sPanchamLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(12, MOVE_PH_BLADE2), //MOVE_KARATE_CHOP),
    LEVEL_UP_MOVE(15, MOVE_COMET_PUNCH),
    LEVEL_UP_MOVE(20, MOVE_SLASH),
    LEVEL_UP_MOVE(25, MOVE_CIRCLE_THROW),
    LEVEL_UP_MOVE(27, MOVE_PH_ATK_THROW), //MOVE_VITAL_THROW),
...
static const struct LevelUpMove sPangoroLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(27, MOVE_PH_ATK_THROW), //MOVE_VITAL_THROW),
    LEVEL_UP_MOVE(35, MOVE_BODY_SLAM),
    LEVEL_UP_MOVE(42, MOVE_PH_BITE2 + MOVES_PH_TYPE2), //MOVE_CRUNCH),
...
static const struct LevelUpMove sEspurrLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 9, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE(13, MOVE_LIGHT_SCREEN),
    LEVEL_UP_MOVE(17, MOVE_PH_BEAM1), //MOVE_PSYBEAM),
...
static const struct LevelUpMove sMeowsticLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(40, MOVE_PH_BEAM2), //MOVE_PSYCHIC),
    LEVEL_UP_MOVE(43, MOVE_ROLE_PLAY),
...
static const struct LevelUpMove sHonedgeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(42, MOVE_PH_HEAD), //MOVE_IRON_HEAD),
...
static const struct LevelUpMove sSpritzeeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(50, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISARMING_VOICE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sAromatisseLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(44, MOVE_SKILL_SWAP),
    LEVEL_UP_MOVE(48, MOVE_PSYCHIC),
    LEVEL_UP_MOVE(53, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISARMING_VOICE),
...
static const struct LevelUpMove sSwirlixLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(49, MOVE_PH_BODY), //MOVE_PLAY_ROUGH),
...
static const struct LevelUpMove sInkayLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(18, MOVE_HYPNOSIS),
    LEVEL_UP_MOVE(21, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_PSYBEAM),
    LEVEL_UP_MOVE(23, MOVE_SWITCHEROO),
    LEVEL_UP_MOVE(27, MOVE_PAYBACK),
    LEVEL_UP_MOVE(31, MOVE_LIGHT_SCREEN),
    LEVEL_UP_MOVE(35, MOVE_PLUCK),
    LEVEL_UP_MOVE(39, MOVE_PH_BLADE2 + MOVES_PH_TYPE2), //MOVE_PSYCHO_CUT),
    LEVEL_UP_MOVE(43, MOVE_SLASH),
    LEVEL_UP_MOVE(46, MOVE_PH_BLADE2), //MOVE_NIGHT_SLASH),
    LEVEL_UP_MOVE(48, MOVE_SUPERPOWER),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sBinacleLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE( 4, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 7, MOVE_WITHDRAW),
    ...
    LEVEL_UP_MOVE(45, MOVE_PH_HORN + MOVES_PH_TYPE2), //MOVE_RAZOR_SHELL),
...
static const struct LevelUpMove sBarbaracleLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_HORN), //MOVE_STONE_EDGE),
    LEVEL_UP_MOVE( 1, MOVE_SHELL_SMASH),
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    ...
    LEVEL_UP_MOVE(48, MOVE_PH_HORN + MOVES_PH_TYPE2), //MOVE_RAZOR_SHELL),
...
static const struct LevelUpMove sSkrelpLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 9, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE(12, MOVE_PH_ELEMENT_WEAK2 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(15, MOVE_PH_ELEMENT_WEAK), //MOVE_ACID),
    LEVEL_UP_MOVE(19, MOVE_CAMOUFLAGE),
    LEVEL_UP_MOVE(23, MOVE_PH_TAIL), //MOVE_POISON_TAIL),
    LEVEL_UP_MOVE(25, MOVE_PH_BEAM1 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(28, MOVE_DOUBLE_TEAM),
    LEVEL_UP_MOVE(32, MOVE_PH_STATUS3), //MOVE_TOXIC),
    LEVEL_UP_MOVE(35, MOVE_PH_TAIL + MOVES_PH_TYPE2), //MOVE_AQUA_TAIL),
    LEVEL_UP_MOVE(38, MOVE_PH_BEAM2), //MOVE_SLUDGE_BOMB),
    LEVEL_UP_MOVE(42, MOVE_PH_BEAM3 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(49, ORIGINAL_TYPE_MOVE(MOVE_PH_BEAM2 + MOVES_PH_TYPE2, TYPE_DRAGON)), //MOVE_DRAGON_PULSE),
    LEVEL_UP_END
};

static const struct LevelUpMove sDragalgeLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2), //MOVE_TWISTER),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2), //MOVE_TWISTER),
    LEVEL_UP_MOVE( 1, MOVE_PH_TAIL + MOVES_PH_TYPE2), //MOVE_DRAGON_TAIL),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_SMOKESCREEN),
    LEVEL_UP_MOVE( 1, MOVE_WATER_GUN),
    LEVEL_UP_MOVE( 1, MOVE_FEINT_ATTACK),
    ...
    LEVEL_UP_MOVE(19, MOVE_CAMOUFLAGE),
    LEVEL_UP_MOVE(23, MOVE_PH_TAIL), //MOVE_POISON_TAIL),
    LEVEL_UP_MOVE(25, ORIGINAL_TYPE_MOVE(MOVE_PH_BEAM1 + MOVES_PH_TYPE2, TYPE_WATER)), //MOVE_WATER_PULSE),
    LEVEL_UP_MOVE(28, MOVE_DOUBLE_TEAM),
    LEVEL_UP_MOVE(32, MOVE_PH_STATUS3), //MOVE_TOXIC),
    LEVEL_UP_MOVE(35, ORIGINAL_TYPE_MOVE(MOVE_PH_TAIL + MOVES_PH_TYPE2, TYPE_WATER)), //MOVE_AQUA_TAIL),
    LEVEL_UP_MOVE(38, MOVE_PH_BEAM2), //MOVE_SLUDGE_BOMB),
    LEVEL_UP_MOVE(42, ORIGINAL_TYPE_MOVE(MOVE_PH_BEAM3 + MOVES_PH_TYPE2, TYPE_WATER)), //MOVE_HYDRO_PUMP),
    LEVEL_UP_MOVE(53, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_DRAGON_PULSE),
    LEVEL_UP_MOVE(59, MOVE_PH_TAIL + MOVES_PH_TYPE2), //MOVE_DRAGON_TAIL),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sClauncherLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(12, MOVE_PH_ELEMENT_WEAK2),
    LEVEL_UP_MOVE(16, MOVE_FLAIL),
    LEVEL_UP_MOVE(20, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE(25, MOVE_SWORDS_DANCE),
    ...
    LEVEL_UP_MOVE(43, MOVE_PH_BODY_ATK_SPEED), //MOVE_AQUA_JET),
    LEVEL_UP_MOVE(48, MOVE_PH_SPATK_ADJACENT1_MUD),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sClawitzerLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(49, MOVE_PH_BODY_ATK_SPEED), //MOVE_AQUA_JET),
    LEVEL_UP_MOVE(57, MOVE_PH_SPATK_ADJACENT1_MUD),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sHelioptileLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(11, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(13, MOVE_MUD_SLAP),
    LEVEL_UP_MOVE(17, MOVE_PH_PRIORITY + MOVES_PH_TYPE2), //MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE(22, MOVE_RAZOR_WIND),
    LEVEL_UP_MOVE(25, MOVE_PARABOLIC_CHARGE),
    LEVEL_UP_MOVE(31, MOVE_PH_STATUS3), //MOVE_THUNDER_WAVE),
...
static const struct LevelUpMove sHelioliskLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_PRIORITY + MOVES_PH_TYPE2), //MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM4), //MOVE_THUNDER),
    LEVEL_UP_MOVE( 1, MOVE_PH_HEAL_SAP),
...
static const struct LevelUpMove sTyruntLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(10, MOVE_STOMP),
    LEVEL_UP_MOVE(12, MOVE_BIDE),
    LEVEL_UP_MOVE(15, MOVE_PH_HAZARD), //MOVE_STEALTH_ROCK),
    LEVEL_UP_MOVE(17, MOVE_BITE),
    LEVEL_UP_MOVE(20, MOVE_CHARM),
    LEVEL_UP_MOVE(26, MOVE_ANCIENT_POWER),
    LEVEL_UP_MOVE(30, MOVE_PH_TAIL + MOVES_PH_TYPE2), //MOVE_DRAGON_TAIL),
    LEVEL_UP_MOVE(34, MOVE_CRUNCH),
    LEVEL_UP_MOVE(37, MOVE_PH_BLADE + MOVES_PH_TYPE2), //MOVE_DRAGON_CLAW),
...
static const struct LevelUpMove sTyrantrumLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_SPATK_ADJACENT1), //MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE( 1, MOVE_PH_SPATK_ADJACENT1), //MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE( 1, MOVE_HEAD_SMASH),
    LEVEL_UP_MOVE( 1, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_ROAR),
...
static const struct LevelUpMove sAmauraLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(20, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AURORA_BEAM),
    LEVEL_UP_MOVE(26, MOVE_ANCIENT_POWER),
    ...
    LEVEL_UP_MOVE(50, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_ICE_BEAM),
    LEVEL_UP_MOVE(57, MOVE_HYPER_BEAM),
    LEVEL_UP_MOVE(65, MOVE_PH_SPATK_ADJACENT2 + MOVES_PH_TYPE2), //MOVE_BLIZZARD),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sAurorusLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(50, MOVE_LIGHT_SCREEN),
    LEVEL_UP_MOVE(56, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_ICE_BEAM),
    LEVEL_UP_MOVE(63, MOVE_HYPER_BEAM),
    LEVEL_UP_MOVE(74, MOVE_PH_SPATK_ADJACENT2 + MOVES_PH_TYPE2), //MOVE_BLIZZARD),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSylveonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 9, MOVE_BABY_DOLL_EYES),
    LEVEL_UP_MOVE(13, ORIGINAL_TYPE_MOVE(MOVE_PH_PRIORITY, TYPE_NORMAL)), //MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE(17, ORIGINAL_TYPE_MOVE(MOVE_PH_SWIFT, TYPE_NORMAL)), //MOVE_SWIFT),
...
static const struct LevelUpMove sHawluchaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_HONE_CLAWS),
    LEVEL_UP_MOVE( 4, MOVE_PH_BLADE2), //MOVE_KARATE_CHOP),
    LEVEL_UP_MOVE( 8, MOVE_WING_ATTACK),
    LEVEL_UP_MOVE(12, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(16, MOVE_PH_BLADE + MOVES_PH_TYPE2), //MOVE_AERIAL_ACE),
    LEVEL_UP_MOVE(20, MOVE_ENCORE),
...
static const struct LevelUpMove sDedenneLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(20, MOVE_PH_ATK_WEAK), //MOVE_NUZZLE),
    LEVEL_UP_MOVE(23, MOVE_PH_STATUS3), //MOVE_THUNDER_WAVE),
    LEVEL_UP_MOVE(26, MOVE_VOLT_SWITCH),
    LEVEL_UP_MOVE(30, MOVE_REST),
    LEVEL_UP_MOVE(31, MOVE_SNORE),
    LEVEL_UP_MOVE(34, MOVE_CHARGE_BEAM),
    LEVEL_UP_MOVE(39, MOVE_ENTRAINMENT),
    LEVEL_UP_MOVE(42, MOVE_PH_BODY + MOVES_PH_TYPE2), //MOVE_PLAY_ROUGH),
    LEVEL_UP_MOVE(45, MOVE_PH_BEAM4), //MOVE_THUNDER),
    LEVEL_UP_MOVE(50, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISCHARGE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sCarbinkLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(18, MOVE_REFLECT),
    LEVEL_UP_MOVE(21, MOVE_PH_HAZARD), //MOVE_STEALTH_ROCK),
    LEVEL_UP_MOVE(27, MOVE_GUARD_SPLIT),
    LEVEL_UP_MOVE(31, MOVE_ANCIENT_POWER),
    LEVEL_UP_MOVE(35, MOVE_FLAIL),
    LEVEL_UP_MOVE(40, MOVE_SKILL_SWAP),
    LEVEL_UP_MOVE(46, MOVE_PH_ELEMENT_STRONG), //MOVE_POWER_GEM),
    LEVEL_UP_MOVE(49, MOVE_PH_HORN), //MOVE_STONE_EDGE),
    LEVEL_UP_MOVE(50, MOVE_MOONBLAST),
...
static const struct LevelUpMove sGoomyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(18, MOVE_PH_BEAM1), //MOVE_DRAGON_BREATH),
...
static const struct LevelUpMove sSliggooLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(32, MOVE_BODY_SLAM),
    LEVEL_UP_MOVE(38, MOVE_MUDDY_WATER),
    LEVEL_UP_MOVE(47, MOVE_PH_BEAM2), //MOVE_DRAGON_PULSE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sKlefkiLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(43, MOVE_PH_BODY + MOVES_PH_TYPE2), //MOVE_PLAY_ROUGH),
...
static const struct LevelUpMove sPhantumpLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(19, MOVE_FEINT_ATTACK),
    LEVEL_UP_MOVE(23, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(28, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(31, MOVE_WILL_O_WISP),
    LEVEL_UP_MOVE(35, MOVE_FORESTS_CURSE),
    LEVEL_UP_MOVE(39, MOVE_DESTINY_BOND),
    LEVEL_UP_MOVE(45, MOVE_PH_BODY_2TURN), //MOVE_PHANTOM_FORCE),
...
static const struct LevelUpMove sPumpkabooLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(11, MOVE_PH_TYPE_EFF + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(16, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2), //MOVE_RAZOR_LEAF),
    LEVEL_UP_MOVE(20, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
...
static const struct LevelUpMove sGourgeistLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(42, MOVE_PAIN_SPLIT),
    LEVEL_UP_MOVE(48, MOVE_SEED_BOMB),
    LEVEL_UP_MOVE(57, MOVE_PH_BODY_2TURN), //MOVE_PHANTOM_FORCE),
...
static const struct LevelUpMove sBergmiteLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(39, MOVE_AVALANCHE),
    LEVEL_UP_MOVE(43, MOVE_PH_SPATK_ADJACENT2), //MOVE_BLIZZARD),
    LEVEL_UP_MOVE(47, MOVE_RECOVER),
    LEVEL_UP_MOVE(49, MOVE_DOUBLE_EDGE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sNoibatLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 5, MOVE_ABSORB),
    LEVEL_UP_MOVE(11, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE(13, MOVE_BITE),
    LEVEL_UP_MOVE(16, MOVE_WING_ATTACK),
    LEVEL_UP_MOVE(18, MOVE_AGILITY),
    LEVEL_UP_MOVE(23, MOVE_PH_SPATK_ADJACENT1),
    LEVEL_UP_MOVE(27, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(31, MOVE_RAZOR_WIND),
    LEVEL_UP_MOVE(35, MOVE_TAILWIND),
    LEVEL_UP_MOVE(40, MOVE_WHIRLWIND),
    LEVEL_UP_MOVE(43, MOVE_SUPER_FANG),
    LEVEL_UP_MOVE(48, MOVE_PH_BEAM1), //MOVE_AIR_SLASH),
    LEVEL_UP_MOVE(58, MOVE_PH_BEAM4), //MOVE_HURRICANE),
    LEVEL_UP_END
};

static const struct LevelUpMove sNoivernLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_BOOMBURST),
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_DRAGON_PULSE),
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM4), //MOVE_HURRICANE),
    LEVEL_UP_MOVE( 1, MOVE_MOONLIGHT),
    LEVEL_UP_MOVE( 1, MOVE_SCREECH),
    LEVEL_UP_MOVE( 1, MOVE_SUPERSONIC),
    ...
    LEVEL_UP_MOVE(40, MOVE_WHIRLWIND),
    LEVEL_UP_MOVE(43, MOVE_SUPER_FANG),
    LEVEL_UP_MOVE(53, MOVE_PH_BEAM1), //MOVE_AIR_SLASH),
    LEVEL_UP_MOVE(62, MOVE_PH_BEAM4), //MOVE_HURRICANE),
    LEVEL_UP_MOVE(70, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_DRAGON_PULSE),
...
static const struct LevelUpMove sYveltalLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 5, MOVE_DOUBLE_TEAM),
    LEVEL_UP_MOVE(10, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
    ...
    LEVEL_UP_MOVE(80, MOVE_PH_PRIORITY), //MOVE_SUCKER_PUNCH),
...
static const struct LevelUpMove sZygardeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(10, MOVE_PH_BODY_2TURN + MOVES_PH_TYPE2), //MOVE_DIG),
    LEVEL_UP_MOVE(18, MOVE_BIND),
    LEVEL_UP_MOVE(26, MOVE_LANDS_WRATH),
    LEVEL_UP_MOVE(35, MOVE_PH_WEATHER + MOVES_PH_TYPE2), //MOVE_SANDSTORM),
    LEVEL_UP_MOVE(44, MOVE_HAZE),
    LEVEL_UP_MOVE(51, MOVE_CRUNCH),
    LEVEL_UP_MOVE(55, MOVE_PH_SPATK_ADJACENT2 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(59, MOVE_CAMOUFLAGE),
    LEVEL_UP_MOVE(63, MOVE_PH_BEAM2), //MOVE_DRAGON_PULSE),
...
static const struct LevelUpMove sDiancieLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(12, MOVE_REFLECT),
    LEVEL_UP_MOVE(18, MOVE_PH_HAZARD), //MOVE_STEALTH_ROCK),
    LEVEL_UP_MOVE(21, MOVE_GUARD_SPLIT),
    LEVEL_UP_MOVE(27, MOVE_ANCIENT_POWER),
    LEVEL_UP_MOVE(31, MOVE_FLAIL),
    LEVEL_UP_MOVE(35, MOVE_SKILL_SWAP),
    LEVEL_UP_MOVE(40, MOVE_PH_ELEMENT_STRONG), //MOVE_POWER_GEM),
...
static const struct LevelUpMove sHoopaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(19, MOVE_PH_BEAM1), //MOVE_PSYBEAM),
    LEVEL_UP_MOVE(25, MOVE_SKILL_SWAP),
    LEVEL_UP_MOVE(29, MOVE_POWER_SPLIT),
    LEVEL_UP_MOVE(29, MOVE_GUARD_SPLIT),
    LEVEL_UP_MOVE(35, MOVE_PH_BODY_2TURN + MOVES_PH_TYPE2), //MOVE_PHANTOM_FORCE),
    LEVEL_UP_MOVE(46, MOVE_ZEN_HEADBUTT),
    LEVEL_UP_MOVE(50, MOVE_WONDER_ROOM),
    LEVEL_UP_MOVE(50, MOVE_TRICK_ROOM),
    LEVEL_UP_MOVE(55, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_SHADOW_BALL),
    LEVEL_UP_MOVE(68, MOVE_NASTY_PLOT),
    LEVEL_UP_MOVE(75, MOVE_PH_BEAM2), //MOVE_PSYCHIC),
...
static const struct LevelUpMove sVolcanionLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(11, MOVE_HAZE),
    LEVEL_UP_MOVE(15, MOVE_PH_PRIORITY),
    LEVEL_UP_MOVE(21, MOVE_PH_BEAM1 + MOVES_PH_TYPE2),
...
static const struct LevelUpMove sRowletLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(14, MOVE_PH_SPATK_ADJACENT1), //MOVE_RAZOR_LEAF),
    LEVEL_UP_MOVE(16, MOVE_OMINOUS_WIND),
    LEVEL_UP_MOVE(18, MOVE_FORESIGHT),
    LEVEL_UP_MOVE(22, MOVE_PLUCK),
    LEVEL_UP_MOVE(25, MOVE_PH_RECOVER), //MOVE_SYNTHESIS),
    LEVEL_UP_MOVE(29, MOVE_FURY_ATTACK),
    LEVEL_UP_MOVE(32, MOVE_SUCKER_PUNCH),
    LEVEL_UP_MOVE(36, MOVE_PH_BLADE),
...
static const struct LevelUpMove sDartrixLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(37, MOVE_SUCKER_PUNCH),
    LEVEL_UP_MOVE(42, MOVE_PH_BLADE),
...
static const struct LevelUpMove sDecidueyeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_BODY_2TURN + MOVES_PH_TYPE2), //MOVE_PHANTOM_FORCE),
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM3),
    LEVEL_UP_MOVE( 1, MOVE_U_TURN),
    LEVEL_UP_MOVE( 1, MOVE_SHADOW_SNEAK),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    ...
    LEVEL_UP_MOVE(55, ORIGINAL_TYPE_MOVE(MOVE_PH_BODY_RECOIL + MOVES_PH_TYPE2, TYPE_FLYING)), //MOVE_BRAVE_BIRD),
    LEVEL_UP_MOVE(60, MOVE_NASTY_PLOT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sLittenLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(11, MOVE_LEER),
    LEVEL_UP_MOVE(14, MOVE_PH_BITE), //MOVE_FIRE_FANG),
...
static const struct LevelUpMove sTorracatLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(42, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(46, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(51, MOVE_PH_BODY),
...
static const struct LevelUpMove sIncineroarLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(44, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(49, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(55, MOVE_PH_BODY),
    LEVEL_UP_MOVE(60, MOVE_OUTRAGE),
...
static const struct LevelUpMove sPopplioLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 4, MOVE_GROWL),
    LEVEL_UP_MOVE( 8, ORIGINAL_TYPE_MOVE(MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2, TYPE_FAIRY)), //MOVE_DISARMING_VOICE),
    LEVEL_UP_MOVE(11, MOVE_BABY_DOLL_EYES),
    LEVEL_UP_MOVE(14, MOVE_PH_PRIORITY), //MOVE_AQUA_JET),
    LEVEL_UP_MOVE(16, MOVE_ICY_WIND),
    LEVEL_UP_MOVE(18, MOVE_ENCORE),
    LEVEL_UP_MOVE(22, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
...
static const struct LevelUpMove sBrionneLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2), //MOVE_DISARMING_VOICE),
    LEVEL_UP_MOVE( 4, MOVE_GROWL),
    LEVEL_UP_MOVE( 8, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2), //MOVE_DISARMING_VOICE),
    LEVEL_UP_MOVE(11, MOVE_BABY_DOLL_EYES),
    LEVEL_UP_MOVE(14, MOVE_PH_PRIORITY), //MOVE_AQUA_JET),
    LEVEL_UP_MOVE(16, MOVE_ICY_WIND),
...
static const struct LevelUpMove sPrimarinaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2), //MOVE_DISARMING_VOICE),
    LEVEL_UP_MOVE( 4, MOVE_GROWL),
    LEVEL_UP_MOVE( 9, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2), //MOVE_DISARMING_VOICE),
    LEVEL_UP_MOVE(11, MOVE_BABY_DOLL_EYES),
    LEVEL_UP_MOVE(14, MOVE_PH_PRIORITY), //MOVE_AQUA_JET),
    LEVEL_UP_MOVE(16, MOVE_ICY_WIND),
    LEVEL_UP_MOVE(19, MOVE_ENCORE),
...
static const struct LevelUpMove sPikipekLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_PECK),
    LEVEL_UP_MOVE( 3, MOVE_GROWL),
    LEVEL_UP_MOVE( 7, MOVE_PH_ELEMENT_WEAK), //MOVE_ECHOED_VOICE),
    LEVEL_UP_MOVE( 9, MOVE_ROCK_SMASH),
    LEVEL_UP_MOVE(13, MOVE_SUPERSONIC),
    LEVEL_UP_MOVE(15, MOVE_PLUCK),
    LEVEL_UP_MOVE(19, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    ...
    LEVEL_UP_MOVE(37, MOVE_PH_SPATK_ADJACENT1),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sToucannonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(44, MOVE_FEATHER_DANCE),
    LEVEL_UP_MOVE(50, MOVE_PH_SPATK_ADJACENT1),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sYungoosLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(40, MOVE_PH_STATUS2), //MOVE_YAWN),
    LEVEL_UP_MOVE(43, MOVE_THRASH),
...
static const struct LevelUpMove sGumshoosLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(47, MOVE_PH_STATUS2), //MOVE_YAWN),
    LEVEL_UP_MOVE(51, MOVE_THRASH),
    LEVEL_UP_MOVE(55, MOVE_REST),
    LEVEL_UP_END
};

static const struct LevelUpMove sGrubbinLevelUpLearnset[] = {   // BUG
    LEVEL_UP_MOVE( 1, MOVE_VISE_GRIP),
    LEVEL_UP_MOVE( 4, MOVE_STRING_SHOT),
    LEVEL_UP_MOVE( 7, MOVE_MUD_SLAP),
    LEVEL_UP_MOVE(10, MOVE_BITE),
    LEVEL_UP_MOVE(13, MOVE_PH_BITE),
    LEVEL_UP_MOVE(16, ORIGINAL_TYPE_MOVE(MOVE_PH_HEAD + MOVES_PH_TYPE2, TYPE_ELECTRIC)), //MOVE_SPARK),
    LEVEL_UP_MOVE(19, MOVE_ACROBATICS),
    LEVEL_UP_MOVE(22, MOVE_CRUNCH),
    LEVEL_UP_MOVE(25, MOVE_PH_BLADE), //MOVE_X_SCISSOR),
    LEVEL_UP_MOVE(28, MOVE_DIG),
    LEVEL_UP_END
};

static const struct LevelUpMove sCharjabugLevelUpLearnset[] = { // BUG, ELECTRIC
    LEVEL_UP_MOVE( 0, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 1, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 1, MOVE_VISE_GRIP),
    LEVEL_UP_MOVE( 1, MOVE_STRING_SHOT),
    LEVEL_UP_MOVE( 1, MOVE_MUD_SLAP),
    ...
    LEVEL_UP_MOVE(10, MOVE_BITE),
    LEVEL_UP_MOVE(13, MOVE_PH_BITE),
    LEVEL_UP_MOVE(16, MOVE_PH_HEAD + MOVES_PH_TYPE2), //MOVE_SPARK),
    LEVEL_UP_MOVE(19, MOVE_ACROBATICS),
    LEVEL_UP_MOVE(25, MOVE_CRUNCH),
    LEVEL_UP_MOVE(31, MOVE_PH_BLADE), //MOVE_X_SCISSOR),
    LEVEL_UP_MOVE(37, MOVE_DIG),
    LEVEL_UP_MOVE(43, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2), //MOVE_DISCHARGE),
    LEVEL_UP_MOVE(49, MOVE_IRON_DEFENSE),
    LEVEL_UP_END
};

static const struct LevelUpMove sVikavoltLevelUpLearnset[] = {  // BUG, ELECTRIC
    LEVEL_UP_MOVE( 0, MOVE_PH_ELEMENT_STRONG + MOVES_PH_TYPE2), //MOVE_THUNDERBOLT),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_STRONG + MOVES_PH_TYPE2), //MOVE_THUNDERBOLT),
...
static const struct LevelUpMove sCrabrawlerLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(42, MOVE_IRON_DEFENSE),
    LEVEL_UP_MOVE(45, MOVE_DYNAMIC_PUNCH),
    LEVEL_UP_MOVE(49, MOVE_PH_BODY_RECOIL), //MOVE_CLOSE_COMBAT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sOricorioLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2),
...
static const struct LevelUpMove sCutieflyLevelUpLearnset[] = {  // BUG, FAIRY
    LEVEL_UP_MOVE( 1, MOVE_ABSORB),
    ...
    LEVEL_UP_MOVE(21, MOVE_SWEET_SCENT),
    LEVEL_UP_MOVE(26, MOVE_PH_BEAM3),
    LEVEL_UP_MOVE(31, MOVE_PH_ELEMENT_STRONG2 + MOVES_PH_TYPE2), //MOVE_DAZZLING_GLEAM),
    LEVEL_UP_MOVE(36, MOVE_AROMATHERAPY),
    LEVEL_UP_MOVE(41, MOVE_QUIVER_DANCE),
    LEVEL_UP_END
};

static const struct LevelUpMove sRibombeeLevelUpLearnset[] = {  // BUG, FAIRY
    ...
    LEVEL_UP_MOVE(21, MOVE_SWEET_SCENT),
    LEVEL_UP_MOVE(28, MOVE_PH_BEAM3),
    LEVEL_UP_MOVE(35, MOVE_PH_ELEMENT_STRONG2 + MOVES_PH_TYPE2), //MOVE_DAZZLING_GLEAM),
    LEVEL_UP_MOVE(42, MOVE_AROMATHERAPY),
...
static const struct LevelUpMove sRockruffLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(15, MOVE_PH_ATK_THROW), //MOVE_ROCK_THROW),
    LEVEL_UP_MOVE(18, MOVE_ODOR_SLEUTH),
    LEVEL_UP_MOVE(23, MOVE_ROCK_TOMB),
    LEVEL_UP_MOVE(26, MOVE_ROAR),
    LEVEL_UP_MOVE(29, MOVE_PH_HAZARD), //MOVE_STEALTH_ROCK),
    LEVEL_UP_MOVE(34, MOVE_PH_SPATK_ADJACENT1), //MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE(37, MOVE_SCARY_FACE),
...
static const struct LevelUpMove sWishiwashiLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(14, MOVE_PH_VARDMG), //MOVE_BRINE),
    LEVEL_UP_MOVE(17, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(22, MOVE_TEARFUL_LOOK),
    LEVEL_UP_MOVE(25, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(30, MOVE_PH_BODY_2TURN), //MOVE_DIVE),
    LEVEL_UP_MOVE(33, MOVE_BEAT_UP),
    LEVEL_UP_MOVE(38, MOVE_PH_TAIL), //MOVE_AQUA_TAIL),
    LEVEL_UP_MOVE(41, MOVE_DOUBLE_EDGE),
    LEVEL_UP_MOVE(46, MOVE_SOAK),
    LEVEL_UP_MOVE(49, MOVE_ENDEAVOR),
    LEVEL_UP_MOVE(54, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMareanieLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 9, MOVE_BITE),
    LEVEL_UP_MOVE(13, MOVE_PH_HAZARD), //MOVE_TOXIC_SPIKES),
    LEVEL_UP_MOVE(17, MOVE_WIDE_GUARD),
    LEVEL_UP_MOVE(21, MOVE_PH_STATUS3), //MOVE_TOXIC),
    LEVEL_UP_MOVE(25, MOVE_PH_VARDMG), //MOVE_VENOSHOCK),
...
static const struct LevelUpMove sMudbrayLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(10, MOVE_PH_PRIORITY), //MOVE_BULLDOZE),
    ...
    LEVEL_UP_MOVE(36, MOVE_COUNTER),
    LEVEL_UP_MOVE(38, MOVE_PH_SPATK_ADJACENT2),
...
static const struct LevelUpMove sDewpiderLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_PH_BITE + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(16, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE(21, MOVE_BITE),
    LEVEL_UP_MOVE(24, MOVE_PH_HEAL_SAP),
...
static const struct LevelUpMove sAraquanidLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_SPIDER_WEB),
    LEVEL_UP_MOVE( 1, MOVE_PH_BITE + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 5, MOVE_INFESTATION),
    LEVEL_UP_MOVE( 8, MOVE_SPIDER_WEB),
    LEVEL_UP_MOVE(13, MOVE_PH_BITE + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(16, MOVE_PH_BEAM2), //MOVE_BUBBLE_BEAM),
...
static const struct LevelUpMove sFomantisLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(10, MOVE_PH_SPATK_ADJACENT1), //MOVE_RAZOR_LEAF),
    ...
    LEVEL_UP_MOVE(32, MOVE_SLASH),
    LEVEL_UP_MOVE(37, MOVE_SWEET_SCENT),
    LEVEL_UP_MOVE(41, MOVE_PH_BEAM4),
    LEVEL_UP_MOVE(46, MOVE_PH_WEATHER), //MOVE_SUNNY_DAY),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sLurantisLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(55, MOVE_PH_WEATHER), //MOVE_SUNNY_DAY),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMorelullLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(22, MOVE_INGRAIN),
    LEVEL_UP_MOVE(25, MOVE_CONFUSE_RAY),
    LEVEL_UP_MOVE(29, MOVE_PH_BEAM2),
...
static const struct LevelUpMove sSalanditLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_PH_STATUS), //MOVE_POISON_GAS),
    LEVEL_UP_MOVE( 5, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    ...
    LEVEL_UP_MOVE(24, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(29, MOVE_PH_STATUS3), //MOVE_TOXIC),
    LEVEL_UP_MOVE(32, MOVE_NASTY_PLOT),
    LEVEL_UP_MOVE(37, MOVE_PH_VARDMG), //MOVE_VENOSHOCK),
    LEVEL_UP_MOVE(40, MOVE_PH_BEAM1 + MOVES_PH_TYPE2),
...
static const struct LevelUpMove sSalazzleLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(29, MOVE_PH_STATUS3), //MOVE_TOXIC),
    LEVEL_UP_MOVE(32, MOVE_NASTY_PLOT),
    LEVEL_UP_MOVE(39, MOVE_PH_VARDMG), //MOVE_VENOSHOCK),
    LEVEL_UP_MOVE(44, MOVE_PH_BEAM1 + MOVES_PH_TYPE2),
...
static const struct LevelUpMove sBewearLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(19, MOVE_FLAIL),
    LEVEL_UP_MOVE(23, MOVE_PAYBACK),
    LEVEL_UP_MOVE(30, MOVE_PH_BODY_RECOIL), //MOVE_TAKE_DOWN),
...
static const struct LevelUpMove sOranguruLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(43, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_PSYCHIC),
    LEVEL_UP_MOVE(46, MOVE_PH_BEAM3 + MOVES_PH_TYPE2), //MOVE_FUTURE_SIGHT),
    LEVEL_UP_MOVE(50, MOVE_TRICK_ROOM),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sPassimianLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(43, MOVE_PH_BODY_RECOIL), //MOVE_CLOSE_COMBAT),
    LEVEL_UP_MOVE(46, MOVE_REVERSAL),
    LEVEL_UP_MOVE(50, MOVE_GIGA_IMPACT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sGolisopodLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(21, MOVE_SLASH),
    LEVEL_UP_MOVE(26, MOVE_PH_HORN + MOVES_PH_TYPE2), //MOVE_RAZOR_SHELL),
    LEVEL_UP_MOVE(31, MOVE_SUCKER_PUNCH),
...
static const struct LevelUpMove sSandygastLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 5, MOVE_ASTONISH),
    LEVEL_UP_MOVE( 9, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE(14, MOVE_PH_ATK_TRAP + MOVES_PH_TYPE2), //MOVE_SAND_TOMB),
    LEVEL_UP_MOVE(18, MOVE_MEGA_DRAIN),
    LEVEL_UP_MOVE(23, MOVE_PH_PRIORITY + MOVES_PH_TYPE2), //MOVE_BULLDOZE),
    LEVEL_UP_MOVE(27, MOVE_HYPNOSIS),
    LEVEL_UP_MOVE(32, MOVE_IRON_DEFENSE),
    LEVEL_UP_MOVE(36, MOVE_GIGA_DRAIN),
    LEVEL_UP_MOVE(41, MOVE_PH_BEAM2), //MOVE_SHADOW_BALL),
    LEVEL_UP_MOVE(45, MOVE_PH_ELEMENT_STRONG + MOVES_PH_TYPE2), //MOVE_EARTH_POWER),
    LEVEL_UP_MOVE(50, MOVE_SHORE_UP),
    LEVEL_UP_MOVE(54, MOVE_PH_WEATHER + MOVES_PH_TYPE2), //MOVE_SANDSTORM),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sPalossandLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(36, MOVE_GIGA_DRAIN),
    LEVEL_UP_MOVE(41, MOVE_PH_BEAM2), //MOVE_SHADOW_BALL),
    LEVEL_UP_MOVE(47, MOVE_PH_ELEMENT_STRONG + MOVES_PH_TYPE2), //MOVE_EARTH_POWER),
    LEVEL_UP_MOVE(54, MOVE_SHORE_UP),
    LEVEL_UP_MOVE(60, MOVE_PH_WEATHER + MOVES_PH_TYPE2), //MOVE_SANDSTORM),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMiniorLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 3, MOVE_DEFENSE_CURL),
    LEVEL_UP_MOVE( 8, MOVE_PH_ELEMENT_WEAK), //MOVE_ROLLOUT),
    LEVEL_UP_MOVE(10, MOVE_CONFUSE_RAY),
    LEVEL_UP_MOVE(15, MOVE_SWIFT),
    LEVEL_UP_MOVE(17, MOVE_ANCIENT_POWER),
    LEVEL_UP_MOVE(22, MOVE_SELF_DESTRUCT),
    LEVEL_UP_MOVE(24, MOVE_PH_HAZARD), //MOVE_STEALTH_ROCK),
    LEVEL_UP_MOVE(29, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(31, MOVE_AUTOTOMIZE),
    LEVEL_UP_MOVE(36, MOVE_COSMIC_POWER),
    LEVEL_UP_MOVE(38, MOVE_PH_ELEMENT_STRONG), //MOVE_POWER_GEM),
    LEVEL_UP_MOVE(43, MOVE_DOUBLE_EDGE),
...
static const struct LevelUpMove sKomalaLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_DEFENSE_CURL),
    LEVEL_UP_MOVE( 1, ORIGINAL_TYPE_MOVE(MOVE_PH_ELEMENT_WEAK, TYPE_ROCK)), //MOVE_ROLLOUT),
...
static const struct LevelUpMove sTurtonatorLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(33, MOVE_BODY_SLAM),
    LEVEL_UP_MOVE(37, MOVE_SHELL_SMASH),
    LEVEL_UP_MOVE(41, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_DRAGON_PULSE),
...
static const struct LevelUpMove sTogedemaruLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 9, MOVE_ROLLOUT),
    LEVEL_UP_MOVE(13, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(17, MOVE_PH_HEAD), //MOVE_SPARK),
    LEVEL_UP_MOVE(21, MOVE_PH_ATK_WEAK), //MOVE_NUZZLE),
...
static const struct LevelUpMove sMimikyuLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(46, MOVE_PH_BODY + MOVES_PH_TYPE2), //MOVE_PLAY_ROUGH),
...
static const struct LevelUpMove sBruxishLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(17, MOVE_PH_PRIORITY), //MOVE_AQUA_JET),
...
static const struct LevelUpMove sDrampaLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_PLAY_NICE),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK2), //MOVE_ECHOED_VOICE),
    LEVEL_UP_MOVE( 5, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2), //MOVE_TWISTER),
    LEVEL_UP_MOVE( 9, MOVE_PROTECT),
    ...
    LEVEL_UP_MOVE(29, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_DRAGON_BREATH),
    LEVEL_UP_MOVE(33, MOVE_SAFEGUARD),
    LEVEL_UP_MOVE(37, MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE(41, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_DRAGON_PULSE),
    LEVEL_UP_MOVE(45, MOVE_FLY),
    LEVEL_UP_MOVE(49, MOVE_PH_SPATK_ADJACENT1),
    LEVEL_UP_MOVE(53, MOVE_PH_THRASH + MOVES_PH_TYPE2), //MOVE_OUTRAGE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sDhelmiseLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_RAPID_SPIN),
    LEVEL_UP_MOVE( 1, MOVE_ASTONISH),
    LEVEL_UP_MOVE( 5, MOVE_PH_BEAM1 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 9, MOVE_WRAP),
    LEVEL_UP_MOVE(14, MOVE_GYRO_BALL),
    LEVEL_UP_MOVE(18, MOVE_METAL_SOUND),
    LEVEL_UP_MOVE(23, MOVE_PH_BEAM2 + MOVES_PH_TYPE2),
...
static const struct LevelUpMove sJangmooLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(17, MOVE_PH_TAIL), //MOVE_DRAGON_TAIL),
    LEVEL_UP_MOVE(21, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(25, MOVE_HEADBUTT),
    LEVEL_UP_MOVE(29, MOVE_WORK_UP),
    LEVEL_UP_MOVE(33, MOVE_SCREECH),
    LEVEL_UP_MOVE(37, MOVE_IRON_DEFENSE),
    LEVEL_UP_MOVE(41, MOVE_PH_BLADE), //MOVE_DRAGON_CLAW),
    LEVEL_UP_MOVE(45, MOVE_NOBLE_ROAR),
    LEVEL_UP_MOVE(49, MOVE_DRAGON_DANCE),
    LEVEL_UP_MOVE(53, MOVE_PH_THRASH), //MOVE_OUTRAGE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sHakamooLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(33, MOVE_SCREECH),
    LEVEL_UP_MOVE(38, MOVE_IRON_DEFENSE),
    LEVEL_UP_MOVE(43, MOVE_PH_BLADE), //MOVE_DRAGON_CLAW),
    LEVEL_UP_MOVE(48, MOVE_NOBLE_ROAR),
    LEVEL_UP_MOVE(53, MOVE_DRAGON_DANCE),
    LEVEL_UP_MOVE(58, MOVE_PH_THRASH), //MOVE_OUTRAGE),
    LEVEL_UP_MOVE(63, MOVE_PH_BODY_RECOIL + MOVES_PH_TYPE2), //MOVE_CLOSE_COMBAT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sKommooLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(67, MOVE_PH_THRASH), //MOVE_OUTRAGE),
    LEVEL_UP_MOVE(75, MOVE_PH_BODY_RECOIL + MOVES_PH_TYPE2), //MOVE_CLOSE_COMBAT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sTapuKokoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_WITHDRAW),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 8, MOVE_PH_HEAD), //MOVE_SPARK),
    ...
    LEVEL_UP_MOVE(58, MOVE_PH_VARDMG), //MOVE_ELECTRO_BALL),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sTapuLeleLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(43, MOVE_NATURES_MADNESS),
    LEVEL_UP_MOVE(48, MOVE_PH_BALL), //MOVE_EXTRASENSORY),
...
static const struct LevelUpMove sTapuBuluLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_LEAFAGE),
    LEVEL_UP_MOVE( 8, MOVE_HORN_ATTACK),
    LEVEL_UP_MOVE(14, MOVE_PH_BEAM2),
...
static const struct LevelUpMove sTapuFiniLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_WITHDRAW),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 8, MOVE_PH_BEAM1),
    LEVEL_UP_MOVE(14, MOVE_PH_HAZARD),
    ...
    LEVEL_UP_MOVE(43, MOVE_NATURES_MADNESS),
    LEVEL_UP_MOVE(48, MOVE_PH_SPATK_ADJACENT1_MUD),
    LEVEL_UP_MOVE(53, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(58, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSolgaleoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_TELEPORT),
    LEVEL_UP_MOVE( 1, MOVE_METAL_CLAW),
    LEVEL_UP_MOVE( 7, MOVE_PH_HEAD + MOVES_PH_TYPE2), //MOVE_IRON_HEAD),
    LEVEL_UP_MOVE(13, MOVE_METAL_SOUND),
    LEVEL_UP_MOVE(19, MOVE_ZEN_HEADBUTT),
    LEVEL_UP_MOVE(23, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_FLASH_CANNON),
...
static const struct LevelUpMove sLunalaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(23, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_SHADOW_BALL),
    ...
    LEVEL_UP_MOVE(61, MOVE_PH_BODY_2TURN + MOVES_PH_TYPE2), //MOVE_PHANTOM_FORCE),
    LEVEL_UP_MOVE(67, MOVE_WIDE_GUARD),
    LEVEL_UP_MOVE(73, MOVE_HYPER_BEAM),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sNihilegoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(37, MOVE_PH_ELEMENT_STRONG), //MOVE_POWER_GEM),
    LEVEL_UP_MOVE(43, MOVE_MIRROR_COAT),
    LEVEL_UP_MOVE(47, MOVE_ACID_SPRAY),
    LEVEL_UP_MOVE(53, MOVE_VENOM_DRENCH),
    LEVEL_UP_MOVE(59, MOVE_PH_HAZARD), //MOVE_STEALTH_ROCK),
...
static const struct LevelUpMove sBuzzwoleLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(19, MOVE_PH_ATK_THROW + MOVES_PH_TYPE2), //MOVE_VITAL_THROW),
...
static const struct LevelUpMove sPheromosaLevelUpLearnset[] = { // BUG, FIGHTING
    LEVEL_UP_MOVE( 1, MOVE_QUIVER_DANCE),
    LEVEL_UP_MOVE( 1, MOVE_QUICK_GUARD),
    LEVEL_UP_MOVE( 1, MOVE_LOW_KICK),
    LEVEL_UP_MOVE( 1, MOVE_RAPID_SPIN),
...
static const struct LevelUpMove sXurkitreeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(37, MOVE_PH_ELEMENT_STRONG), //MOVE_THUNDERBOLT),
    LEVEL_UP_MOVE(43, MOVE_HYPNOSIS),
    LEVEL_UP_MOVE(47, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISCHARGE),
    LEVEL_UP_MOVE(53, MOVE_ELECTRIC_TERRAIN),
    LEVEL_UP_MOVE(59, MOVE_POWER_WHIP),
    LEVEL_UP_MOVE(67, MOVE_PH_TYPE_EFF),
...
static const struct LevelUpMove sCelesteelaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(29, MOVE_PH_HEAD), //MOVE_IRON_HEAD),
    LEVEL_UP_MOVE(31, MOVE_GIGA_DRAIN),
    LEVEL_UP_MOVE(37, MOVE_PH_BEAM2), //MOVE_FLASH_CANNON),
    LEVEL_UP_MOVE(43, MOVE_AUTOTOMIZE),
...
static const struct LevelUpMove sGuzzlordLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(23, MOVE_PH_TAIL + MOVES_PH_TYPE2), //MOVE_DRAGON_TAIL),
    LEVEL_UP_MOVE(29, MOVE_IRON_TAIL),
    LEVEL_UP_MOVE(31, MOVE_STOMPING_TANTRUM),
    LEVEL_UP_MOVE(37, MOVE_PH_BITE2), //MOVE_CRUNCH),
    ...
    LEVEL_UP_MOVE(73, MOVE_PH_BODY + MOVES_PH_TYPE2), //MOVE_DRAGON_RUSH),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sNecrozmaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(37, MOVE_PH_BLADE2), //MOVE_PSYCHO_CUT),
...
static const struct LevelUpMove sMagearnaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(33, MOVE_MIND_READER),
    LEVEL_UP_MOVE(41, MOVE_PH_BEAM2), //MOVE_FLASH_CANNON),
...
static const struct LevelUpMove sMarshadowLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PURSUIT),
    LEVEL_UP_MOVE( 1, MOVE_SHADOW_SNEAK),
    LEVEL_UP_MOVE( 5, MOVE_PH_FIST3), //MOVE_FORCE_PALM),
    LEVEL_UP_MOVE(11, MOVE_FEINT),
    ...
    LEVEL_UP_MOVE(50, MOVE_PH_BODY_RECOIL), //MOVE_CLOSE_COMBAT),
...
static const struct LevelUpMove sPoipoleLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, ORIGINAL_TYPE_MOVE(MOVE_PH_BEAM2 + MOVES_PH_TYPE2, TYPE_DRAGON)), //MOVE_DRAGON_PULSE),
    LEVEL_UP_MOVE( 1, MOVE_PECK),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_HELPING_HAND),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK), //MOVE_ACID),
    LEVEL_UP_MOVE( 7, MOVE_FURY_ATTACK),
    LEVEL_UP_MOVE(13, MOVE_PH_VARDMG), //MOVE_VENOSHOCK),
    LEVEL_UP_MOVE(19, MOVE_CHARM),
    LEVEL_UP_MOVE(23, MOVE_VENOM_DRENCH),
    LEVEL_UP_MOVE(31, MOVE_NASTY_PLOT),
    LEVEL_UP_MOVE(37, MOVE_PH_HORN), //MOVE_POISON_JAB),
    LEVEL_UP_MOVE(41, MOVE_PH_STATUS3), //MOVE_TOXIC),
    LEVEL_UP_MOVE(47, MOVE_FELL_STINGER),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sNaganadelLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(61, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_DRAGON_PULSE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sStakatakaLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_PROTECT),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 5, MOVE_PH_SPATK_ADJACENT1), //MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE(11, MOVE_PH_HAZARD), //MOVE_STEALTH_ROCK),
    LEVEL_UP_MOVE(17, MOVE_BIDE),
    LEVEL_UP_MOVE(19, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(23, MOVE_PH_ATK_THROW), //MOVE_ROCK_THROW),
    LEVEL_UP_MOVE(31, MOVE_AUTOTOMIZE),
    LEVEL_UP_MOVE(37, MOVE_IRON_DEFENSE),
    LEVEL_UP_MOVE(43, MOVE_PH_HEAD + MOVES_PH_TYPE2), //MOVE_IRON_HEAD),
    LEVEL_UP_MOVE(47, MOVE_PH_ATK_WEAK), //MOVE_ROCK_BLAST),
...
static const struct LevelUpMove sBlacephalonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_STORED_POWER),
    LEVEL_UP_MOVE(17, MOVE_PH_SPATK_ADJACENT1),
    LEVEL_UP_MOVE(23, MOVE_NIGHT_SHADE),
    LEVEL_UP_MOVE(29, MOVE_LIGHT_SCREEN),
    LEVEL_UP_MOVE(31, MOVE_CALM_MIND),
    LEVEL_UP_MOVE(37, MOVE_PH_BEAM4), //MOVE_FIRE_BLAST),
    LEVEL_UP_MOVE(41, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_SHADOW_BALL),
...
static const struct LevelUpMove sMeltanLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 45, MOVE_PH_BEAM2), //MOVE_FLASH_CANNON),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sGrookeyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 8, MOVE_TAUNT),
    LEVEL_UP_MOVE(12, MOVE_PH_SPATK_ADJACENT1), //MOVE_RAZOR_LEAF),
    LEVEL_UP_MOVE(17, MOVE_SCREECH),
...
static const struct LevelUpMove sScorbunnyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(17, MOVE_PH_PRIORITY),
    LEVEL_UP_MOVE(20, MOVE_AGILITY),
...
static const struct LevelUpMove sRabootLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE(12, MOVE_DOUBLE_KICK),
    LEVEL_UP_MOVE(19, MOVE_PH_PRIORITY),
...
static const struct LevelUpMove sSobbleLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(36, MOVE_PH_WEATHER), //MOVE_RAIN_DANCE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sRookideeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(32, MOVE_SWAGGER),
    LEVEL_UP_MOVE(36, MOVE_PH_BODY_RECOIL), //MOVE_BRAVE_BIRD),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sCorvisquireLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(46, MOVE_PH_BODY_RECOIL), //MOVE_BRAVE_BIRD),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sCorviknightLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(50, MOVE_PH_BODY_RECOIL), //MOVE_BRAVE_BIRD),
    LEVEL_UP_END
};

static const struct LevelUpMove sBlipbugLevelUpLearnset[] = {   // BUG
    LEVEL_UP_MOVE( 1, MOVE_STRUGGLE_BUG),
    LEVEL_UP_END
};

static const struct LevelUpMove sDottlerLevelUpLearnset[] = {   // BUG, PSYCHIC
...
static const struct LevelUpMove sOrbeetleLevelUpLearnset[] = {  // BUG, PSYCHIC
    LEVEL_UP_MOVE( 1, MOVE_REFLECT),
    LEVEL_UP_MOVE( 1, MOVE_LIGHT_SCREEN),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 1, MOVE_STRUGGLE_BUG),
    ...
    LEVEL_UP_MOVE(36, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_PSYCHIC),
...
static const struct LevelUpMove sNickitLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(16, MOVE_ASSURANCE),
    LEVEL_UP_MOVE(20, MOVE_NASTY_PLOT),
    LEVEL_UP_MOVE(24, MOVE_PH_PRIORITY), //MOVE_SUCKER_PUNCH),
    LEVEL_UP_MOVE(28, MOVE_PH_BLADE2), //MOVE_NIGHT_SLASH),
...
static const struct LevelUpMove sThievulLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(28, MOVE_PH_PRIORITY), //MOVE_SUCKER_PUNCH),
    LEVEL_UP_MOVE(34, MOVE_PH_BLADE2), //MOVE_NIGHT_SLASH),
...
static const struct LevelUpMove sGossifleurLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(21, MOVE_PH_STRONGWIND), //MOVE_LEAF_TORNADO),
    LEVEL_UP_MOVE(24, MOVE_PH_RECOVER), //MOVE_SYNTHESIS),
...
static const struct LevelUpMove sEldegossLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(12, MOVE_PH_SPATK_ADJACENT1), //MOVE_RAZOR_LEAF),
    LEVEL_UP_MOVE(16, MOVE_ROUND),
    LEVEL_UP_MOVE(23, MOVE_PH_STRONGWIND), //MOVE_LEAF_TORNADO),
    LEVEL_UP_MOVE(28, MOVE_PH_RECOVER), //MOVE_SYNTHESIS),
...
static const struct LevelUpMove sDrednawLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_ROCK_TOMB),
    LEVEL_UP_MOVE( 1, MOVE_PH_HORN), //MOVE_RAZOR_SHELL),
    LEVEL_UP_MOVE( 1, MOVE_CRUNCH),
    LEVEL_UP_MOVE( 1, MOVE_ROCK_POLISH),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK),
...
static const struct LevelUpMove sYamperLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE( 5, MOVE_PH_ATK_WEAK), //MOVE_NUZZLE),
    LEVEL_UP_MOVE(10, MOVE_BITE),
    LEVEL_UP_MOVE(15, MOVE_ROAR),
    LEVEL_UP_MOVE(20, MOVE_PH_HEAD), //MOVE_SPARK),
...
static const struct LevelUpMove sBoltundLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(28, MOVE_CHARM),
    LEVEL_UP_MOVE(34, MOVE_CRUNCH),
    LEVEL_UP_MOVE(41, MOVE_PH_HEAL_SAP),
...
static const struct LevelUpMove sRolycolyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(40, MOVE_PH_ATK_WEAK), //MOVE_ROCK_BLAST),
    LEVEL_UP_END
};

static const struct LevelUpMove sCarkolLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_BODY_ATK_SPEED + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 1, MOVE_PH_BODY_ATK_SPEED + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_SMOKESCREEN),
    LEVEL_UP_MOVE( 1, MOVE_RAPID_SPIN),
    LEVEL_UP_MOVE( 1, MOVE_SMACK_DOWN),
    ...
    LEVEL_UP_MOVE(35, MOVE_PH_HAZARD), //MOVE_STEALTH_ROCK),
    LEVEL_UP_MOVE(41, MOVE_HEAT_CRASH),
    LEVEL_UP_MOVE(48, MOVE_PH_ATK_WEAK), //MOVE_ROCK_BLAST),
...
static const struct LevelUpMove sCoalossalLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(20, MOVE_ANCIENT_POWER),
    LEVEL_UP_MOVE(27, MOVE_INCINERATE),
    LEVEL_UP_MOVE(37, MOVE_PH_HAZARD), //MOVE_STEALTH_ROCK),
    LEVEL_UP_MOVE(45, MOVE_HEAT_CRASH),
    LEVEL_UP_MOVE(54, MOVE_PH_ATK_WEAK), //MOVE_ROCK_BLAST),
...
static const struct LevelUpMove sFlappleLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(12, MOVE_PH_HEAL_SAP),
    LEVEL_UP_MOVE(16, MOVE_PROTECT),
    LEVEL_UP_MOVE(20, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_DRAGON_BREATH),
    LEVEL_UP_MOVE(24, MOVE_DRAGON_DANCE),
    LEVEL_UP_MOVE(28, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_DRAGON_PULSE),
    LEVEL_UP_MOVE(32, MOVE_GRAV_APPLE),
    LEVEL_UP_MOVE(36, MOVE_IRON_DEFENSE),
    LEVEL_UP_MOVE(40, MOVE_FLY),
    LEVEL_UP_MOVE(44, MOVE_PH_BODY + MOVES_PH_TYPE2), //MOVE_DRAGON_RUSH),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sAppletunLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(32, MOVE_BODY_SLAM),
    LEVEL_UP_MOVE(36, MOVE_IRON_DEFENSE),
    LEVEL_UP_MOVE(40, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_DRAGON_PULSE),
    LEVEL_UP_MOVE(44, MOVE_PH_BALL),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSilicobraLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(15, MOVE_PH_PRIORITY), //MOVE_BULLDOZE),
    LEVEL_UP_MOVE(20, MOVE_HEADBUTT),
    LEVEL_UP_MOVE(25, MOVE_GLARE),
    LEVEL_UP_MOVE(30, MOVE_PH_BODY_2TURN), //MOVE_DIG),
    LEVEL_UP_MOVE(35, MOVE_PH_WEATHER), //MOVE_SANDSTORM),
    LEVEL_UP_MOVE(40, MOVE_SLAM),
    LEVEL_UP_MOVE(45, MOVE_COIL),
    LEVEL_UP_MOVE(50, MOVE_PH_ATK_TRAP), //MOVE_SAND_TOMB),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSandacondaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(51, MOVE_PH_ATK_TRAP), //MOVE_SAND_TOMB),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sCramorantLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(28, MOVE_PH_BODY_2TURN + MOVES_PH_TYPE2), //MOVE_DIVE),
    LEVEL_UP_MOVE(35, MOVE_DRILL_PECK),
    LEVEL_UP_MOVE(42, MOVE_AMNESIA),
    LEVEL_UP_MOVE(49, MOVE_THRASH),
    LEVEL_UP_MOVE(56, MOVE_PH_BEAM3 + MOVES_PH_TYPE2),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sArrokudaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(12, MOVE_BITE),
    LEVEL_UP_MOVE(18, MOVE_AGILITY),
    LEVEL_UP_MOVE(24, MOVE_PH_BODY_2TURN), //MOVE_DIVE),
...
static const struct LevelUpMove sToxtricityLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_HEAD), //MOVE_SPARK),
    LEVEL_UP_MOVE( 1, MOVE_PH_HEAD), //MOVE_SPARK),
    LEVEL_UP_MOVE( 1, MOVE_EERIE_IMPULSE),
    LEVEL_UP_MOVE( 1, MOVE_BELCH),
    LEVEL_UP_MOVE( 1, MOVE_TEARFUL_LOOK),
    ...
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_NOBLE_ROAR),
    LEVEL_UP_MOVE( 4, MOVE_PH_HEAL_SAP),
    ...
    LEVEL_UP_MOVE(32, MOVE_PH_STATUS3 + MOVES_PH_TYPE2), //MOVE_TOXIC),
    LEVEL_UP_MOVE(36, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISCHARGE),
    LEVEL_UP_MOVE(40, MOVE_PH_FIST + MOVES_PH_TYPE2), //MOVE_POISON_JAB),
...
static const struct LevelUpMove sSizzlipedeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(10, MOVE_BITE),
    LEVEL_UP_MOVE(15, MOVE_PH_HEAD), //MOVE_FLAME_WHEEL),
    LEVEL_UP_MOVE(20, MOVE_PH_BITE + MOVES_PH_TYPE2),
...
static const struct LevelUpMove sSinisteaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(36, MOVE_GIGA_DRAIN),
    LEVEL_UP_MOVE(42, MOVE_NASTY_PLOT),
    LEVEL_UP_MOVE(48, MOVE_PH_BEAM2), //MOVE_SHADOW_BALL),
...
static const struct LevelUpMove sPolteageistLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(54, MOVE_MEMENTO),
    LEVEL_UP_MOVE(60, MOVE_SHELL_SMASH),
    LEVEL_UP_MOVE(66, MOVE_PH_HEAL_SAP),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sHatennaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(10, ORIGINAL_TYPE_MOVE(MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2, TYPE_FAIRY)), //MOVE_DISARMING_VOICE),
    LEVEL_UP_MOVE(15, MOVE_AROMATHERAPY),
    LEVEL_UP_MOVE(20, MOVE_PH_BEAM1), //MOVE_PSYBEAM),
    LEVEL_UP_MOVE(25, MOVE_HEAL_PULSE),
    LEVEL_UP_MOVE(30, ORIGINAL_TYPE_MOVE(MOVE_PH_ELEMENT_STRONG2 + MOVES_PH_TYPE2, TYPE_FAIRY)), //MOVE_DAZZLING_GLEAM),
    LEVEL_UP_MOVE(35, MOVE_CALM_MIND),
    LEVEL_UP_MOVE(40, MOVE_PH_BEAM2), //MOVE_PSYCHIC),
...
static const struct LevelUpMove sHattremLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, ORIGINAL_TYPE_MOVE(MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2, TYPE_FAIRY)), //MOVE_DISARMING_VOICE),
    LEVEL_UP_MOVE(15, MOVE_AROMATHERAPY),
    LEVEL_UP_MOVE(20, MOVE_PH_BEAM1), //MOVE_PSYBEAM),
    LEVEL_UP_MOVE(25, MOVE_HEAL_PULSE),
    LEVEL_UP_MOVE(30, ORIGINAL_TYPE_MOVE(MOVE_PH_ELEMENT_STRONG2 + MOVES_PH_TYPE2, TYPE_FAIRY)), //MOVE_DAZZLING_GLEAM),
...
static const struct LevelUpMove sHattereneLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_BLADE2), //MOVE_PSYCHO_CUT),
    LEVEL_UP_MOVE( 1, MOVE_PH_BLADE2), //MOVE_PSYCHO_CUT),
    LEVEL_UP_MOVE( 1, MOVE_BRUTAL_SWING),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK),
    LEVEL_UP_MOVE( 1, MOVE_PLAY_NICE),
    ...
    LEVEL_UP_MOVE(20, MOVE_PH_BEAM1), //MOVE_PSYBEAM),
    LEVEL_UP_MOVE(25, MOVE_HEAL_PULSE),
    LEVEL_UP_MOVE(30, MOVE_PH_ELEMENT_STRONG2 + MOVES_PH_TYPE2), //MOVE_DAZZLING_GLEAM),
    LEVEL_UP_MOVE(37, MOVE_CALM_MIND),
    LEVEL_UP_MOVE(46, MOVE_PH_BEAM2), //MOVE_PSYCHIC),
    LEVEL_UP_MOVE(55, MOVE_HEALING_WISH),
...
static const struct LevelUpMove sImpidimpLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(36, MOVE_NASTY_PLOT),
    LEVEL_UP_MOVE(40, MOVE_PH_BODY + MOVES_PH_TYPE2), //MOVE_PLAY_ROUGH),
...
static const struct LevelUpMove sGrimmsnarlLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(35, MOVE_DARK_PULSE),
    LEVEL_UP_MOVE(40, MOVE_NASTY_PLOT),
    LEVEL_UP_MOVE(48, MOVE_PH_BODY + MOVES_PH_TYPE2), //MOVE_PLAY_ROUGH),
...
static const struct LevelUpMove sObstagoonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(12, MOVE_PH_HEAD + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(15, MOVE_HONE_CLAWS),
    LEVEL_UP_MOVE(18, MOVE_PH_ATK_WEAK + MOVES_PH_TYPE2), //MOVE_FURY_SWIPES),
    LEVEL_UP_MOVE(23, MOVE_REST),
    LEVEL_UP_MOVE(28, MOVE_PH_BODY_RECOIL + MOVES_PH_TYPE2), //MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(35, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(42, MOVE_COUNTER),
...
static const struct LevelUpMove sPerrserkerLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_HEAD), //MOVE_IRON_HEAD),
    LEVEL_UP_MOVE( 1, MOVE_PH_HEAD), //MOVE_IRON_HEAD),
    LEVEL_UP_MOVE( 1, MOVE_METAL_BURST),
    LEVEL_UP_MOVE( 1, MOVE_IRON_DEFENSE),
    LEVEL_UP_MOVE( 1, MOVE_FAKE_OUT),
...
static const struct LevelUpMove sRunerigusLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(32, MOVE_SLAM),
    LEVEL_UP_MOVE(38, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(44, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_SHADOW_BALL),
    LEVEL_UP_MOVE(50, MOVE_PH_SPATK_ADJACENT2),
...
static const struct LevelUpMove sMilceryLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(35, MOVE_PH_ELEMENT_STRONG2), //MOVE_DAZZLING_GLEAM),
...
static const struct LevelUpMove sPincurchinLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(60, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISCHARGE),
    LEVEL_UP_END
};

static const struct LevelUpMove sSnomLevelUpLearnset[] = {  // ICE, BUG
    LEVEL_UP_MOVE( 1, MOVE_POWDER_SNOW),
    LEVEL_UP_MOVE( 1, MOVE_STRUGGLE_BUG),
    LEVEL_UP_END
};

static const struct LevelUpMove sFrosmothLevelUpLearnset[] = {  // ICE, BUG
    LEVEL_UP_MOVE( 0, MOVE_ICY_WIND),
    LEVEL_UP_MOVE( 1, MOVE_ICY_WIND),
    LEVEL_UP_MOVE( 1, MOVE_POWDER_SNOW),
    LEVEL_UP_MOVE( 1, MOVE_STRUGGLE_BUG),
    ...
    LEVEL_UP_MOVE(21, MOVE_FEATHER_DANCE),
    LEVEL_UP_MOVE(24, MOVE_PH_BEAM1), //MOVE_AURORA_BEAM),
    LEVEL_UP_MOVE(28, MOVE_HAIL),
    LEVEL_UP_MOVE(32, MOVE_PH_BEAM3 + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(36, MOVE_AURORA_VEIL),
    LEVEL_UP_MOVE(40, MOVE_PH_SPATK_ADJACENT2), //MOVE_BLIZZARD),
    LEVEL_UP_MOVE(44, MOVE_TAILWIND),
...
static const struct LevelUpMove sStonjournerLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(30, MOVE_PH_HAZARD), //MOVE_STEALTH_ROCK),
    LEVEL_UP_MOVE(36, MOVE_PH_SPATK_ADJACENT1), //MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE(42, MOVE_BODY_SLAM),
    LEVEL_UP_MOVE(48, MOVE_WIDE_GUARD),
    LEVEL_UP_MOVE(54, MOVE_HEAVY_SLAM),
    LEVEL_UP_MOVE(60, MOVE_PH_HORN), //MOVE_STONE_EDGE),
...
static const struct LevelUpMove sMorpekoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(30, MOVE_PH_HEAD), //MOVE_SPARK),
    LEVEL_UP_MOVE(35, MOVE_TORMENT),
    LEVEL_UP_MOVE(40, MOVE_AGILITY),
    LEVEL_UP_MOVE(45, MOVE_BULLET_SEED),
    LEVEL_UP_MOVE(50, MOVE_PH_BITE2 + MOVES_PH_TYPE2), //MOVE_CRUNCH),
...
static const struct LevelUpMove sCufantLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(40, MOVE_PH_HEAD), //MOVE_IRON_HEAD),
    LEVEL_UP_MOVE(45, MOVE_PLAY_ROUGH),
...
static const struct LevelUpMove sCopperajahLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(44, MOVE_PH_HEAD), //MOVE_IRON_HEAD),
...
static const struct LevelUpMove sDracozoltLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(35, MOVE_PH_TAIL + MOVES_PH_TYPE2), //MOVE_DRAGON_TAIL),
    LEVEL_UP_MOVE(42, MOVE_STOMP),
    LEVEL_UP_MOVE(49, MOVE_SLAM),
    LEVEL_UP_MOVE(56, MOVE_PH_SPATK_ADJACENT1), //MOVE_DISCHARGE),
    LEVEL_UP_MOVE(63, MOVE_BOLT_BEAK),
    LEVEL_UP_MOVE(70, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_DRAGON_PULSE),
    LEVEL_UP_MOVE(77, MOVE_PH_BODY + MOVES_PH_TYPE2), //MOVE_DRAGON_RUSH),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sArctozoltLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(77, MOVE_PH_SPATK_ADJACENT2 + MOVES_PH_TYPE2), //MOVE_BLIZZARD),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sDracovishLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(35, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_DRAGON_BREATH),
    LEVEL_UP_MOVE(42, MOVE_STOMP),
...
static const struct LevelUpMove sDuraludonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(48, MOVE_PH_BLADE + MOVES_PH_TYPE2), //MOVE_DRAGON_CLAW),
    LEVEL_UP_MOVE(54, MOVE_PH_BEAM2), //MOVE_FLASH_CANNON),
...
static const struct LevelUpMove sDrakloakLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_BEAM2), //MOVE_DRAGON_PULSE),
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM2), //MOVE_DRAGON_PULSE),
    LEVEL_UP_MOVE( 1, MOVE_ASTONISH),
    LEVEL_UP_MOVE( 1, MOVE_INFESTATION),
    LEVEL_UP_MOVE( 1, MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_BITE),
    ...
    LEVEL_UP_MOVE(48, MOVE_PH_BODY_2TURN + MOVES_PH_TYPE2), //MOVE_PHANTOM_FORCE),
    LEVEL_UP_MOVE(54, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(61, MOVE_PH_BODY), //MOVE_DRAGON_RUSH),
...
static const struct LevelUpMove sDragapultLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(48, MOVE_PH_BODY_2TURN + MOVES_PH_TYPE2), //MOVE_PHANTOM_FORCE),
    LEVEL_UP_MOVE(54, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(63, MOVE_PH_BODY), //MOVE_DRAGON_RUSH),
...
static const struct LevelUpMove sZacianLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(33, ORIGINAL_TYPE_MOVE(MOVE_PH_HEAD + MOVES_PH_TYPE2, TYPE_STEEL)), //MOVE_IRON_HEAD),
...
static const struct LevelUpMove sZamazentaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(55, MOVE_CRUNCH),
    LEVEL_UP_MOVE(66, MOVE_MOONBLAST),
    LEVEL_UP_MOVE(77, MOVE_PH_BODY_RECOIL), //MOVE_CLOSE_COMBAT),
    LEVEL_UP_MOVE(88, MOVE_GIGA_IMPACT),
    LEVEL_UP_END
};

static const struct LevelUpMove sEternatusLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_PH_TAIL), //MOVE_POISON_TAIL),
    LEVEL_UP_MOVE( 1, MOVE_CONFUSE_RAY),
    LEVEL_UP_MOVE( 1, MOVE_PH_TAIL + MOVES_PH_TYPE2), //MOVE_DRAGON_TAIL),
    LEVEL_UP_MOVE( 1, MOVE_AGILITY),
    LEVEL_UP_MOVE( 8, MOVE_PH_STATUS3), //MOVE_TOXIC),
    LEVEL_UP_MOVE(16, MOVE_PH_VARDMG), //MOVE_VENOSHOCK),
    LEVEL_UP_MOVE(24, MOVE_DRAGON_DANCE),
...
static const struct LevelUpMove sKubfuLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(44, MOVE_COUNTER),
    LEVEL_UP_MOVE(48, MOVE_PH_BODY_RECOIL), //MOVE_CLOSE_COMBAT),
...
static const struct LevelUpMove sUrshifuLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_PH_PRIORITY + MOVES_PH_TYPE2), //MOVE_SUCKER_PUNCH),
    LEVEL_UP_MOVE( 1, MOVE_ROCK_SMASH),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_ENDURE),
    LEVEL_UP_MOVE( 1, MOVE_FOCUS_ENERGY),
...
static const struct LevelUpMove sZarudeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(60, MOVE_PH_BALL + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(66, MOVE_PH_RECOVER + MOVES_PH_TYPE2), //MOVE_SYNTHESIS),
    LEVEL_UP_MOVE(72, MOVE_HAMMER_ARM),
...
static const struct LevelUpMove sRegielekiLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(24, MOVE_PH_STATUS3), //MOVE_THUNDER_WAVE),
...
static const struct LevelUpMove sRegidragoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(30, MOVE_CRUNCH),
    LEVEL_UP_MOVE(36, MOVE_PH_BLADE), //MOVE_DRAGON_CLAW),
...
static const struct LevelUpMove sCalyrexLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(56, MOVE_PH_BEAM2), //MOVE_PSYCHIC),
    LEVEL_UP_MOVE(64, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(72, MOVE_HEAL_PULSE),
    LEVEL_UP_MOVE(80, MOVE_SOLAR_BEAM),
    LEVEL_UP_MOVE(88, MOVE_PH_BEAM3), //MOVE_FUTURE_SIGHT),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sRattataAlolanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE( 4, MOVE_PH_PRIORITY + MOVES_PH_TYPE2), //MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE( 7, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE(10, MOVE_BITE),
    LEVEL_UP_MOVE(13, MOVE_PURSUIT),
    LEVEL_UP_MOVE(16, MOVE_HYPER_FANG),
    LEVEL_UP_MOVE(19, MOVE_ASSURANCE),
    LEVEL_UP_MOVE(22, MOVE_PH_BITE2), //MOVE_CRUNCH),
    LEVEL_UP_MOVE(25, MOVE_PH_PRIORITY), //MOVE_SUCKER_PUNCH),
    LEVEL_UP_MOVE(28, MOVE_SUPER_FANG),
    LEVEL_UP_MOVE(31, MOVE_DOUBLE_EDGE),
    LEVEL_UP_MOVE(34, MOVE_ENDEAVOR),
    LEVEL_UP_END
...
static const struct LevelUpMove sRaticateAlolanLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(16, MOVE_HYPER_FANG),
    LEVEL_UP_MOVE(19, MOVE_ASSURANCE),
    LEVEL_UP_MOVE(24, MOVE_PH_BITE2), //MOVE_CRUNCH),
    LEVEL_UP_MOVE(29, MOVE_PH_PRIORITY), //MOVE_SUCKER_PUNCH),
    LEVEL_UP_MOVE(34, MOVE_SUPER_FANG),
    LEVEL_UP_MOVE(39, MOVE_DOUBLE_EDGE),
    LEVEL_UP_MOVE(44, MOVE_ENDEAVOR),
    LEVEL_UP_END
...
static const struct LevelUpMove sRaichuAlolanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_PSYCHIC),
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_PSYCHIC),
...
static const struct LevelUpMove sSandshrewAlolanLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(26, MOVE_SLASH),
    LEVEL_UP_MOVE(30, MOVE_PH_HEAD + MOVES_PH_TYPE2), //MOVE_IRON_HEAD),
    LEVEL_UP_MOVE(34, MOVE_GYRO_BALL),
    LEVEL_UP_MOVE(38, MOVE_SWORDS_DANCE),
    LEVEL_UP_MOVE(42, MOVE_HAIL),
    LEVEL_UP_MOVE(46, MOVE_PH_SPATK_ADJACENT2), //MOVE_BLIZZARD),
...
static const struct LevelUpMove sVulpixAlolanLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(23, MOVE_FEINT_ATTACK),
    LEVEL_UP_MOVE(26, MOVE_HEX),
    LEVEL_UP_MOVE(28, MOVE_PH_BEAM1), //MOVE_AURORA_BEAM),
    LEVEL_UP_MOVE(31, MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE(34, MOVE_SAFEGUARD),
    LEVEL_UP_MOVE(36, MOVE_PH_BEAM2), //MOVE_ICE_BEAM),
    LEVEL_UP_MOVE(39, MOVE_IMPRISON),
    LEVEL_UP_MOVE(42, MOVE_PH_SPATK_ADJACENT2), //MOVE_BLIZZARD),
    LEVEL_UP_MOVE(44, MOVE_GRUDGE),
    LEVEL_UP_MOVE(47, MOVE_CAPTIVATE),
    LEVEL_UP_MOVE(50, MOVE_SHEER_COLD),
    LEVEL_UP_END
...
static const struct LevelUpMove sNinetalesAlolanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_PH_ELEMENT_STRONG2 + MOVES_PH_TYPE2), //MOVE_DAZZLING_GLEAM),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_STRONG2 + MOVES_PH_TYPE2), //MOVE_DAZZLING_GLEAM),
    LEVEL_UP_MOVE( 1, MOVE_IMPRISON),
    LEVEL_UP_MOVE( 1, MOVE_NASTY_PLOT),
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM2), //MOVE_ICE_BEAM),
    LEVEL_UP_MOVE( 1, MOVE_ICE_SHARD),
    LEVEL_UP_MOVE( 1, MOVE_CONFUSE_RAY),
    LEVEL_UP_MOVE( 1, MOVE_SAFEGUARD),
    LEVEL_UP_END
...
static const struct LevelUpMove sDiglettAlolanLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(28, MOVE_PH_ELEMENT_STRONG), //MOVE_EARTH_POWER),
    LEVEL_UP_MOVE(31, MOVE_PH_BODY_2TURN), //MOVE_DIG),
    LEVEL_UP_MOVE(35, MOVE_PH_HEAD + MOVES_PH_TYPE2), //MOVE_IRON_HEAD),
    LEVEL_UP_MOVE(39, MOVE_PH_SPATK_ADJACENT2),
    LEVEL_UP_MOVE(43, MOVE_FISSURE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sDugtrioAlolanLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(30, MOVE_PH_ELEMENT_STRONG), //MOVE_EARTH_POWER),
    LEVEL_UP_MOVE(35, MOVE_PH_BODY_2TURN), //MOVE_DIG),
    LEVEL_UP_MOVE(41, MOVE_PH_HEAD + MOVES_PH_TYPE2), //MOVE_IRON_HEAD),
    LEVEL_UP_MOVE(47, MOVE_PH_SPATK_ADJACENT2),
    LEVEL_UP_MOVE(53, MOVE_FISSURE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMeowthAlolanLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(17, MOVE_SCREECH),
    LEVEL_UP_MOVE(22, MOVE_PH_SWIFT), //MOVE_FEINT_ATTACK),
    LEVEL_UP_MOVE(25, MOVE_TAUNT),
    LEVEL_UP_MOVE(30, MOVE_PAY_DAY),
    LEVEL_UP_MOVE(33, MOVE_SLASH),
    LEVEL_UP_MOVE(38, MOVE_NASTY_PLOT),
...
static const struct LevelUpMove sPersianAlolanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, ORIGINAL_TYPE_MOVE(MOVE_PH_SWIFT, TYPE_NORMAL)), //MOVE_SWIFT),
    LEVEL_UP_MOVE( 1, ORIGINAL_TYPE_MOVE(MOVE_PH_SWIFT, TYPE_NORMAL)), //MOVE_SWIFT),
    ...
    LEVEL_UP_MOVE(49, MOVE_ASSURANCE),
    LEVEL_UP_MOVE(56, MOVE_CAPTIVATE),
    LEVEL_UP_MOVE(61, MOVE_PH_BLADE2), //MOVE_NIGHT_SLASH),
    LEVEL_UP_MOVE(65, MOVE_FEINT),
...
static const struct LevelUpMove sGeodudeAlolanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_DEFENSE_CURL),
    LEVEL_UP_MOVE( 4, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE( 6, MOVE_ROCK_POLISH),
    LEVEL_UP_MOVE(10, MOVE_PH_ELEMENT_WEAK), //MOVE_ROLLOUT),
    LEVEL_UP_MOVE(12, MOVE_PH_HEAD + MOVES_PH_TYPE2), //MOVE_SPARK),
    LEVEL_UP_MOVE(16, MOVE_PH_ATK_THROW), //MOVE_ROCK_THROW),
    LEVEL_UP_MOVE(18, MOVE_SMACK_DOWN),
...
static const struct LevelUpMove sGravelerAlolanLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(30, MOVE_PH_HAZARD), //MOVE_STEALTH_ROCK),
    LEVEL_UP_MOVE(34, MOVE_PH_ATK_WEAK), //MOVE_ROCK_BLAST),
    LEVEL_UP_MOVE(40, MOVE_PH_SPATK_ADJACENT1 + MOVES_PH_TYPE2), //MOVE_DISCHARGE),
    LEVEL_UP_MOVE(44, MOVE_EXPLOSION),
    LEVEL_UP_MOVE(50, MOVE_DOUBLE_EDGE),
    LEVEL_UP_MOVE(54, MOVE_PH_HORN), //MOVE_STONE_EDGE),
    LEVEL_UP_END
...
static const struct LevelUpMove sGrimerAlolanLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(18, MOVE_PH_BITE), //MOVE_POISON_FANG),
    LEVEL_UP_MOVE(21, MOVE_MINIMIZE),
    LEVEL_UP_MOVE(26, MOVE_FLING),
    LEVEL_UP_MOVE(29, MOVE_PH_HORN + MOVES_PH_TYPE2), //MOVE_KNOCK_OFF),
    LEVEL_UP_MOVE(32, MOVE_PH_BITE2 + MOVES_PH_TYPE2), //MOVE_CRUNCH),
    LEVEL_UP_MOVE(37, MOVE_SCREECH),
    LEVEL_UP_MOVE(40, MOVE_GUNK_SHOT),
    LEVEL_UP_MOVE(43, MOVE_ACID_ARMOR),
    LEVEL_UP_MOVE(46, MOVE_BELCH),
...
static const struct LevelUpMove sMarowakAlolanLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE( 1, MOVE_BONE_CLUB),
    LEVEL_UP_MOVE( 1, MOVE_PH_HEAD), //MOVE_FLAME_WHEEL),
    LEVEL_UP_MOVE( 3, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE( 7, MOVE_BONE_CLUB),
    LEVEL_UP_MOVE(11, MOVE_PH_HEAD), //MOVE_FLAME_WHEEL),
    LEVEL_UP_MOVE(13, MOVE_LEER),
    LEVEL_UP_MOVE(17, MOVE_HEX),
    LEVEL_UP_MOVE(21, MOVE_BONEMERANG),
...
static const struct LevelUpMove sPonytaGalarianLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(41, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(45, ORIGINAL_TYPE_MOVE(MOVE_PH_ELEMENT_STRONG2 + MOVES_PH_TYPE2, TYPE_FAIRY)), //MOVE_DAZZLING_GLEAM),
    LEVEL_UP_MOVE(50, MOVE_PH_BEAM2), //MOVE_PSYCHIC),
    LEVEL_UP_MOVE(55, MOVE_HEALING_WISH),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sRapidashGalarianLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(35, MOVE_HEAL_PULSE),
    LEVEL_UP_MOVE(43, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE(49, MOVE_PH_ELEMENT_STRONG2 + MOVES_PH_TYPE2), //MOVE_DAZZLING_GLEAM),
    LEVEL_UP_MOVE(56, MOVE_PH_BEAM2), //MOVE_PSYCHIC),
    LEVEL_UP_MOVE(63, MOVE_HEALING_WISH),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSlowpokeGalarianLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_CURSE),
    LEVEL_UP_MOVE( 3, MOVE_GROWL),
    LEVEL_UP_MOVE( 6, ORIGINAL_TYPE_MOVE(MOVE_PH_ELEMENT_WEAK, TYPE_POISON)), //MOVE_ACID),
    LEVEL_UP_MOVE( 9, ORIGINAL_TYPE_MOVE(MOVE_PH_STATUS2, TYPE_NORMAL)), //MOVE_YAWN),
    LEVEL_UP_MOVE(12, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
...
static const struct LevelUpMove sSlowbroGalarianLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_PH_ELEMENT_WEAK), //MOVE_ACID),
    LEVEL_UP_MOVE( 9, ORIGINAL_TYPE_MOVE(MOVE_PH_STATUS2 + MOVES_PH_TYPE2, TYPE_NORMAL)), //MOVE_YAWN),
    LEVEL_UP_MOVE(12, MOVE_PH_ELEMENT_WEAK + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(15, MOVE_DISABLE),
    LEVEL_UP_MOVE(18, MOVE_WATER_PULSE),
    LEVEL_UP_MOVE(21, MOVE_HEADBUTT),
...
static const struct LevelUpMove sWeezingGalarianLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(28, MOVE_SELF_DESTRUCT),
    LEVEL_UP_MOVE(32, MOVE_PH_BEAM2), //MOVE_SLUDGE_BOMB),
    LEVEL_UP_MOVE(38, MOVE_PH_STATUS3), //MOVE_TOXIC),
...
static const struct LevelUpMove sZapdosGalarianLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(65, MOVE_PH_BODY_RECOIL), //MOVE_CLOSE_COMBAT),
...
static const struct LevelUpMove sMoltresGalarianLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(20, MOVE_AGILITY),
    LEVEL_UP_MOVE(25, MOVE_ANCIENT_POWER),
    LEVEL_UP_MOVE(30, MOVE_PH_PRIORITY), //MOVE_SUCKER_PUNCH),
    LEVEL_UP_MOVE(35, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
    LEVEL_UP_MOVE(40, MOVE_AFTER_YOU),
...
static const struct LevelUpMove sZigzagoonGalarianLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(18, MOVE_PIN_MISSILE),
    LEVEL_UP_MOVE(21, MOVE_REST),
    LEVEL_UP_MOVE(24, MOVE_PH_BODY_RECOIL + MOVES_PH_TYPE2), //MOVE_TAKE_DOWN),
...
static const struct LevelUpMove sYamaskGalarianLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(32, MOVE_SLAM),
    LEVEL_UP_MOVE(36, MOVE_PH_HEAL_SAP + MOVES_PH_TYPE2),
    LEVEL_UP_MOVE(40, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_SHADOW_BALL),
    LEVEL_UP_MOVE(44, MOVE_PH_SPATK_ADJACENT2),
...
static const struct LevelUpMove sWormadamSandyCloakLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(20, MOVE_HIDDEN_POWER),
    LEVEL_UP_MOVE(23, MOVE_CONFUSION),
    LEVEL_UP_MOVE(26, ORIGINAL_TYPE_MOVE(MOVE_PH_ATK_WEAK + MOVES_PH_TYPE2, TYPE_ROCK)), //MOVE_ROCK_BLAST),
...
static const struct LevelUpMove sWormadamTrashCloakLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(41, MOVE_ATTRACT),
    LEVEL_UP_MOVE(44, MOVE_PSYCHIC),
    LEVEL_UP_MOVE(47, MOVE_PH_HEAD + MOVES_PH_TYPE2), //MOVE_IRON_HEAD),
    LEVEL_UP_MOVE(50, MOVE_PH_BEAM3),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sShayminSkyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(46, MOVE_NATURAL_GIFT),
    LEVEL_UP_MOVE(55, MOVE_PH_TYPE_EFF),
    LEVEL_UP_MOVE(64, MOVE_PH_BEAM1 + MOVES_PH_TYPE2), //MOVE_AIR_SLASH),
    LEVEL_UP_MOVE(73, MOVE_PH_BALL),
    LEVEL_UP_MOVE(82, MOVE_SWEET_KISS),
    LEVEL_UP_MOVE(91, MOVE_PH_BEAM3),
    LEVEL_UP_MOVE(100, MOVE_SEED_FLARE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMeowsticFemaleLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(35, MOVE_PH_BALL), //MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE(40, MOVE_PH_BEAM2), //MOVE_PSYCHIC),
    LEVEL_UP_MOVE(43, MOVE_ROLE_PLAY),
    LEVEL_UP_MOVE(45, MOVE_SIGNAL_BEAM),
    LEVEL_UP_MOVE(48, MOVE_SUCKER_PUNCH),
    LEVEL_UP_MOVE(50, MOVE_PH_BEAM3), //MOVE_FUTURE_SIGHT),
...
static const struct LevelUpMove sHoopaUnboundLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(29, MOVE_POWER_SPLIT),
    LEVEL_UP_MOVE(29, MOVE_GUARD_SPLIT),
    LEVEL_UP_MOVE(46, MOVE_PH_HORN + MOVES_PH_TYPE2), //MOVE_KNOCK_OFF),
    LEVEL_UP_MOVE(50, MOVE_WONDER_ROOM),
    LEVEL_UP_MOVE(50, MOVE_TRICK_ROOM),
    LEVEL_UP_MOVE(55, MOVE_DARK_PULSE),
    LEVEL_UP_MOVE(75, MOVE_PH_BEAM2), //MOVE_PSYCHIC),
...
static const struct LevelUpMove sCalyrexShadowRiderLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_CONFUSE_RAY),
    LEVEL_UP_MOVE( 1, MOVE_HAZE),
    LEVEL_UP_MOVE( 1, MOVE_PH_BEAM2 + MOVES_PH_TYPE2), //MOVE_SHADOW_BALL),
    LEVEL_UP_MOVE( 1, MOVE_TAKE_DOWN),
    LEVEL_UP_MOVE( 1, MOVE_AGILITY),
    LEVEL_UP_MOVE( 1, MOVE_THRASH),
    LEVEL_UP_MOVE( 1, MOVE_DISABLE),
